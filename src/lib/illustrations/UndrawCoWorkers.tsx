...
const UndrawCoWorkers = (_props: any) => {
  ...
  delete props.style;
  return (
    <svg data-name="Layer 1" width="1em" height="1em" viewBox="0 0 990 758.22" style={style} {...props}>
      <defs>
        <linearGradient id="prefix__a" x1={369.6} y1={747.98} x2={495.41} y2={747.98} gradientUnits="userSpaceOnUse">
          <stop offset={0} stopColor="gray" stopOpacity={0.25} />
          <stop offset={0.54} stopColor="gray" stopOpacity={0.12} />
          <stop offset={1} stopColor="gray" stopOpacity={0.1} />
        </linearGradient>
        <linearGradient id="prefix__b" x1={406.65} y1={569.23} x2={580.77} y2={569.23} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__c" x1={406.65} y1={566.88} x2={580.77} y2={566.88} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__d" x1={450.31} y1={393.69} x2={539.32} y2={393.69} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__e" x1={332.62} y1={585.2} x2={485.91} y2={585.2} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__f" x1={330.25} y1={585.2} x2={483.54} y2={585.2} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__g" x1={325.69} y1={523.49} x2={468.11} y2={523.49} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__h" x1={512.25} y1={535.81} x2={666.3} y2={535.81} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__i" x1={514.63} y1={535.81} x2={668.68} y2={535.81} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__j" x1={334.24} y1={335.17} x2={375.57} y2={335.17} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__k" x1={404.05} y1={350.24} x2={432.54} y2={350.24} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__l" x1={554.15} y1={502.96} x2={564.83} y2={502.96} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__m" x1={382.15} y1={523.48} x2={401.05} y2={523.48} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__n" x1={396.31} y1={603.61} x2={450.31} y2={603.61} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__o" x1={466.47} y1={363.78} x2={534.98} y2={363.78} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__p" x1={355.99} y1={258.44} x2={465.17} y2={258.44} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__q" x1={436.13} y1={299.32} x2={566.69} y2={299.32} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__r" x1={434.94} y1={298.14} x2={565.5} y2={298.14} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__s" x1={488.88} y1={375.59} x2={562.07} y2={375.59} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__t" x1={488.88} y1={376.76} x2={562.07} y2={376.76} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__u" x1={765.65} y1={677.74} x2={765.65} y2={269.69} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__v" x1={579.6} y1={758.22} x2={579.6} y2={555.42} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__w" x1={578.2} y1={568.04} x2={578.2} y2={387.91} xlinkHref="#prefix__a" />
      </defs>
      <path
      ...
      />
      <g opacity={0.7}>
        <path fill={primaryColor} opacity={0.6} d="M0 80h990v505H0z" />
        <path
      ...
      <g opacity={0.7}>
        ...
        <path
          ...
          fill="url(#prefix__i)"
        />
        <path fill="url(#prefix__j)" d="M359.21 288.72l16.36 79.41-26.7 13.49-14.63-71.53 24.97-21.37z" />
        <path fill="url(#prefix__k)" d="M404.05 374l12.46-51.04 16.03 29.92-8.31 24.64-20.18-3.52z" />
        <path
        ...
        <path
          ...
          opacity={0.1}
        />
        <ellipse cx={410.58} cy={258.44} rx={54.59} ry={53.97} fill="url(#prefix__p)" />
        <path
      ...
      <path
        ...
        fill="#fdb797"
      />
      <path d="M633.15 516.11s-29.62 63.8-26.2 74.06 193.68 0 193.68 0-35.32-35.32-28.48-74.06z" fill="#3ad29f" />
      <path
      ...
      <path
        ...
        fill="#fdb797"
      />
      <path d="M742 428.96s26.2 17.78 49 16.3c0 0 2.28-30.54-4.56-32.25s-36.51 0-44.44 15.95z" opacity={0.1} />
      <path d="M742 427.82s26.2 17.78 49 16.3c0 0 2.28-30.54-4.56-32.25s-36.51 0-44.44 15.95z" fill="#252a62" />
      <path
      ...
      <path
        ...
        fill={primaryColor}
      />
      <path d="M624.61 492.76a201.83 201.83 0 0 1 52.39-6.84M742 431.24s-17.09 12.53-12.53 19.37" opacity={0.1} />
      <path
        fill="url(#prefix__v)"
        d="M859.31 555.42H299.9v48.92h32.56v153.88h495.45V604.34h31.4v-48.92z"
        opacity={0.7}
      />
      <path fill="#e0e0e0" d="M337.5 583.91h485.35v174.32H337.5z" />
      <path opacity={0.1} d="M337.5 593.02h485.35v27.34H337.5z" />
      <path fill="#e0e0e0" d="M305.6 564.54h548.01v46.71H305.6z" />
      ...
      <path d="M264.58 587.32s6.74 9.89 26.73 12.92" opacity={0.1} />
      <path
