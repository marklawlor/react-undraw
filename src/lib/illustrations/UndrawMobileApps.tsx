...
const UndrawMobileApps = (_props: any) => {
  ...
  delete props.style;
  return (
    <svg data-name="Layer 1" width="1em" height="1em" viewBox="0 0 918.21 702.7" style={style} {...props}>
      <defs>
        <linearGradient
          id="prefix__a"
          x1={473.15}
      ...
      <rect x={311.76} y={197.86} width={64} height={64} rx={10.5} ry={10.5} fill={primaryColor} />
      <rect x={390.76} y={197.86} width={64} height={64} rx={10.5} ry={10.5} fill={primaryColor} opacity={0.6} />
      <rect x={469.76} y={197.86} width={64} height={64} rx={10.5} ry={10.5} fill={primaryColor} opacity={0.6} />
      <rect x={548.76} y={197.86} width={64} height={64} rx={10.5} ry={10.5} fill={primaryColor} opacity={0.6} />
      <g opacity={0.6} fill={primaryColor}>
