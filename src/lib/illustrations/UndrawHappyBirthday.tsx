...
const UndrawHappyBirthday = (_props: any) => {
  ...
  return (
    <svg data-name="Layer 1" width="1em" height="1em" viewBox="0 0 839.2 727.08" style={style} {...props}>
      <defs>
        ...
        <linearGradient id="prefix__b" x1={615.75} y1={530.72} x2={651.5} y2={530.72} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__c" x1={745.48} y1={595.56} x2={780.02} y2={595.56} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__d" x1={634.32} y1={509.85} x2={634.32} y2={96.02} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__e" x1={637.11} y1={586.77} x2={637.11} y2={513.3} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__f" x1={454.92} y1={727.08} x2={454.92} y2={487.86} xlinkHref="#prefix__a" />
      </defs>
      ...
      <path fill={primaryColor} d="M429.66 545.29h50.52v178.76h-50.52z" />
      <path opacity={0.1} d="M320.85 494.77H589v54.41H320.85z" />
      <path fill="#535461" d="M305.31 490.88h299.24v54.41H305.31z" />
      <path fill={primaryColor} d="M429.66 490.88h50.52v54.41h-50.52z" />
    </svg>
  );
};
