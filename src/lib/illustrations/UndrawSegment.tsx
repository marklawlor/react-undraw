...
const UndrawSegment = (_props: any) => {
  ...
  delete props.style;
  return (
    <svg data-name="Layer 1" width="1em" height="1em" viewBox="0 0 844 723.28" style={style} {...props}>
      <defs>
        ...
        <linearGradient id="prefix__b" x1={600} y1={642.36} x2={600} y2={88.36} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__c" x1={910.39} y1={454.21} x2={910.39} y2={315.32} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__d" x1={706.97} y1={486.37} x2={706.97} y2={246.08} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__e" x1={966.2} y1={448.54} x2={966.2} y2={448.05} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__f" x1={908.16} y1={769.78} x2={908.16} y2={439.08} xlinkHref="#prefix__a" />
      </defs>
      ...
      <path
        ...
        fill="url(#prefix__b)"
      />
      <path d="M833 467.94H9V22.87a10.75 10.75 0 0 1 10.75-10.75h802.42A10.75 10.75 0 0 1 833 22.87z" fill="#f5f5f5" />
      <path d="M812.92 543.12H29.08a20 20 0 0 1-20-20v-55.18H833v55.14a20 20 0 0 1-20.08 20.04z" fill="#fff" />
      <g opacity={0.2} fill="#fff">
        <path d="M701.26 466.11c.8.11 1.6.24 2.38.41a9.68 9.68 0 0 1 .82-.53 13.94 13.94 0 0 1 2.82-1.21 5.06 5.06 0 0 1 1.13-.87 18.82 18.82 0 0 0-7 2.08zM659 502.72a37 37 0 0 1 23.7-34.53c-1.3-3.07 0-6.31 5.23-8.15l3.7-1.31 1.74-1.67-8.44 3c-5.21 1.84-6.53 5.08-5.23 8.15a37 37 0 0 0 13.3 71.51h1.5a37 37 0 0 1-35.5-37z" />
        <path d="M688.19 466.04h-.17a2.73 2.73 0 0 0 0 .52q1.56-.34 3.16-.55l.57-.31a73.48 73.48 0 0 1 8.17-3.59c.42-.5.86-1 1.31-1.47a73.5 73.5 0 0 0-12.48 5.05z" />
      </g>
      ...
      <path fill={primaryColor} opacity={0.5} d="M78 205.72h236v8H78zM78 243.72h236v8H78z" />
      <path fill={primaryColor} opacity={0.3} d="M78 286.72h236v8H78z" />
      ...
      <path
        ...
        fill="url(#prefix__c)"
      />
      <path d="M786.2 361.1a113 113 0 0 0-70.5-126.54l-40.52 105.48z" fill={primaryColor} />
      <path d="M786.2 361.1a113 113 0 0 0-70.5-126.54l-40.52 105.48z" opacity={0.2} />
      <path
        d="M720.82 366.22l92-77.27a120.14 120.14 0 1 0 .45 154z"
        transform="translate(-178 -88.36)"
        fill="url(#prefix__d)"
      />
      <path d="M542 277.86l86.52-72.68a113 113 0 1 0 .42 144.86z" fill={primaryColor} />
      <path fill={primaryColor} opacity={0.7} d="M350 104.72h142v18H350z" />
      <path
      ...
      />
      <g opacity={0.2} fill="#fff">
        <path d="M762.09 616.57l26.51 87.07h3.86l-27-88.72s-1.28.57-3.37 1.65zM732.67 584.09h-3.86a124.33 124.33 0 0 0-37.89 118.27l.28 1.3h3.86l-.28-1.3a124.33 124.33 0 0 1 37.89-118.27z" />
      </g>
      <path
