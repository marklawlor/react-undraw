...
const UndrawFinance = (_props: any) => {
  ...
  delete props.style;
  return (
    <svg data-name="Layer 1" width="1em" height="1em" viewBox="0 0 954 549.86" style={style} {...props}>
      <defs>
        <linearGradient id="prefix__a" x1={569.11} y1={596.37} x2={569.11} y2={230.62} gradientUnits="userSpaceOnUse">
          <stop offset={0} stopColor="gray" stopOpacity={0.25} />
          <stop offset={0.54} stopColor="gray" stopOpacity={0.12} />
          <stop offset={1} stopColor="gray" stopOpacity={0.1} />
        </linearGradient>
        <linearGradient id="prefix__b" x1={878.33} y1={643.77} x2={878.33} y2={175.07} xlinkHref="#prefix__a" />
      </defs>
      <path
      ...
      <path fill={primaryColor} opacity={0.5} d="M292.12 283.18h38.91v60.04h-38.91z" />
      <path fill={primaryColor} opacity={0.7} d="M358.83 229.81h38.91v113.41h-38.91z" />
      <path fill={primaryColor} opacity={0.5} d="M425.54 262.05h38.91v81.16h-38.91z" />
      <path fill={primaryColor} opacity={0.8} d="M492.25 212.02h38.91v131.2h-38.91z" />
      <path fill={primaryColor} d="M558.96 165.32h38.91v177.89h-38.91z" />
      <path
        fill="none"
        stroke="#535461"
        strokeMiterlimit={10}
      ...
      />
      <circle cx={311.02} cy={246.49} r={7.78} fill={primaryColor} />
      <circle cx={444.44} cy={242.04} r={7.78} fill={primaryColor} />
      <circle cx={512.26} cy={173.11} r={7.78} fill={primaryColor} />
      <circle cx={378.84} cy={184.22} r={7.78} fill={primaryColor} />
      <circle cx={577.86} cy={145.31} r={7.78} fill={primaryColor} />
      <path
      ...
      <path
        ...
        strokeWidth={2}
      />
      <circle cx={82.69} cy={141.7} r={7.23} fill={primaryColor} />
      <path
        ...
        strokeWidth={2}
      />
      <circle cx={53.76} cy={165.2} r={7.23} fill={primaryColor} />
      <circle cx={45.63} cy={269.16} r={7.23} fill={primaryColor} />
      <circle cx={39.3} cy={210.4} r={7.23} fill={primaryColor} />
      <circle cx={106.2} cy={171.53} r={7.23} fill={primaryColor} />
      <circle cx={106.2} cy={282.72} r={7.23} fill={primaryColor} />
      <circle cx={94.45} cy={200.46} r={7.23} fill={primaryColor} />
      <circle cx={108.91} cy={330.64} r={7.23} fill={primaryColor} />
      <circle cx={60.09} cy={311.65} r={7.23} fill={primaryColor} />
      <circle cx={101.68} cy={231.19} r={7.23} fill={primaryColor} />
    </svg>
  );
};
