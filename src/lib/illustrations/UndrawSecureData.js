...
const UndrawSecureData = props => (
  ...
  >
    ...
    <path fill="url(#a)" d="M162.9 86.11h469.69v631.14H162.9z" opacity={0.5} />
    ...
    <path fill="url(#c)" d="M212.53 223.1h152.7v105.19h-152.7z" opacity={0.5} />
    <path
      data-name="<Rectangle>"
      fill="#fff"
      d="M213.58 224.32h150.6v101.52h-150.6z"
    />
    <g clipPath="url(#d)" fill={props.primaryColor}>
      <path
        opacity={0.4}
    ...
    <path fill="url(#f)" d="M212.53 439.6h152.7v105.19h-152.7z" opacity={0.5} />
    <path
      data-name="<Rectangle>"
      fill="#fff"
      d="M213.58 440.82h150.6v101.52h-150.6z"
    />
    <g clipPath="url(#g)" fill="#bdbdbd">
      <path
        opacity={0.4}
    ...
    <path fill={props.primaryColor} d="M546.32 631.77h182.24v90.07H546.32z" />
    <path
