...
const UndrawWeatherApp = (_props: any) => {
  ...
  delete props.style;
  return (
    <svg data-name="Layer 1" width="1em" height="1em" viewBox="0 0 881 722.629" style={style} {...props}>
      <path
      ...
      <path
        ...
        strokeMiterlimit={10}
      />
      <circle cx={192.675} cy={368.803} r={93.445} fill={primaryColor} />
      <rect x={170.077} y={165.056} width={45.806} height={92.346} rx={22.903} fill={primaryColor} />
      <rect
        x={465.887}
        y={332.979}
        width={45.806}
      ...
      <rect
        ...
        fill={primaryColor}
      />
      <circle cx={203.675} cy={357.803} r={93.445} fill="none" stroke="#3f3d56" strokeMiterlimit={10} />
      <rect
        x={181.077}
        y={154.056}
        width={45.806}
      ...
      <path fill="none" stroke="#3f3d56" strokeMiterlimit={10} d="M0 722.129h881" />
    </svg>
  );
};
