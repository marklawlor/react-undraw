...
const UndrawConnectingTeams = (_props: any) => {
  ...
  delete props.style;
  return (
    <svg data-name="Layer 1" width="1em" height="1em" viewBox="0 0 818.94 750" style={style} {...props}>
      <defs>
        <linearGradient id="prefix__a" x1={391.06} y1={181.72} x2={391.06} y2={30.67} gradientUnits="userSpaceOnUse">
          <stop offset={0} stopColor="gray" stopOpacity={0.25} />
          <stop offset={0.54} stopColor="gray" stopOpacity={0.12} />
          <stop offset={1} stopColor="gray" stopOpacity={0.1} />
        </linearGradient>
        <linearGradient id="prefix__b" x1={710.91} y1={187.1} x2={710.91} y2={36.05} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__c" x1={551} y1={311.01} x2={551} y2={159.96} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__d" x1={66.72} y1={439.07} x2={66.72} y2={305.63} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__e" x1={77.31} y1={432.72} x2={77.31} y2={299.28} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__f" x1={509.01} y1={292.43} x2={509.01} y2={202.06} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__g" x1={371.86} y1={825} x2={371.86} y2={147.87} xlinkHref="#prefix__a" />
      </defs>
      <circle cx={391.06} cy={106.19} r={75.53} fill="url(#prefix__a)" opacity={0.5} />
      ...
      <path
        ...
        fill="#fda57d"
      />
      <path d="M379.02 142.51a32.91 32.91 0 0 0 22.87.06v-2.81h-22.87z" opacity={0.1} />
      ...
      <circle cx={710.91} cy={111.58} r={75.53} fill="url(#prefix__b)" opacity={0.5} />
      ...
      <path
        ...
        fill="#fda57d"
      />
      <path d="M698.87 147.9a32.91 32.91 0 0 0 22.87.06v-2.81h-22.87z" opacity={0.1} />
      <circle cx={710.34} cy={116.65} r={32.77} fill="#fda57d" />
      <path d="M687 86.84s13.81 28 52.78 11.75l-9.07-14.22-16.08-5.77z" opacity={0.1} />
      <path d="M687 86.43s13.81 28 52.78 11.75L730.71 84l-16.08-5.77z" fill="#72351c" />
      <path
      ...
      <circle cx={551} cy={235.49} r={75.53} fill="url(#prefix__c)" opacity={0.5} />
      <circle cx={551} cy={235.08} r={73.93} fill="#f5f5f5" />
      <path d="M522.14 235.73s-8.38 41.3-13 39c0 0 44.12 38.11 83.08 0 0 0-6.86-29.1-16.77-39z" fill="#333" />
      <path
      ...
      <path
        ...
        fill="#be7c5e"
      />
      <path d="M538.95 271.8a32.91 32.91 0 0 0 22.87.06v-2.81h-22.87z" opacity={0.1} />
      <circle cx={550.43} cy={240.56} r={32.77} fill="#be7c5e" />
      <path d="M519.09 228.11h62.5s-5.34-25.24-29-23.63-33.5 23.63-33.5 23.63z" fill="#333" />
      <ellipse cx={518.33} cy={239.16} rx={3.05} ry={5.72} fill="#be7c5e" />
      <ellipse cx={582.35} cy={239.16} rx={3.05} ry={5.72} fill="#be7c5e" />
      <path d="M519.09 229h62.5s-5.34-25.24-29-23.63-33.5 23.63-33.5 23.63z" opacity={0.1} />
      <path
      ...
      />
      <circle cx={66.72} cy={372.35} r={66.72} fill="url(#prefix__d)" opacity={0.5} />
      ...
      <path d="M56 396.81h20.2v16.72a9.54 9.54 0 0 1-9.54 9.54h-1.08a9.54 9.54 0 0 1-9.58-9.54v-16.72z" opacity={0.1} />
      <path
        d="M56.65 396.06h19a.6.6 0 0 1 .6.6v16.12a9.54 9.54 0 0 1-9.54 9.54h-1.13a9.54 9.54 0 0 1-9.58-9.54v-16.12a.6.6 0 0 1 .6-.6z"
        fill="#ccc"
      />
      <path d="M56.08 404.43a29.07 29.07 0 0 0 20.2.06V402h-20.2z" opacity={0.1} />
      <circle cx={66.22} cy={376.83} r={28.95} fill="#ccc" />
      <path d="M45.6 350.5s12.2 24.77 46.62 10.38l-8-12.57-14.21-5.1z" opacity={0.1} />
      <path d="M45.6 350.13s12.2 24.77 46.62 10.38l-8-12.57-14.21-5.1z" fill="#ccc" />
      <path
      ...
      <circle cx={77.31} cy={366} r={66.72} fill="url(#prefix__e)" opacity={0.5} />
      ...
      <path
        ...
        fill="#ccc"
      />
      <path d="M66.67 398.08a29.07 29.07 0 0 0 20.2.06v-2.48h-20.2z" opacity={0.1} />
      <circle cx={76.81} cy={370.48} r={28.95} fill="#ccc" />
      <path d="M56.19 344.14s12.2 24.77 46.62 10.38l-8-12.57-14.21-5.1z" opacity={0.1} />
      <path d="M56.19 343.78s12.2 24.77 46.62 10.38l-8-12.57-14.21-5.1z" fill="#ccc" />
      <path
      ...
      <path
        ...
        fill="#4d8af0"
      />
      <path d="M110.95 733.18v-28.3h43.59s3.06 11.47 22.94 13.76-9.18 16.06-9.18 16.06z" fill="#333" />
      <path d="M158.02 715.56l7.59-27.26 42 11.69s-.13 11.87 18.41 19.41-13.15 13-13.15 13z" fill="#333" />
      <path
