...
const UndrawProblemSolving = (_props: any) => {
  ...
  delete props.style;
  return (
    <svg data-name="Layer 1" width="1em" height="1em" viewBox="0 0 990.17 637.668" style={style} {...props}>
      <path
      ...
      <path
        ...
        strokeMiterlimit={10}
      />
      <ellipse cx={897.083} cy={483.183} rx={14.583} ry={7.083} fill={primaryColor} />
      <ellipse cx={908.75} cy={529.85} rx={14.583} ry={7.083} fill={primaryColor} />
      <ellipse cx={882.083} cy={537.35} rx={14.583} ry={7.083} fill={primaryColor} />
      <ellipse cx={923.75} cy={576.516} rx={14.583} ry={7.083} fill={primaryColor} />
      <ellipse cx={952.917} cy={576.516} rx={14.583} ry={7.083} fill={primaryColor} />
      <path fill="none" stroke="#3f3d56" strokeMiterlimit={10} d="M555.5 637h412" />
      <path
      ...
      <circle cx={17} cy={23.5} r={17} fill={primaryColor} />
      <circle cx={22} cy={17.5} r={17} fill="none" stroke="#3f3d56" strokeMiterlimit={10} />
      <circle cx={224} cy={237.5} r={17} fill="#f2f2f2" />
      <circle cx={229} cy={231.5} r={17} fill="none" stroke="#3f3d56" strokeMiterlimit={10} />
      <circle cx={356} cy={108.5} r={17} fill={primaryColor} />
      <circle cx={361} cy={102.5} r={17} fill="none" stroke="#3f3d56" strokeMiterlimit={10} />
      <rect x={38.719} y={62.975} width={260.028} height={129.17} rx={13.524} fill={primaryColor} />
      <rect
        x={53.916}
        y={52}
        width={260.028}
