...
const UndrawTypewriter = (_props: any) => {
  ...
  delete props.style;
  return (
    <svg data-name="Layer 1" width="1em" height="1em" viewBox="0 0 1009.54 717.96" style={style} {...props}>
      <defs>
        <linearGradient id="prefix__a" x1={554.8} y1={808.98} x2={554.8} y2={548.41} gradientUnits="userSpaceOnUse">
      ...
      <g opacity={0.2}>
        ...
        <ellipse
          ...
          fill="#3f3d56"
        />
        <ellipse cx={823.53} cy={539.55} rx={23.67} ry={18.08} transform="rotate(-70.1 709.9 562.249)" fill="#3f3d56" />
        <ellipse
          cx={833.41}
          cy={512.36}
          rx={23.67}
      ...
      <ellipse cx={180.47} cy={642.47} rx={67.3} ry={12.94} fill={primaryColor} />
      ...
      <path d="M309.34 52.15s6.87 186.83-5.31 208.7h411.74s-17.49-143.71 0-208.7z" opacity={0.03} />
      ...
      <ellipse cx={275.91} cy={461.74} rx={15.31} ry={12.81} fill={primaryColor} />
      <ellipse cx={275.91} cy={461.74} rx={15.31} ry={12.81} opacity={0.1} />
      <ellipse cx={275.91} cy={458.93} rx={15.31} ry={12.81} fill={primaryColor} />
      ...
      <ellipse cx={736.71} cy={461.74} rx={15.31} ry={12.81} fill={primaryColor} />
      <ellipse cx={736.71} cy={461.74} rx={15.31} ry={12.81} opacity={0.1} />
      <ellipse cx={736.71} cy={458.93} rx={15.31} ry={12.81} fill={primaryColor} />
      ...
      <path opacity={0.1} d="M265.29 222.43h497.35v7.5H265.29z" />
      <path
        fill="#464353"
      ...
      <g data-name="woman">
        ...
        <path
          ...
          fill="#be6f72"
        />
        <path d="M486.25 482.54l-4.4 1.57-1.6-2.66v-.23a7.7 7.7 0 0 1 5.47-1.08z" opacity={0.1} />
        <path
      ...
      <path opacity={0.03} d="M308.93 52.16l1.57 41.35 45.48-41.35h-47.05z" />
      <ellipse cx={847.47} cy={692.13} rx={33.8} ry={6.5} fill={primaryColor} />
