...
const UndrawPhotoSharing = (_props: any) => {
  ...
  return (
    <svg data-name="Layer 1" width="1em" height="1em" viewBox="0 0 777.21 727.86" style={style} {...props}>
      <defs>
        ...
        <linearGradient id="prefix__b" x1={258.38} y1={294.87} x2={258.38} y2={252.24} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__c" x1={659.41} y1={203.43} x2={659.41} y2={169.83} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__d" x1={345.38} y1={208.38} x2={345.38} y2={161.13} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__e" x1={483.32} y1={183.35} x2={483.32} y2={142.38} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__f" x1={708.87} y1={119.9} x2={748.2} y2={119.9} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__g" x1={964.11} y1={297.58} x2={964.11} y2={98.89} xlinkHref="#prefix__a" />
        <linearGradient
          id="prefix__h"
          x1={463.31}
          y1={448}
        ...
        <linearGradient
          ...
          xlinkHref="#prefix__a"
        />
        <linearGradient id="prefix__n" x1={431.12} y1={727.86} x2={431.12} y2={429.15} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__o" x1={296.27} y1={470.97} x2={296.27} y2={446.14} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__p" x1={543.51} y1={470.97} x2={543.51} y2={446.14} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__q" x1={432.11} y1={661.16} x2={432.11} y2={495.04} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__r" x1={432.11} y1={637.09} x2={432.11} y2={519.1} xlinkHref="#prefix__a" />
      </defs>
      <path fill="url(#prefix__a)" d="M72.92 128.87h704.29v471.18H72.92z" />
      ...
      <g opacity={0.2} fill="#fff">
        <path d="M704.83 132.68a131.26 131.26 0 0 0 13.88.92 130.82 130.82 0 0 1-13.78-.59zM701.73 114.35C715.6 114 741 109.2 741 109.2a5.29 5.29 0 0 1 .54.43c-7.24 1.3-29.15 5.05-39.81 4.72zM694.03 113.72c-6 1.21-7.92 10.19-4.08 15.25 3.51 4.65 7.78 53 7.78 53h-2.91s-4.26-48.35-7.78-53c-4.39-5.8-1.3-16.74 6.99-15.25z" />
      </g>
      <path d="M710.8 187.11s-28.41 0-28.41 4.67a8.79 8.79 0 0 0 3.55 7h24.86z" fill="#263238" />
      <path
      ...
      />
      <path transform="rotate(-.2 -27985.86 70396.46)" fill="url(#prefix__k)" d="M395.88 287.61H545.4v170.36H395.88z" />
      ...
      />
      <path fill="url(#prefix__n)" d="M266.77 429.15h328.7v298.71h-328.7z" />
      <path fill="#fff" d="M275.31 438.37h314.38v279.45H275.31z" />
      <circle cx={296.27} cy={458.56} r={12.42} fill="url(#prefix__o)" />
      <circle cx={296.27} cy={458.56} r={10.09} fill="#ff9800" />
      <path fill="url(#prefix__p)" d="M511.29 446.14h64.43v24.84h-64.43z" />
      <path fill="#f5f5f5" d="M513.62 448.46h60.55v20.18h-60.55z" />
      <path fill={primaryColor} d="M274.54 511.34H589.7v133.51H274.54z" />
      <circle cx={432.11} cy={578.1} r={83.06} fill="url(#prefix__q)" />
      <circle cx={432.11} cy={578.1} r={80.73} fill="#fff" />
      <circle cx={432.11} cy={578.1} r={58.99} fill="url(#prefix__r)" />
      <circle cx={432.11} cy={578.1} r={57.44} fill={primaryColor} />
      <circle cx={432.11} cy={579.65} r={34.15} fill={primaryColor} />
