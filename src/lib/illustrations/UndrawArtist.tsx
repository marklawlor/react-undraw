...
const UndrawArtist = (_props: any) => {
  ...
  delete props.style;
  return (
    <svg data-name="Layer 1" width="1em" height="1em" viewBox="0 0 1037.826 750.05" style={style} {...props}>
      <ellipse cx={931.913} cy={801.524} rx={23.5} ry={187} transform="rotate(-89.93 853.836 804.63)" fill="#3f3d56" />
      ...
      />
      <path d="M860.1 151.455l7.56-3.768s32.057 38.438 22.596 54.164-37.148 5.62-37.148 5.62z" fill={primaryColor} />
      ...
      <ellipse
        ...
        fill="#ff6584"
      />
      <circle cx={768.435} cy={212.09} r={3.147} fill={primaryColor} />
      <circle cx={835.791} cy={212.172} r={3.147} fill={primaryColor} />
      ...
      <path
        ...
        opacity={0.1}
      />
      <circle cx={336} cy={284.475} r={73} fill={primaryColor} />
      <path
