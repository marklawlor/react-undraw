...
const UndrawCautiousDog = (_props: any) => {
  ...
  delete props.style;
  return (
    <svg data-name="Layer 1" width="1em" height="1em" viewBox="0 0 921 532.56" style={style} {...props}>
      <defs>
        <linearGradient id="prefix__a" x1={460.5} y1={532.56} x2={460.5} y2={81.56} gradientUnits="userSpaceOnUse">
          <stop offset={0} stopColor="gray" stopOpacity={0.25} />
          <stop offset={0.54} stopColor="gray" stopOpacity={0.12} />
          <stop offset={1} stopColor="gray" stopOpacity={0.1} />
        </linearGradient>
        <linearGradient id="prefix__b" x1={698.5} y1={537.03} x2={941.5} y2={537.03} xlinkHref="#prefix__a" />
      </defs>
      <ellipse cx={460.5} cy={307.06} rx={460.5} ry={225.5} fill="url(#prefix__a)" opacity={0.7} />
      <ellipse cx={460.5} cy={307.06} rx={440.57} ry={215.74} fill={primaryColor} />
      <path
      ...
      <path fill={primaryColor} d="M795.47 434.8H565.53l9.14-11.75h212.96l7.84 11.75z" />
