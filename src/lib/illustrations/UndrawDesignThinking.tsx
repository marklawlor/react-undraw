...
const UndrawDesignThinking = (_props: any) => {
  ...
  delete props.style;
  return (
    <svg data-name="Layer 1" width="1em" height="1em" viewBox="0 0 832.88 669.688" style={style} {...props}>
      <path
      ...
      <path d="M610.69 193.81a30 30 0 0 1-42.38 42.38 30 30 0 1 0 42.38-42.38z" opacity={0.1} />
      ...
      <path
        ...
        fill="#ffc1c7"
      />
      <path d="M604.55 201.95a22 22 0 1 0-29.1 29.1 22 22 0 1 0 29.1-29.1z" fill="#2f2e41" />
      <ellipse cx={577} cy={230.5} rx={2.5} ry={6.5} fill="#ffc1c7" />
      <circle cx={336} cy={50.5} r={22} fill={primaryColor} />
      <path fill={primaryColor} d="M41 306.5h32v32H41z" />
      <rect x={181} y={154.5} width={228} height={133} rx={16.004} fill="#f2f2f2" />
      <circle cx={116.5} cy={155} r={90} fill="#f2f2f2" />
      <circle cx={131.5} cy={146} r={90} fill="none" stroke="#3f3d56" strokeMiterlimit={10} />
      <rect x={158.5} y={132} width={228} height={133} rx={14.693} fill="none" stroke="#3f3d56" strokeMiterlimit={10} />
      <circle cx={345} cy={41.5} r={22} fill="none" stroke="#3f3d56" strokeMiterlimit={10} />
      <path fill="none" stroke="#3f3d56" strokeMiterlimit={10} d="M46 300.5h32v32H46z" />
      <path fill={primaryColor} d="M0 6.5h32v32H0z" />
      <path fill="none" stroke="#3f3d56" strokeMiterlimit={10} d="M5 .5h32v32H5zM400.5 669h413" />
    </svg>
  );
};
