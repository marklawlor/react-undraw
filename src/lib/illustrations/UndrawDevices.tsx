...
const UndrawDevices = (_props: any) => {
  ...
  delete props.style;
  return (
    <svg data-name="Layer 1" width="1em" height="1em" viewBox="0 0 814.27 615.44" style={style} {...props}>
      <defs>
        <linearGradient
          id="prefix__a"
          x1={684.96}
      ...
      />
      <path fill="#f5f5f5" d="M302.206 543.318l380.67-.531.025 17.94-380.67.531z" />
      <path
      ...
      <path
        ...
        fill="#f5f5f5"
      />
      <path fill={primaryColor} d="M208.754 40.069l568.62-.794.4 287.41-568.619.794z" />
      <rect
        x={291.13}
        y={290.71}
        width={296}
      ...
      <rect
        ...
        fill="#fff"
      />
      <path fill={primaryColor} d="M126.02 189.42h240.06v367.12H126.02z" />
      ...
      <rect
        ...
        fill="#fff"
      />
      <path fill={primaryColor} d="M25.641 288.634l144.73-.202.39 278.92-144.73.202z" />
