...
const UndrawOuterSpace = (_props: any) => {
  ...
  delete props.style;
  return (
    <svg data-name="Layer 1" width="1em" height="1em" viewBox="0 0 1135.18 814.22" style={style} {...props}>
      <defs>
      ...
      />
      <circle cx={748.15} cy={555.65} r={11.52} fill="url(#prefix__c)" opacity={0.7} />
