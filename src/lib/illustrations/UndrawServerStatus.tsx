...
const UndrawServerStatus = (_props: any) => {
  ...
  delete props.style;
  return (
    <svg data-name="Layer 1" width="1em" height="1em" viewBox="0 0 1055.52 773.82" style={style} {...props}>
      <defs>
        <linearGradient
          id="prefix__a"
          x1={1958.6}
      ...
      <path
        ...
        opacity={0.1}
      />
      <path d="M503.38 30.13l-3.81 221s137.92 0 255.26 38.1l2.29-223.32S568.91 20.99 503.38 30.13z" opacity={0.1} />
      <path d="M501.38 27.13l-3.81 221s137.92 0 255.26 38.1l2.29-223.32S566.91 17.99 501.38 27.13z" fill="#f5f5fb" />
      <path d="M444.64 29.96l3.81 221s-137.92 0-255.26 38.1L190.9 65.8s188.21-44.98 253.74-35.84z" opacity={0.1} />
      <path d="M446.64 26.96l3.81 221s-137.92 0-255.26 38.1L192.9 62.8s188.21-44.98 253.74-35.84z" fill="#f5f5fb" />
      <path d="M790.41 97.42v218.69s45-5.33 139.44 111.25l8.39-218.69s-98.3-105.91-147.83-111.25z" opacity={0.1} />
      <path d="M788.41 95.42v218.69s45-5.33 139.44 111.25l8.39-218.69s-98.3-105.91-147.83-111.25z" fill="#f5f5fb" />
      <path d="M160.06 103.91v218.7s-45-5.33-139.44 111.25l-8.38-218.69s98.29-105.91 147.82-111.26z" opacity={0.1} />
      <path d="M162.06 100.91v218.7s-45-5.33-139.44 111.25l-8.38-218.69s98.29-105.91 147.82-111.26z" fill="#f5f5fb" />
      <path
        d="M668.06 469.68c0 7.45-47.31 50.5-155 50.5s-166-41.55-166-49 60.31 11 168 11 153-19.96 153-12.5z"
        fill="#f7f7fd"
      />
      <ellipse cx={316.11} cy={365.5} rx={11.46} ry={1.57} fill={primaryColor} opacity={0.1} />
      <ellipse cx={272.22} cy={369.95} rx={11.46} ry={1.57} fill={primaryColor} opacity={0.1} />
      <ellipse cx={220.54} cy={363.93} rx={11.46} ry={1.57} fill={primaryColor} opacity={0.1} />
      <ellipse cx={289.79} cy={382.62} rx={8.14} ry={1.12} fill={primaryColor} opacity={0.1} />
      <ellipse cx={244.24} cy={381.5} rx={8.14} ry={1.12} fill={primaryColor} opacity={0.1} />
      <path
      ...
      <path
        ...
        opacity={0.1}
      />
      <path d="M216.94 350.35c0 .71.08 1.28.18 1.28s.17-.57.17-1.28-.09-.37-.19-.37-.16-.33-.16.37z" fill="#ffd037" />
      <path d="M215.96 351.2c.62.34 1.16.54 1.21.45s-.42-.43-1-.76-.38-.1-.42 0-.41.02.21.31z" fill="#ffd037" />
      <path
      ...
      <path
        ...
        opacity={0.1}
      />
      <path d="M230.76 350.35c0 .71-.07 1.28-.17 1.28s-.18-.57-.18-1.28.1-.37.2-.37.15-.33.15.37z" fill="#ffd037" />
      <path d="M231.76 351.2c-.62.34-1.16.54-1.2.45s.41-.43 1-.76.38-.1.43 0 .36.02-.23.31z" fill="#ffd037" />
      <path
      ...
      <path
        ...
        opacity={0.2}
      />
      <ellipse cx={195.17} cy={496.39} rx={34.72} ry={5.13} fill={primaryColor} opacity={0.1} />
      <ellipse cx={292.15} cy={538.87} rx={34.72} ry={5.13} fill={primaryColor} opacity={0.1} />
      <ellipse cx={149.49} cy={587.2} rx={34.72} ry={5.13} fill={primaryColor} opacity={0.1} />
      <ellipse cx={885.14} cy={693.36} rx={34.72} ry={5.13} fill={primaryColor} opacity={0.1} />
      <ellipse cx={491.09} cy={575.32} rx={22.99} ry={2.57} fill={primaryColor} opacity={0.1} />
      <ellipse cx={820.09} cy={443.32} rx={22.99} ry={2.57} fill={primaryColor} opacity={0.1} />
      <ellipse cx={641.08} cy={638.32} rx={22.99} ry={2.57} fill={primaryColor} opacity={0.1} />
      <ellipse cx={442.64} cy={621.36} rx={22.99} ry={2.57} fill={primaryColor} opacity={0.1} />
      <ellipse cx={256.67} cy={614.69} rx={22.99} ry={2.57} fill={primaryColor} opacity={0.1} />
      <ellipse cx={208.21} cy={660.73} rx={22.99} ry={2.57} fill={primaryColor} opacity={0.1} />
      <g opacity={0.1}>
      ...
      <ellipse cx={508.8} cy={235.5} rx={152.12} ry={67.89} fill={primaryColor} />
      <path
      ...
      <path
        ...
        fill={primaryColor}
      />
      <ellipse cx={733.03} cy={571.25} rx={57} ry={10.26} fill={primaryColor} opacity={0.1} />
      <path
      ...
      <path
        ...
        opacity={0.05}
      />
      <path d="M730.48 557.91c5 7.86 12.77 3.4 14.15 2.52l-.57-1.7-11.3-3.15a7 7 0 0 1-2.28 2.33z" opacity={0.1} />
      <path
      ...
      <path
        ...
        opacity={0.2}
      />
      <circle cx={31.29} cy={21.63} r={21.63} fill={primaryColor} opacity={0.1} />
      <circle cx={961.29} cy={83.63} r={21.63} fill={primaryColor} opacity={0.1} />
      <circle cx={16} cy={106.18} r={16} fill={primaryColor} opacity={0.1} />
      <circle cx={178} cy={16.18} r={16} fill={primaryColor} opacity={0.1} />
      <circle cx={834} cy={18.18} r={16} fill={primaryColor} opacity={0.1} />
      <path
      ...
      <path
        ...
        opacity={0.1}
      />
      <path d="M897.06 653.08c0 1.84-.21 3.34-.46 3.34s-.46-1.5-.46-3.34.26-1 .51-1 .41-.85.41 1z" fill="#ffd037" />
      <path d="M899.62 655.28c-1.62.88-3 1.41-3.16 1.19s1.1-1.12 2.71-2 1-.24 1.11 0 .96-.07-.66.81z" fill="#ffd037" />
      <path
      ...
      <path
        ...
        opacity={0.1}
      />
      <path d="M861.01 653.08c0 1.84.21 3.34.47 3.34s.46-1.5.46-3.34-.26-1-.52-1-.41-.85-.41 1z" fill="#ffd037" />
      <path d="M858.46 655.28c1.62.88 3 1.41 3.15 1.19s-1.09-1.12-2.71-2-1-.24-1.1 0-.96-.07.66.81z" fill="#ffd037" />
      <path
