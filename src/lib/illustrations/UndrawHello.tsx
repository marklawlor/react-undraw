...
const UndrawHello = (_props: any) => {
  ...
  delete props.style;
  return (
    <svg data-name="Layer 1" width="1em" height="1em" viewBox="0 0 909.67 748.22" style={style} {...props}>
      <defs>
        <linearGradient id="prefix__a" x1={966.56} y1={410.81} x2={966.56} y2={349.8} gradientUnits="userSpaceOnUse">
          <stop offset={0} stopColor="gray" stopOpacity={0.25} />
          <stop offset={0.54} stopColor="gray" stopOpacity={0.12} />
          <stop offset={1} stopColor="gray" stopOpacity={0.1} />
        </linearGradient>
        <linearGradient id="prefix__b" x1={517.02} y1={824.11} x2={517.02} y2={75.89} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__c" x1={146.88} y1={637.21} x2={321.94} y2={637.21} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__d" x1={728.6} y1={487.08} x2={728.6} y2={484.08} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__e" x1={653.39} y1={341.18} x2={653.39} y2={183.08} xlinkHref="#prefix__a" />
      </defs>
      <path
      ...
      <path
        ...
        fill={primaryColor}
      />
      <path d="M829.12 276.56v46a9.7 9.7 0 0 1-9.7 9.7h5a9.7 9.7 0 0 0 9.7-9.7v-46z" opacity={0.1} />
      <path
        ...
        fill="#eee"
      />
      <path fill="none" stroke="#e0e0e0" strokeMiterlimit={10} strokeWidth={8} d="M449.06 344.02l-104 324" />
      <path
      ...
      />
      <path d="M296.15 182h27.91a56 56 0 0 1 56 56v148h-160V258.11A76.09 76.09 0 0 1 296.15 182z" fill={primaryColor} />
      <path d="M220.06 386h160v87h-89a71 71 0 0 1-71-71v-16z" fill="#39447a" />
      <path d="M222.22 242.06l97.84 93h108v-14l-93-27-79.55-98.24s-36.13 22.29-33.29 46.24z" opacity={0.05} />
      <path d="M222.22 240.06l97.84 93h108v-14l-93-27-79.55-98.24s-36.13 22.29-33.29 46.24z" fill={primaryColor} />
      <path d="M428.06 319.02s52 4 38 14h-38zM496.06 205.02s13-39 22-28-5 34-5 34z" fill="#fda57d" />
      <path opacity={0.05} d="M220.06 386.02v4.66l160 .34v-5h-160z" />
      <path
        d="M344.52 478.56l107.6 9.81 5.86 219.74 38.53-12.54s57.63-249 2.68-270-114.35-48.63-149.81-26.1-4.86 79.09-4.86 79.09z"
        fill="#39447a"
      />
      <path d="M351.06 411.02s59 30 67 64" opacity={0.1} />
      <path d="M288.06 472.02l84 68-94 151 39 11s163-140 129-188-68-104-110-105-48 63-48 63z" fill="#39447a" />
      <path opacity={0.05} d="M420.06 251.02l21 36 5-10-26-26z" />
      <path
      ...
      <path d="M300.06 149.02a20 20 0 0 0-20 20v6.8a64 64 0 0 0 40 0v-6.8a20 20 0 0 0-20-20z" opacity={0.05} />
      ...
      <path
        ...
        opacity={0.6}
      />
      <rect x={5.85} y={645.27} width={154.09} height={65.57} rx={32.78} ry={32.78} fill={primaryColor} />
      <path
      ...
      <path
        ...
        fill="url(#prefix__d)"
      />
      <path fill="none" stroke="#e0e0e0" strokeMiterlimit={10} strokeWidth={8} d="M801.82 344.02l104 370.09" />
      ...
      <rect
        ...
        opacity={0.7}
      />
      <rect x={543.13} y={185.99} width={216.61} height={155.18} rx={26.84} ry={26.84} fill="#3e3f49" />
      <rect x={546.13} y={185.99} width={216.61} height={155.18} rx={26.84} ry={26.84} fill="#535461" />
