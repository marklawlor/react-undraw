...
const UndrawAboutMe = (_props: any) => {
  ...
  delete props.style;
  return (
    <svg data-name="Layer 1" width="1em" height="1em" viewBox="0 0 1167.52 756.03" style={style} {...props}>
      <defs>
        <linearGradient id="prefix__a" x1={588.17} y1={804.7} x2={588.17} y2={185.7} gradientUnits="userSpaceOnUse">
        ...
        <linearGradient
          ...
          xlinkHref="#prefix__a"
        />
        <linearGradient id="prefix__c" x1={588.52} y1={693.03} x2={588.52} y2={483.16} xlinkHref="#prefix__a" />
      </defs>
      <ellipse cx={560.76} cy={725.03} rx={541} ry={31} fill={primaryColor} opacity={0.1} />
      <g opacity={0.2}>
        <path
      ...
      <g opacity={0.2}>
        ...
        <ellipse
          ...
          fill="#3f3d56"
        />
        <ellipse cx={183.38} cy={449.12} rx={20.61} ry={26.98} transform="rotate(-13.72 -124 480.492)" fill="#3f3d56" />
        <path
      ...
      <path transform="rotate(90 670.04 128.59)" fill="url(#prefix__b)" d="M640.17 169.7h4v6h-4z" />
      <path
        fill="#ededf4"
      ...
      <path
        ...
        opacity={0.1}
      />
      <ellipse cx={886.46} cy={740.19} rx={33.8} ry={6.5} fill={primaryColor} />
      ...
      <path
        ...
        opacity={0.1}
      />
      <ellipse cx={270.46} cy={741.74} rx={15.3} ry={2.94} fill={primaryColor} />
