...
const UndrawChatting = (_props: any) => {
  ...
  delete props.style;
  return (
    <svg data-name="Layer 1" width="1em" height="1em" viewBox="0 0 789.99 731" style={style} {...props}>
      <defs>
        <linearGradient
          id="prefix__a"
          x1={461.46}
        ...
        <linearGradient id="prefix__b" x1={533.21} y1={688.58} x2={533.21} y2={490.28} xlinkHref="#prefix__a" />
        <linearGradient
          id="prefix__c"
          x1={-602.79}
          y1={427.8}
          ...
          xlinkHref="#prefix__a"
        />
        <linearGradient id="prefix__d" x1={376.5} y1={427.5} x2={376.5} y2={242.61} xlinkHref="#prefix__a" />
        <linearGradient
          id="prefix__e"
          x1={3313.5}
          y1={702.5}
      ...
      <rect
        ...
        fill="#dbdbdb"
      />
      <circle cx={642.91} cy={161.92} r={2.93} transform="rotate(-.86 -5088.324 13777.942)" fill="#dbdbdb" />
      <path
      ...
      <path
        ...
        fill="#fda57d"
      />
      <path d="M314.38 522.64a42.68 42.68 0 0 0 29.66.08v-3.64h-29.66z" opacity={0.1} />
      <circle cx={329.25} cy={482.12} r={42.51} fill="#fda57d" />
      <path d="M288.62 465.97h81.06s-6.92-32.73-37.56-30.64-43.5 30.64-43.5 30.64z" fill="#333" />
      <ellipse cx={287.63} cy={480.31} rx={3.95} ry={7.41} fill="#fda57d" />
      <ellipse cx={370.66} cy={480.31} rx={3.95} ry={7.41} fill="#fda57d" />
      <path d="M288.62 467.07h81.06s-6.92-32.73-37.56-30.64-43.5 30.64-43.5 30.64z" opacity={0.1} />
      <path
      ...
      <path
        ...
        fill="#be7c5e"
      />
      <path d="M431 258.95a42.68 42.68 0 0 0 29.66.08v-3.64H431z" opacity={0.1} />
      <circle cx={445.86} cy={218.43} r={42.51} fill="#be7c5e" />
      <path d="M405.23 202.29h81.06s-6.92-32.73-37.56-30.64-43.5 30.64-43.5 30.64z" fill="#333" />
      <ellipse cx={404.24} cy={216.62} rx={3.95} ry={7.41} fill="#be7c5e" />
      <ellipse cx={487.27} cy={216.62} rx={3.95} ry={7.41} fill="#be7c5e" />
      <path d="M405.23 203.39h81.06s-6.92-32.73-37.56-30.64-43.5 30.64-43.5 30.64z" opacity={0.1} />
      <path
        ...
        opacity={0.5}
      />
      <path d="M14 163v135h225s0 27 27 36c0 0-9-18 0-36h63V163z" fill="#fff" />
      <path fill={primaryColor} d="M41 190h180v18H41zM41 217h243v18H41zM41 244h216v18H41z" />
      <path
        ...
        opacity={0.5}
      />
      <path d="M761 438v135H536s0 27-27 36c0 0 9-18 0-36h-63V438z" fill="#fff" />
      <path fill={primaryColor} d="M483 465h180v18H483zM483 492h243v18H483zM483 519h216v18H483z" />
      <g opacity={0.5} fill="#47e6b1">
        <path d="M84 714h3v17h-3z" />
        <path d="M94 721v3H77v-3z" />
      </g>
      <g opacity={0.5} fill="#47e6b1">
        <path d="M633 192h3v17h-3z" />
        <path d="M643 199v3h-17v-3z" />
      </g>
      <g opacity={0.5} fill="#47e6b1">
        <path d="M697 612h3v17h-3z" />
        <path d="M707 619v3h-17v-3z" />
      </g>
      <g opacity={0.5} fill="#47e6b1">
        <path d="M508 0h3v17h-3z" />
        <path d="M518 7v3h-17V7z" />
      </g>
      <path
