...
const UndrawSynchronize = (_props: any) => {
  ...
  delete props.style;
  return (
    <svg data-name="Layer 1" width="1em" height="1em" viewBox="0 0 874.169 657" style={style} {...props}>
      ...
      <path d="M130.5 612s-2-2-7 4-15 13-21 7-6-1-6-1-13 21-24 24-3 13 7 9 59-21 59-21-1-14-8-22z" fill="#2f2e41" />
      <path d="M57.5 346l-15 23s-37 29-18 32 30-27 30-27l13-16z" fill="#a0616a" />
      <path d="M52.5 342s17 25 25 27 5-19 5-19z" fill={primaryColor} />
      <path d="M52.5 342s17 25 25 27 5-19 5-19z" opacity={0.1} />
      <path d="M74.5 340l3 52s-11 77 6 95c0 0 10 27 10 37s7 70 7 70h29s6-83-10-109V343z" fill="#2f2e41" />
      <path
      ...
      <path
        ...
        fill="#2f2e41"
      />
      <path d="M98.5 200s1 27-4 28a76.88 76.88 0 0 0-12 4v15l8 5 20-12 8-7 8-7s-5-14 0-23z" fill="#a0616a" />
      <path d="M98.5 200s1 27-4 28a76.88 76.88 0 0 0-12 4v15l8 5 20-12 8-7 8-7s-5-14 0-23z" opacity={0.1} />
      <path
      ...
      <path fill="none" stroke="#3f3d56" strokeMiterlimit={10} d="M0 656.5h851.223M191 .5h352v295.248H191z" />
      <path
