...
const UndrawModernWoman = (_props: any) => {
  ...
  delete props.style;
  return (
    <svg data-name="Layer 1" width="1em" height="1em" viewBox="0 0 1004.92 901" style={style} {...props}>
      <defs>
        <linearGradient
          id="prefix__a"
          x1={152.96}
        ...
        <linearGradient id="prefix__b" x1={540.11} y1={738.57} x2={540.11} y2={575.92} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__c" x1={456.49} y1={738.57} x2={456.49} y2={724.03} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__d" x1={485.72} y1={738.57} x2={485.72} y2={724.03} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__e" x1={546.71} y1={738.57} x2={546.71} y2={724.03} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__f" x1={578.48} y1={738.57} x2={578.48} y2={724.03} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__g" x1={451.29} y1={631.9} x2={451.29} y2={599.87} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__h" x1={514.84} y1={662.35} x2={514.84} y2={647.08} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__i" x1={568.32} y1={631.83} x2={568.32} y2={583.55} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__j" x1={600.78} y1={689.69} x2={600.78} y2={657.25} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__k" x1={581.17} y1={656.92} x2={581.17} y2={637.16} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__l" x1={582.35} y1={655.65} x2={582.35} y2={635.89} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__m" x1={584.77} y1={652.62} x2={584.77} y2={638.43} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__n" x1={584.77} y1={651.35} x2={584.77} y2={637.16} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__o" x1={616.75} y1={639.33} x2={616.75} y2={621.67} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__p" x1={616.75} y1={638.06} x2={616.75} y2={620.4} xlinkHref="#prefix__a" />
        <linearGradient
          id="prefix__q"
          x1={644.7}
          y1={621.67}
          ...
          xlinkHref="#prefix__a"
        />
        <linearGradient id="prefix__r" x1={452.99} y1={708.71} x2={452.99} y2={668.05} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__s" x1={454.26} y1={708.71} x2={454.26} y2={668.05} xlinkHref="#prefix__a" />
      </defs>
      <path
      ...
      />
      <path d="M1.23 783.89h1003.59v-131H26.27C1.8 693.1-2.45 740.98 1.23 783.89z" fill="#fff" opacity={0.1} />
      ...
      <path opacity={0.1} d="M686 267.65l-42.95 37.16-1.23-.82 43.36-36.75.82.41z" />
      ...
      <path
        ...
        fill="#ffc533"
      />
      <path opacity={0.1} d="M633.29 451.83l.13 2.08-8.39-1.04.44-1.04h7.82z" />
      <path d="M633.56 453.9h-3.1s8.61 79.67 17 81.13l.65-1s-13.73-64.85-14.55-80.13z" opacity={0.1} />
      <path
      ...
      <g opacity={0.5}>
        ...
        <path
          ...
          fill="url(#prefix__g)"
        />
        <path d="M552 647.17s-27.19 34.22-71.66-.09" transform="translate(-195.08 .5)" fill="url(#prefix__h)" />
        <path d="M466.35 583.55s-16.52 21.6 0 48.29" transform="translate(-195.08 .5)" fill="url(#prefix__i)" />
        <path d="M427 657.25s14.55 18.08.18 32.44" transform="translate(-195.08 .5)" fill="url(#prefix__j)" />
        <path
        ...
        <path
          ...
          fill="url(#prefix__m)"
        />
        <path d="M465.51 637.16S451.1 648 427 651.35" transform="translate(-195.08 .5)" fill="url(#prefix__n)" />
        <path
          ...
          opacity={0.1}
        />
        <path d="M429.5 636.92s-24.14 7.62-30.5-16.52z" transform="translate(-195.08 .5)" fill="url(#prefix__p)" />
        <ellipse cx={191.21} cy={617.72} rx={2.54} ry={4.45} fill="url(#prefix__q)" />
        <path
          ...
          fill="url(#prefix__r)"
        />
        <path d="M572.45 668s15.25 24.14 5.08 40.66z" transform="translate(-195.08 .5)" fill="url(#prefix__s)" />
      </g>
      <path
      ...
      <path
        ...
        fill="#383f4d"
      />
      <path d="M271.53 639.79s-13.75 10.34-36.78 13.54" opacity={0.1} />
      <path d="M271.53 638.58s-13.75 10.34-36.78 13.54" fill="#f3ad55" />
      <path d="M230.17 643.56s-23 7.27-29.1-15.76z" opacity={0.1} />
      <path d="M230.17 642.35s-23 7.27-29.1-15.76z" fill="#f3ad55" />
      <ellipse cx={195.95} cy={619.56} rx={2.42} ry={4.24} fill="#383f4d" />
      <path d="M379.64 706.85l-4.85-38.8s14.55 23 4.85 38.8" opacity={0.1} />
      ...
      <path
        ...
        fill="#3ad29f"
      />
      <path opacity={0.1} d="M687.53 464.91v-2.64l-20.44-5.19-.95 2.23 21.39 5.6z" />
    </svg>
  );
};
