...
const UndrawGrades = (_props: any) => {
  ...
  delete props.style;
  return (
    <svg data-name="Layer 1" width="1em" height="1em" viewBox="0 0 793.42 762" style={style} {...props}>
      <defs>
        <linearGradient id="prefix__a" x1={254.47} y1={338.35} x2={254.47} y2={235.68} gradientUnits="userSpaceOnUse">
        ...
        <linearGradient
          ...
          xlinkHref="#prefix__a"
        />
        <linearGradient id="prefix__c" x1={254.47} y1={831} x2={254.47} y2={728.33} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__d" x1={254.47} y1={668.46} x2={254.47} y2={565.8} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__e" x1={254.47} y1={502.58} x2={254.47} y2={399.91} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__f" x1={499.41} y1={67.18} x2={499.41} y2={35.49} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__g" x1={499.41} y1={238.72} x2={499.41} y2={207.03} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__h" x1={499.41} y1={398.09} x2={499.41} y2={366.4} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__i" x1={499.41} y1={563.83} x2={499.41} y2={532.14} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__j" x1={499.41} y1={726.51} x2={499.41} y2={694.82} xlinkHref="#prefix__a" />
      </defs>
      <path
      ...
      <path
        ...
        fill="#fda57d"
      />
      <path d="M31.28 200.28s-5.63 16.38-8.7 14.84c0 0 29.63 25.59 55.78 0a78 78 0 0 0-11.26-14.84z" fill="#333" />
      ...
      <path
        ...
        fill="#fda57d"
      />
      <path d="M42.56 224.5a22.1 22.1 0 0 0 15.35 0v-1.89H42.56z" opacity={0.1} />
      ...
      <path
        ...
        opacity={0.1}
      />
      <path d="M44.22 56.78h15.36V70a6.73 6.73 0 0 1-6.73 6.73h-1.9A6.73 6.73 0 0 1 44.22 70V56.78z" fill="#be7c5e" />
      <path d="M44.25 59a22.1 22.1 0 0 0 15.35 0v-1.89H44.25z" opacity={0.1} />
      ...
      <path
        ...
        fill="#fda57d"
      />
      <path d="M41.51 718.83a22.1 22.1 0 0 0 15.35 0V717H41.51z" opacity={0.1} />
      ...
      <path
        ...
        fill="#f55f44"
      />
      <path d="M42.53 553h15.36v13.23a6.73 6.73 0 0 1-6.73 6.73h-1.9a6.73 6.73 0 0 1-6.73-6.73V553z" opacity={0.1} />
      <path
        d="M42.53 552.41h15.36v13.23a6.73 6.73 0 0 1-6.73 6.73h-1.9a6.73 6.73 0 0 1-6.73-6.73v-13.23z"
        fill="#be7c5e"
      />
      <path d="M42.56 554.62a22.1 22.1 0 0 0 15.35 0v-1.89H42.56z" opacity={0.1} />
      ...
      <path
        ...
        fill="#be7c5e"
      />
      <path d="M41.51 390.41a22.1 22.1 0 0 0 15.35 0v-1.89H41.51z" opacity={0.1} />
      ...
      <path
        ...
        fill="#333"
      />
      <path fill="url(#prefix__f)" d="M205.41 35.49h588v31.69h-588z" opacity={0.5} />
      <path fill="#f5f5f5" d="M207.87 37.87h583.88v26.14H207.87z" />
      <path fill="#3ad29f" d="M207.87 37.87h412.84v26.14H207.87z" />
      <path fill="url(#prefix__g)" d="M205.41 207.03h588v31.69h-588z" opacity={0.5} />
      <path fill="#f5f5f5" d="M207.87 209.41h583.88v26.14H207.87z" />
      <path fill={primaryColor} d="M207.87 209.41h572.39v26.14H207.87z" />
      <path fill="url(#prefix__h)" d="M205.41 366.4h588v31.69h-588z" opacity={0.5} />
      <path fill="#f5f5f5" d="M207.87 368.78h583.88v26.14H207.87z" />
      <path fill="#f55f44" d="M207.87 368.78h89.53v26.14h-89.53z" />
      <path fill="url(#prefix__i)" d="M205.41 532.14h588v31.69h-588z" opacity={0.5} />
      <path fill="#f5f5f5" d="M207.87 534.52h583.88v26.14H207.87z" />
      <path fill={primaryColor} d="M207.87 534.52h529.84v26.14H207.87z" />
      <path fill="url(#prefix__j)" d="M205.41 694.82h588v31.69h-588z" opacity={0.5} />
