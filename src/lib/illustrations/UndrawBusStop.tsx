...
const UndrawBusStop = (_props: any) => {
  ...
  delete props.style;
  return (
    <svg data-name="Layer 1" width="1em" height="1em" viewBox="0 0 894.09 426" style={style} {...props}>
      <defs>
        <linearGradient id="prefix__a" x1={255.91} y1={453.73} x2={255.91} y2={237} gradientUnits="userSpaceOnUse">
          <stop offset={0} stopColor="gray" stopOpacity={0.25} />
          <stop offset={0.54} stopColor="gray" stopOpacity={0.12} />
          <stop offset={1} stopColor="gray" stopOpacity={0.1} />
        </linearGradient>
        <linearGradient id="prefix__b" x1={110.93} y1={303.6} x2={110.93} y2={63} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__c" x1={352.87} y1={463.34} x2={352.87} y2={282.02} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__d" x1={192.59} y1={302.38} x2={192.59} y2={100.44} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__e" x1={489.54} y1={78} x2={489.54} y2={61} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__f" x1={284.54} y1={303} x2={284.54} y2={75.62} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__g" x1={695.54} y1={303} x2={695.54} y2={75.62} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__h" x1={488.09} y1={233} x2={488.09} y2={226} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__i" x1={488.09} y1={243} x2={488.09} y2={236} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__j" x1={488.09} y1={253} x2={488.09} y2={246} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__k" x1={488.09} y1={262} x2={488.09} y2={255} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__l" x1={641.04} y1={460} x2={641.04} y2={452} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__m" x1={488.09} y1={273} x2={488.09} y2={259} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__n" x1={555.09} y1={302} x2={555.09} y2={271.6} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__o" x1={422.09} y1={302} x2={422.09} y2={271.6} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__p" x1={324.59} y1={206} x2={324.59} y2={148} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__q" x1={324.59} y1={302} x2={324.59} y2={204.53} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__r" x1={165.59} y1={358} x2={165.59} y2={353.79} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__s" x1={269.59} y1={341} x2={269.59} y2={336.79} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__t" x1={314.59} y1={358} x2={314.59} y2={353.79} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__u" x1={344.59} y1={406} x2={344.59} y2={401.79} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__v" x1={113.09} y1={415} x2={113.09} y2={410.79} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__w" x1={136.59} y1={426} x2={136.59} y2={421.79} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__x" x1={328.09} y1={416} x2={328.09} y2={411.79} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__y" x1={472.09} y1={388} x2={472.09} y2={383.79} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__z" x1={543.59} y1={365} x2={543.59} y2={360.79} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__A" x1={664.59} y1={406} x2={664.59} y2={401.79} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__B" x1={644.09} y1={422} x2={644.09} y2={417.79} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__C" x1={253.97} y1={119.91} x2={253.97} y2={106.53} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__D" x1={239.23} y1={107} x2={239.23} y2={102.21} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__E" x1={252.71} y1={142.41} x2={252.71} y2={117.66} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__F" x1={222.98} y1={248.86} x2={222.98} y2={67.6} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__G" x1={253.09} y1={122} x2={253.09} y2={115.22} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__H" x1={375.66} y1={541} x2={375.66} y2={473} xlinkHref="#prefix__a" />
        <linearGradient
          id="prefix__I"
          x1={536.83}
          y1={356.91}
      ...
      <path
        ...
        fill="#00897b"
      />
      <path fill="url(#prefix__b)" d="M106.09 63h9.67v240.6h-9.67z" />
      ...
      <path fill="url(#prefix__d)" d="M187.09 100.44h11v201.94h-11z" />
      <path fill="#795548" d="M189.73 100.44h6.08v201.94h-6.08z" />
      <path data-name="<Path>" fill="#795548" d="M193.39 160.92l-36.06-36.78" />
      <path fill="#795548" d="M155.157 126.275l4.341-4.256 36.06 36.784-4.343 4.256z" />
      <path data-name="<Path>" fill="#795548" d="M193.39 192.53l37.38-26.22" />
      <path fill="#795548" d="M191.648 190.041l37.383-26.234 3.492 4.977-37.383 26.234z" />
      <path fill="#b0bec5" d="M35.24 301.17h858.85v3.65H35.24z" />
      <path fill="url(#prefix__e)" d="M265.04 61h449v17h-449z" data-name="<Rectangle>" />
      <path data-name="<Rectangle>" fill="#00838f" d="M269.17 63.26h441.92v12.37H269.17z" />
      <path fill="url(#prefix__f)" d="M276.04 75.62h17V303h-17z" data-name="<Rectangle>" />
      <path data-name="<Rectangle>" fill="#00838f" d="M279.92 75.62h11.29v224.72h-11.29z" />
      <path fill="url(#prefix__g)" d="M687.04 75.62h17V303h-17z" data-name="<Rectangle>" />
      <path data-name="<Rectangle>" fill="#00838f" d="M690.39 75.62h11.29v224.72h-11.29z" />
      ...
      <path fill="url(#prefix__h)" d="M407.09 226h162v7h-162z" />
      <path fill="url(#prefix__i)" d="M407.09 236h162v7h-162z" />
      <path fill="url(#prefix__j)" d="M407.09 246h162v7h-162z" />
      <path fill="url(#prefix__k)" d="M407.09 255h162v7h-162z" />
      <path fill="#00bcd4" d="M408 226.96h160.21v4.87H408zM408 246.42h160.21v4.87H408zM408 236.69h160.21v4.87H408z" />
      <path
      ...
      <path
        ...
        fill="#00bcd4"
      />
      <path data-name="<Rectangle>" fill="#00bcd4" d="M399.13 259.77h177.95v11.83H399.13z" />
      <path fill="url(#prefix__m)" d="M398.09 259h180v14h-180z" data-name="<Rectangle>" />
      <path data-name="<Rectangle>" opacity={0.2} d="M399.13 259.77h177.95v11.83H399.13z" />
      <path
        data-name="<Rectangle>"
        fill="#00bcd4"
        d="M415.26 271.6h13.44v29.57h-13.44zM548.85 271.6h13.44v29.57h-13.44z"
      />
      <path data-name="<Rectangle>" opacity={0.1} d="M415.26 271.6h13.44v29.57h-13.44z" />
      <path fill="url(#prefix__n)" d="M547.09 271.6h16V302h-16z" data-name="<Rectangle>" />
      <path fill="url(#prefix__o)" d="M414.09 271.6h16V302h-16z" data-name="<Rectangle>" />
      <path data-name="<Rectangle>" opacity={0.1} d="M548.85 271.6h13.44v29.57h-13.44z" />
      <g data-name="<Group>">
        <rect
          x={302.09}
          y={148}
        ...
        <rect
          ...
          fill="#fff"
        />
        <path fill="url(#prefix__q)" d="M321.09 204.53h7V302h-7z" data-name="<Rectangle>" />
        <path data-name="<Rectangle>" fill="#00838f" d="M322.43 204.53h4.69v96.6h-4.69z" />
        <path
          data-name="<Path>"
        ...
        />
        <path data-name="<Path>" fill="#f3f9fe" d="M329.63 171.78h4.87v4.87h-4.87z" />
        <circle data-name="<Path>" cx={317.8} cy={179.53} r={1.03} fill={primaryColor} />
        <circle data-name="<Path>" cx={332.94} cy={179.53} r={1.03} fill={primaryColor} />
      </g>
      <path fill="url(#prefix__r)" d="M109.09 353.79h113V358h-113z" />
      <path fill="url(#prefix__s)" d="M233.09 336.79h73V341h-73z" />
      <path fill="url(#prefix__t)" d="M294.09 353.79h41V358h-41z" />
      <path fill="url(#prefix__u)" d="M336.09 401.79h17V406h-17z" />
      <path fill="url(#prefix__v)" d="M101.09 410.79h24V415h-24z" />
      <path fill="url(#prefix__w)" d="M121.09 421.79h31V426h-31z" />
      <path fill="url(#prefix__x)" d="M315.09 411.79h26V416h-26z" />
      <path fill="url(#prefix__y)" d="M426.09 383.79h92V388h-92z" />
      <path fill="url(#prefix__z)" d="M528.09 360.79h31V365h-31z" />
      <path fill="url(#prefix__A)" d="M649.09 401.79h31V406h-31z" />
      <path fill="url(#prefix__B)" d="M617.09 417.79h54V422h-54z" />
      <path
        fill="#b0bec5"
      ...
      />
      <path fill="url(#prefix__C)" d="M251.09 106.53h5.76v13.38h-5.76z" />
      <path fill="#4dd0e1" d="M251.77 106.53h3.65v13.38h-3.65z" />
      <path fill="url(#prefix__D)" d="M221.36 102.21h35.73V107h-35.73z" />
      <path fill="#4dd0e1" d="M221.36 102.88h34.06v3.65h-34.06z" />
      <circle cx={252.71} cy={130.04} r={12.37} fill="url(#prefix__E)" data-name="<Group>" />
      <circle data-name="<Path>" cx={252.71} cy={128.04} r={11.4} fill="#ffeb3b" />
      <path fill="url(#prefix__F)" d="M220.09 67.6h5.79v181.26h-5.79z" />
      <path fill="#4dd0e1" d="M221.36 67.6h3.65v181.26h-3.65z" />
      <circle data-name="<Path>" cx={222.91} cy={60.68} r={9.08} fill="#37474f" />
      <path fill="url(#prefix__G)" d="M234.09 115.22h38V122h-38z" />
      ...
      <path
        ...
        fill="#4dd0e1"
      />
      <path fill="url(#prefix__I)" d="M831.33 106.53h5.76v13.38h-5.76z" />
      <path fill="#4dd0e1" d="M832.76 106.53h3.65v13.38h-3.65z" />
      <path fill="url(#prefix__J)" d="M831.09 102.21h35.73V107h-35.73z" />
      <path fill="#4dd0e1" d="M832.76 102.88h34.06v3.65h-34.06z" />
      <circle cx={835.46} cy={130.04} r={12.37} fill="url(#prefix__K)" data-name="<Group>" />
      <circle data-name="<Path>" cx={835.46} cy={128.04} r={11.4} fill="#ffeb3b" />
      <path fill="url(#prefix__L)" d="M862.3 67.6h5.79v181.26h-5.79z" />
      <path fill="#4dd0e1" d="M863.17 67.6h3.65v181.26h-3.65z" />
      <circle data-name="<Path>" cx={865.27} cy={60.68} r={9.08} fill="#37474f" />
      <path fill="url(#prefix__M)" d="M816.09 115.22h38V122h-38z" />
      ...
      <path
        ...
        fill="url(#prefix__O)"
      />
      <path d="M473.83 250.83s10.21.35 9.88 1.68-9.29 1.74-10.33 1.74-2.56-1.92-2.56-1.92z" fill="#f6b9ad" />
      ...
      <path d="M427.47 256.79s-10.21.35-9.88 1.68 9.29 1.75 10.34 1.75 2.55-1.92 2.55-1.92z" fill="#f6b9ad" />
      <path
      ...
      <path
        ...
        fill="#3d213c"
      />
      <path d="M434.04 255.08s-3.14.12-4.19.82a4.2 4.2 0 0 0-1.45 1.73" opacity={0.1} />
      <g opacity={0.1}>
      ...
      <path
        ...
        opacity={0.1}
      />
      <path d="M441.45 200.91a7.75 7.75 0 0 0 7.14 7.73h.62a7.77 7.77 0 1 0-7.76-7.76z" fill="#f6b9ad" />
      <path
      ...
      <path
        ...
        fill="#3f2b3b"
      />
      <path d="M509.96 295.22s1.37.49 1.65 1.43M529.42 294.53s-1 .41-.91 2.12" opacity={0.1} />
      <ellipse
        cx={662.92}
        cy={538.45}
        rx={0.64}
        ...
        fill="#eec5cd"
      />
      <ellipse cx={682.93} cy={538.45} rx={1.06} ry={0.64} transform="rotate(-60 401.205 552.412)" fill="#eec5cd" />
      <path
      ...
      <path
        ...
        fill={primaryColor}
      />
      <path opacity={0.1} d="M649.15 229.63l.06.28.92 4.15.6 2.75 4.63-1.38 4.29-1.28v-3.1l-10.5-1.42z" />
      <path fill="#e8f4ff" d="M649.15 229.34l.06.28.92 4.16.6 2.74 4.63-1.38 4.29-1.28v-3.1l-10.5-1.42z" />
      <path fill={primaryColor} d="M649.15 229.34l.06.28.92 4.16.6 2.74 4.63-1.38 4.29-1.28v-3.1l-10.5-1.42z" />
      <path
      ...
      <path
        ...
        opacity={0.1}
      />
      <rect x={755.27} y={322.67} width={71.12} height={2} rx={1} ry={1} fill="#dce0ed" />
      <path
        d="M704.71 348.07c2.32 2.52 4 3.51 4 .85-.25-8 13.89-44.42 13.89-44.42l-4.18-.31a108.3 108.3 0 0 0-13.71 43.88z"
        opacity={0.1}
      />
      ...
      <path
        ...
        fill={primaryColor}
      />
      <path d="M768.75 359.18v1.57h44.29v-.49-1.08a22.19 22.19 0 1 0-44.37 0z" fill="#fff" opacity={0.1} />
      ...
      <rect
        ...
        fill="#dce0ed"
      />
      <ellipse cx={864.67} cy={557.12} rx={7.35} ry={2.92} transform="rotate(-65.67 604.512 557.128)" opacity={0.1} />
      <ellipse cx={864.42} cy={556.88} rx={7.35} ry={2.92} transform="rotate(-65.67 604.273 556.886)" fill="#dce0ed" />
      <path
      ...
      <path
        ...
        opacity={0.1}
      />
      <path d="M718.41 307.52a6 6 0 0 1-6-6V291.3a6 6 0 0 1 6-6v22.22z" fill="#dce0ed" />
      <path
      ...
      <path
        ...
        fill="#efb7b9"
      />
      <path fill="#444053" d="M763.95 296.59l-1.65 1.51-1.6 6.14h2.66l2.95-3.82-2.36-3.83z" />
      <path
        opacity={0.1}
      ...
      <path d="M740.94 325.33l-2-1V324a11.28 11.28 0 0 1 2.9.46c-.96.11-.92.72-.9.87z" opacity={0.1} />
      <ellipse cx={739.16} cy={296.9} rx={4.94} ry={6.01} fill={primaryColor} />
      <path fill="#dda2a6" d="M786.7 289.08l7.94 7.83 26.11-.46-7.18-7.37H786.7z" />
      ...
      <path fill="#fff" opacity={0.3} d="M820.75 296.45v26.67h-26.11v-26.21l26.11-.46z" />
      <path fill="#dce0ed" d="M796.77 304.25l19.41-3.33 2.53 12.74-19.99 3.67-1.95-13.08z" />
      <path
        fill={primaryColor}
        d="M800.6 307.23l13.05-2.05.33 1.7-13.05 2.21-.33-1.86zM804.19 310.87l7.42-1.08.33 1.89-7.75 1.09v-1.9z"
      />
      <path fill="#65617d" d="M789.91 303.14l.36-10.55 2.04 2.02-.36 10.57-2.04-2.04z" />
      <path fill="#65617d" d="M816.2 291.78l-25.09.34-.84.47 2.04 2.02.7-.42 24.85-.71-1.66-1.7z" />
    </svg>
  );
};
