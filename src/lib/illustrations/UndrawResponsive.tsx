...
const UndrawResponsive = (_props: any) => {
  ...
  delete props.style;
  return (
    <svg data-name="Layer 1" width="1em" height="1em" viewBox="0 0 971.44 502" style={style} {...props}>
      <defs>
        <linearGradient id="prefix__a" x1={599.5} y1={668.05} x2={599.5} y2={199} gradientUnits="userSpaceOnUse">
          <stop offset={0} stopColor="gray" stopOpacity={0.25} />
          <stop offset={0.54} stopColor="gray" stopOpacity={0.12} />
          <stop offset={1} stopColor="gray" stopOpacity={0.1} />
        </linearGradient>
        <linearGradient id="prefix__b" x1={485.72} y1={258.88} x2={485.72} y2={71.12} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__c" x1={132} y1={515} x2={303} y2={515} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__d" x1={933} y1={568.28} x2={1031} y2={568.28} xlinkHref="#prefix__a" />
      </defs>
      <path
      ...
      <path d="M410.79 380h150.17c1.81-7.87 3.26-13 3.26-13h-157s1.61 5.11 3.57 13z" opacity={0.1} />
      ...
      <path
        ...
        fill="#bdbdbd"
      />
      <rect x={320.72} y={71.12} width={330} height={187.76} rx={4.5} ry={4.5} fill="url(#prefix__b)" opacity={0.5} />
      <rect x={324.95} y={72.5} width={321.54} height={183.96} rx={4.5} ry={4.5} fill="#fff" />
      <rect x={414.52} y={98.91} width={35.44} height={31.9} rx={4.5} ry={4.5} fill={primaryColor} opacity={0.5} />
      ...
      <rect x={414.52} y={148.53} width={35.44} height={31.9} rx={4.5} ry={4.5} fill={primaryColor} opacity={0.5} />
      ...
      <rect x={414.52} y={198.15} width={35.44} height={31.9} rx={4.5} ry={4.5} fill={primaryColor} opacity={0.5} />
      ...
      <path stroke={primaryColor} strokeMiterlimit={10} strokeWidth={2} d="M485.72 42V20M485.72 79V50.13" />
      <circle cx={485.72} cy={79} r={4} fill={primaryColor} />
      <circle cx={485.72} cy={46} r={4} fill="none" stroke="#fff" strokeMiterlimit={10} />
      <path stroke={primaryColor} strokeMiterlimit={10} strokeWidth={2} d="M485.72 42V20M485.72 79V50.13" />
      <circle cx={485.72} cy={79} r={4} fill={primaryColor} />
      <circle cx={485.72} cy={46} r={4} fill="none" stroke="#fff" strokeMiterlimit={10} />
      <path stroke={primaryColor} strokeMiterlimit={10} strokeWidth={2} d="M485.72 279v31M485.72 251v28.87" />
      <circle cx={485.72} cy={251} r={4} fill={primaryColor} />
      <path stroke={primaryColor} strokeMiterlimit={10} strokeWidth={2} d="M305.72 168.5h-31.5M333.22 168.5h-28.87" />
      <circle cx={333.22} cy={168.5} r={4} fill={primaryColor} />
      ...
      <path
        ...
        opacity={0.6}
      />
      <path d="M28.72 364h147s29 37-16 92h-116s-42-38-15-92z" fill={primaryColor} />
      <path
      ...
      <path
        ...
        opacity={0.3}
      />
      <path d="M175.72 364h-147c-.33.67-.65 1.34-1 2h143s28.29 36.11-14.4 90h3.4c45-55 16-92 16-92z" opacity={0.1} />
      ...
      <path stroke={primaryColor} strokeMiterlimit={10} strokeWidth={2} d="M690.22 168.5h6M637.22 168.5h44.88" />
      <circle cx={637.22} cy={168.5} r={4} fill={primaryColor} />
      <circle cx={686.22} cy={168.5} r={4} fill="none" stroke="#fff" strokeMiterlimit={10} />
      <path
      ...
      <path d="M821.72 352h92v79.5a23.5 23.5 0 0 1-23.5 23.5h-45a23.5 23.5 0 0 1-23.5-23.5V352z" fill={primaryColor} />
      <path d="M821.72 352v4h88v79.5a23.39 23.39 0 0 1-5 14.49 23.45 23.45 0 0 0 9-18.49V352z" opacity={0.1} />
    </svg>
  );
};
