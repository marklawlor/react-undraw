...
const UndrawKnowledge = (_props: any) => {
  ...
  delete props.style;
  return (
    <svg data-name="Layer 1" width="1em" height="1em" viewBox="0 0 1087 800.5" style={style} {...props}>
      <path fill="#f2f2f2" d="M117.5 105.5h910v490h-910z" />
      <path fill={primaryColor} opacity={0.3} d="M205.5 189.5h294v361h-294z" />
      <path
        fill="#3f3d56"
      ...
      />
      <path fill={primaryColor} d="M612.5 451.5h123v34h-123z" />
