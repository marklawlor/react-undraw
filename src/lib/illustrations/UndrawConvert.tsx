...
const UndrawConvert = (_props: any) => {
  ...
  delete props.style;
  return (
    <svg data-name="Layer 1" width="1em" height="1em" viewBox="0 0 1014 552" style={style} {...props}>
      <path fill="none" stroke="#3f3d56" strokeMiterlimit={10} strokeWidth={2} d="M507 26v186M135 212V26h744v186" />
      ...
      <circle cx={507} cy={26} r={15} fill={primaryColor} />
