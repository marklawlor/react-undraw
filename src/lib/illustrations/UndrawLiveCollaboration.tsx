...
const UndrawLiveCollaboration = (_props: any) => {
  ...
  delete props.style;
  return (
    <svg data-name="Layer 1" width="1em" height="1em" viewBox="0 0 862 703.19" style={style} {...props}>
      <defs>
        <linearGradient id="prefix__a" x1={232.86} y1={449.06} x2={232.86} y2={19.38} gradientUnits="userSpaceOnUse">
          <stop offset={0} stopColor="gray" stopOpacity={0.25} />
          <stop offset={0.54} stopColor="gray" stopOpacity={0.12} />
          <stop offset={1} stopColor="gray" stopOpacity={0.1} />
        </linearGradient>
        <linearGradient id="prefix__b" x1={303.14} y1={548.35} x2={303.14} y2={118.67} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__c" x1={730.3} y1={703.19} x2={730.3} y2={444.62} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__d" x1={732.71} y1={258.57} x2={732.71} y2={0} xlinkHref="#prefix__a" />
      </defs>
      <rect y={19.38} width={465.71} height={429.68} rx={4.5} ry={4.5} fill="url(#prefix__a)" opacity={0.5} />
      <rect x={5.68} y={22.71} width={454.97} height={419.26} rx={4.5} ry={4.5} fill="#f5f5f5" />
      <rect x={40.75} y={91.77} width={76.73} height={69.06} rx={4.5} ry={4.5} fill={primaryColor} />
      ...
      <rect x={111.03} y={191.06} width={76.73} height={69.06} rx={4.5} ry={4.5} fill={primaryColor} />
      ...
      <path fill="none" stroke="#535461" strokeMiterlimit={10} d="M536 276.74l4.36-4.12" />
      <path
        fill="none"
        stroke="#535461"
        strokeMiterlimit={10}
      ...
      />
      <path fill="none" stroke="#535461" strokeMiterlimit={10} d="M714.02 108.28l4.35-4.12M537.63 427.99l4.47 4.01" />
      <path
        fill="none"
        stroke="#535461"
        strokeMiterlimit={10}
      ...
      />
      <path fill="none" stroke="#535461" strokeMiterlimit={10} d="M718.02 589.93l4.46 4" />
      <circle cx={730.3} cy={573.91} r={129.29} fill="url(#prefix__c)" opacity={0.5} />
      ...
      <path
        ...
        fill="#fdb797"
      />
      <path d="M709.68 636.08a56.33 56.33 0 0 0 39.14.11v-4.81h-39.14z" opacity={0.1} />
      ...
      <path
        ...
        fill="#fdd835"
      />
      <circle cx={732.71} cy={129.29} r={129.29} fill="url(#prefix__d)" opacity={0.5} />
      ...
      <path
        ...
        fill="#fdb797"
      />
      <path d="M712.1 191.46a56.33 56.33 0 0 0 39.14.11v-4.81H712.1z" opacity={0.1} />
      <circle cx={731.74} cy={137.97} r={56.1} fill="#fdb797" />
      <path d="M691.78 86.94s23.64 48 90.34 20.12l-15.53-24.35-27.53-9.88z" opacity={0.1} />
      <path d="M691.78 86.24s23.64 48 90.34 20.12L766.59 82l-27.53-9.88z" fill="#333" />
      <path
