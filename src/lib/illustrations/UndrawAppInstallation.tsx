...
const UndrawAppInstallation = (_props: any) => {
  ...
  delete props.style;
  return (
    <svg data-name="Layer 1" width="1em" height="1em" viewBox="0 0 961.07 805.46" style={style} {...props}>
      <defs>
        <linearGradient id="prefix__a" x1={516.59} y1={775.99} x2={516.59} y2={47.27} gradientUnits="userSpaceOnUse">
          <stop offset={0} stopColor="gray" stopOpacity={0.25} />
          <stop offset={0.54} stopColor="gray" stopOpacity={0.12} />
          <stop offset={1} stopColor="gray" stopOpacity={0.1} />
        </linearGradient>
        <linearGradient id="prefix__b" x1={802.23} y1={799.75} x2={802.23} y2={247.72} xlinkHref="#prefix__a" />
      </defs>
      <path
      ...
      <path
        ...
        fill="url(#prefix__a)"
      />
      <rect x={128.77} y={8.73} width={536.72} height={713.44} rx={20} ry={20} fill="#535461" />
      ...
      <rect x={214.13} y={151.36} width={94} height={94} rx={11.85} ry={11.85} fill={primaryColor} />
      <rect
        x={605.59}
        y={198.63}
        width={94}
        ...
        opacity={0.2}
      />
      <rect x={350.13} y={151.36} width={94} height={94} rx={11.85} ry={11.85} fill={primaryColor} />
      <rect x={214.13} y={317.36} width={94} height={94} rx={11.85} ry={11.85} fill={primaryColor} />
      <rect
        x={605.59}
        y={364.63}
        width={94}
        ...
        opacity={0.2}
      />
      <rect x={350.13} y={317.36} width={94} height={94} rx={11.85} ry={11.85} fill={primaryColor} opacity={0.2} />
      <rect x={214.13} y={483.36} width={94} height={94} rx={11.85} ry={11.85} fill={primaryColor} />
      <rect
        x={605.59}
        y={530.63}
        width={94}
        ...
        fill={primaryColor}
      />
      <rect x={350.13} y={483.36} width={94} height={94} rx={11.85} ry={11.85} fill={primaryColor} />
      <path
      ...
      <path
        ...
        fill="#f7c4a7"
      />
      <path d="M608.01 274.01l-3.69 6.65h-11.79l-.25-3.1c5.49-.48 12.02-1.48 15.73-3.55z" opacity={0.1} />
      <path
        d="M608.9 274.12v15.06l-24.23 6.55s0-1.57-.07-3.75c-.14-4.6-.57-11.94-1.9-13.27.01.02 19.65.02 26.2-4.59z"
        fill="#e6e6f0"
      />
      <path d="M608.9 282.95v6.23l-24.23 6.55s0-1.57-.07-3.75c8.07-1.41 19.72-6.8 24.3-9.03z" opacity={0.1} />
      <path
      ...
      <path
        ...
        fill="#575988"
      />
      <path d="M647.21 465.66s10.48-4.58 28.16-3.27 49.16-14.41 49.16-14.41" opacity={0.1} />
      <path d="M666.2 611.73s.65 2-7.86 4.58-11.13 5.24-11.13 5.24" opacity={0.05} />
      <rect
        x={712.94}
        y={212.27}
        width={94}
      ...
      <path
        ...
        fill="#f7c4a7"
      />
      <path d="M686.17 265.6v.2l-2.62 5-16.37 1.31s-.34-1.35-.76-3.58c5.86-2.23 13.54-4.31 19.75-2.93z" opacity={0.1} />
      <path
      ...
      <path
        ...
        opacity={0.05}
      />
      <path d="M686.17 274.13v4.6l-23.57 12.44s-.27-2.13-.77-4.89c10.16-3.29 20.21-9.46 24.34-12.15z" opacity={0.1} />
      <path
        ...
        fill="#575988"
      />
      <rect x={790.7} y={714.35} width={156} height={14} rx={2.67} ry={2.67} fill={primaryColor} />
      <rect x={773.7} y={700.35} width={156} height={14} rx={2.67} ry={2.67} fill={primaryColor} />
      <rect x={773.7} y={700.35} width={156} height={14} rx={2.67} ry={2.67} opacity={0.05} />
    </svg>
  );
};
