...
const UndrawCamping = (_props: any) => {
  ...
  delete props.style;
  return (
    <svg data-name="Layer 1" width="1em" height="1em" viewBox="0 0 1070.95 699.99" style={style} {...props}>
      <defs>
        <linearGradient id="prefix__a" x1={330.01} y1={508.56} x2={330.01} y2={378.95} gradientUnits="userSpaceOnUse">
          <stop offset={0} stopColor="gray" stopOpacity={0.25} />
          <stop offset={0.54} stopColor="gray" stopOpacity={0.12} />
          <stop offset={1} stopColor="gray" stopOpacity={0.1} />
        </linearGradient>
        <linearGradient id="prefix__b" x1={331.18} y1={435.61} x2={331.18} y2={275.03} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__c" x1={330.79} y1={364.98} x2={330.79} y2={214.89} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__d" x1={330.01} y1={294.36} x2={330.01} y2={160.36} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__e" x1={330.01} y1={229.17} x2={330.01} y2={112} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__f" x1={330.79} y1={166.31} x2={330.79} y2={61.54} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__g" x1={810.81} y1={508.56} x2={810.81} y2={378.95} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__h" x1={811.97} y1={435.61} x2={811.97} y2={275.03} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__i" x1={811.58} y1={364.98} x2={811.58} y2={214.89} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__j" x1={810.81} y1={294.36} x2={810.81} y2={160.36} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__k" x1={810.81} y1={229.17} x2={810.81} y2={112} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__l" x1={811.58} y1={166.31} x2={811.58} y2={61.54} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__m" x1={716.62} y1={473.23} x2={722.45} y2={473.23} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__n" x1={666.57} y1={452.78} x2={666.57} y2={323.18} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__o" x1={667.73} y1={379.83} x2={667.73} y2={219.26} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__p" x1={667.34} y1={309.21} x2={667.34} y2={159.12} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__q" x1={666.57} y1={238.59} x2={666.57} y2={104.59} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__r" x1={666.57} y1={173.4} x2={666.57} y2={56.23} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__s" x1={667.34} y1={110.54} x2={667.34} y2={5.77} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__t" x1={572.39} y1={417.45} x2={578.22} y2={417.45} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__u" x1={512.71} y1={447.02} x2={512.71} y2={317.41} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__v" x1={513.88} y1={374.06} x2={513.88} y2={213.49} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__w" x1={513.49} y1={303.44} x2={513.49} y2={153.35} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__x" x1={512.71} y1={232.82} x2={512.71} y2={98.82} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__y" x1={512.71} y1={167.63} x2={512.71} y2={50.46} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__z" x1={513.49} y1={104.77} x2={513.49} y2={0} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__A" x1={418.53} y1={411.68} x2={424.36} y2={411.68} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__B" x1={433.73} y1={558.36} x2={718.73} y2={558.36} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__C" x1={213.13} y1={601.39} x2={213.13} y2={589.5} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__D" x1={277.65} y1={693.91} x2={277.65} y2={675.81} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__E" x1={247.54} y1={609.81} x2={247.54} y2={600.99} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__F" x1={312.07} y1={704.43} x2={312.07} y2={691.01} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__G" x1={213.44} y1={637.18} x2={213.44} y2={630.72} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__H" x1={277.97} y1={733.9} x2={277.97} y2={724.07} xlinkHref="#prefix__a" />
      </defs>
      <g opacity={0.5}>
        <path
        ...
        <path d="M538.48 144.47l.08 4.36a6.77 6.77 0 0 1-2.06.32l-7.45.08-.09-4.58z" opacity={0.1} />
        <path
        ...
        <path d="M453.93 146.23l.07 3.73a7.09 7.09 0 0 1-2.06.31l-7.45.08-.08-3.94z" opacity={0.1} />
        <path
        ...
        <path
          ...
          d="M451.69 338.69l-63.99-.28h-.07l-31.45-.13 2.86-42.1 17.45.31 55.74 11.32 17.47 26.32 1.99 4.56z"
        />
        <path fill={primaryColor} d="M451.69 338.69l-63.99-.28-1.59-28.14 46.12-2.46 17.47 26.32 1.99 4.56z" />
        <path d="M387.64 338.41l-31.45-.14 2.85-42.09s10.13 15.52 27.08 14.08z" fill="#fff" opacity={0.1} />
        <path
        ...
        <path
          ...
          fill="#636780"
        />
        <path fill="#636780" d="M368 261.12l12.49 11.82 4.24-10.87-17.96-10.03 1.23 9.08z" />
        <path
          fill={primaryColor}
        ...
        />
        <path opacity={0.15} d="M283.54 324.89l40.48 82.79 13.19 3.98 2.92-13.59-15.47-46.03-15.52-26.57-25.6-.58z" />
        <ellipse cx={324.48} cy={517.36} rx={70.47} ry={79.94} transform="translate(-74.24 -93.79)" fill="#636780" />
        <path
        ...
        <ellipse
          ...
          opacity={0.1}
        />
        <ellipse cx={209.07} cy={423.51} rx={12.9} ry={23.47} transform="translate(-72.48 -95.98)" fill="#dce0ed" />
        <path
        ...
        />
        <ellipse cx={171.1} cy={495.72} rx={5.5} ry={9.3} transform="rotate(-1.08 -5166.337 3869.403)" fill="#dce0ed" />
        <path
        ...
        <path
          ...
          opacity={0.1}
        />
        <path d="M56.48 409.13s2.7 8.68 1.6 9-1.6-9-1.6-9zM59.25 406.99s2.71 8.67 1.6 9-1.6-9-1.6-9z" opacity={0.1} />
        <path
        ...
        <ellipse
          ...
          opacity={0.1}
        />
        <ellipse cx={345.95} cy={520.23} rx={25.06} ry={41.13} transform="translate(-74.29 -93.38)" fill="#f0f0f4" />
        <ellipse
          cx={349.98}
          cy={492.55}
          rx={2.96}
        ...
        <path
          ...
          opacity={0.1}
        />
        <path d="M99.78 371.72s-41.26 21.72-10 40.8l8.28 1.75s-30.64-21.21 19.5-42.88z" opacity={0.1} />
        <path d="M101.05 371.7s-41.26 21.72-10 40.8l8.28 1.75s-30.64-21.21 19.5-42.89z" fill="#dce0ed" />
        <ellipse cx={597.46} cy={515.69} rx={23.16} ry={39.65} transform="translate(-74.15 -88.63)" fill="#636780" />
        <ellipse
          cx={596.7}
          cy={516.56}
          rx={16.83}
        ...
        <ellipse
          ...
          fill="#636780"
        />
        <ellipse cx={599.75} cy={516.47} rx={5.82} ry={9.42} transform="translate(-74.17 -88.59)" fill="#636780" />
      ...
      <path fill="url(#prefix__a)" d="M308.28 378.95h43.46v129.6h-43.46z" />
      <path fill="#795548" d="M311.39 378.95h37.25v127.28h-37.25z" />
      <path fill="url(#prefix__b)" d="M331.18 275.03L156.17 435.61h350.01l-175-160.58z" />
      <path fill="#4c4981" d="M331.18 279.25L163.16 431.31H499.2L331.18 279.25z" />
      <path fill="url(#prefix__c)" d="M330.79 214.9L178.68 364.98H482.9L330.79 214.9z" />
      <path fill="#4c4981" d="M330.79 218.98l-145.9 143.96h291.8l-145.9-143.96z" />
      <path fill="url(#prefix__d)" d="M330.01 160.36l-117.18 134H447.2l-117.19-134z" />
      <path fill="#4c4981" d="M330.01 166.48L218.26 291.3h223.51L330.01 166.48z" />
      <path fill="url(#prefix__e)" d="M330.01 112l-87.69 117.17h175.39L330.01 112z" />
      <path fill="#4c4981" d="M330.01 115.46L246.2 227.44h167.63l-83.82-111.98z" />
      <path fill="url(#prefix__f)" d="M330.79 61.54L270.3 166.31h120.98L330.79 61.54z" />
      <path fill="#4c4981" d="M330.79 64.65l-57.8 100.11h115.6l-57.8-100.11z" />
      <path fill="url(#prefix__g)" d="M789.08 378.95h43.46v129.6h-43.46z" />
      <path fill="#795548" d="M792.18 378.95h37.25v127.28h-37.25z" />
      <path fill="url(#prefix__h)" d="M811.97 275.03l-175 160.58h350l-175-160.58z" />
      <path fill="#4c4981" d="M811.97 279.25L643.95 431.31h336.04L811.97 279.25z" />
      <path fill="url(#prefix__i)" d="M811.58 214.9L659.47 364.98h304.22L811.58 214.9z" />
      <path fill="#4c4981" d="M811.58 218.98l-145.9 143.96h291.8l-145.9-143.96z" />
      <path fill="url(#prefix__j)" d="M810.81 160.36l-117.19 134h234.37l-117.18-134z" />
      <path fill="#4c4981" d="M810.81 166.48L699.05 291.3h223.51L810.81 166.48z" />
      <path fill="url(#prefix__k)" d="M810.81 112l-87.7 117.17H898.5L810.81 112z" />
      <path fill="#4c4981" d="M810.81 115.46l-83.82 111.98h167.63l-83.81-111.98z" />
      <path fill="url(#prefix__l)" d="M811.58 61.54l-60.49 104.77h120.98L811.58 61.54z" />
      ...
      <path
        ...
        fill="#fff"
      />
      <path fill="url(#prefix__n)" d="M644.84 323.18h43.46v129.6h-43.46z" />
      <path fill="#795548" d="M647.94 323.18h37.25v127.28h-37.25z" />
      <path fill="url(#prefix__o)" d="M667.73 219.26l-175 160.57h350.01L667.73 219.26z" />
      <path fill="#4c4981" d="M667.73 223.48L499.71 375.54h336.04L667.73 223.48z" />
      <path fill="url(#prefix__p)" d="M667.34 159.12l-152.1 150.09h304.21L667.34 159.12z" />
      <path fill="#4c4981" d="M667.34 163.21l-145.9 143.96h291.81L667.34 163.21z" />
      <path fill="url(#prefix__q)" d="M666.57 104.59l-117.19 134h234.37l-117.18-134z" />
      <path fill="#4c4981" d="M666.57 110.71L554.81 235.53h223.51L666.57 110.71z" />
      <path fill="url(#prefix__r)" d="M666.57 56.23l-87.7 117.17h175.39L666.57 56.23z" />
      <path fill="#4c4981" d="M666.57 59.69l-83.82 111.98h167.63L666.57 59.69z" />
      <path fill="url(#prefix__s)" d="M667.34 5.77l-60.48 104.77h120.97L667.34 5.77z" />
      ...
      <path
        ...
        fill="#fff"
      />
      <path fill="url(#prefix__u)" d="M490.98 317.41h43.46v129.6h-43.46z" />
      <path fill="#795548" d="M494.09 317.41h37.25v127.28h-37.25z" />
      <path fill="url(#prefix__v)" d="M513.88 213.49l-175 160.57h350l-175-160.57z" />
      <path fill="#4c4981" d="M513.88 217.71L345.86 369.77H681.9L513.88 217.71z" />
      <path fill="url(#prefix__w)" d="M513.49 153.35L361.38 303.44H665.6L513.49 153.35z" />
      <path fill="#4c4981" d="M513.49 157.44L367.59 301.4h291.8l-145.9-143.96z" />
      <path fill="url(#prefix__x)" d="M512.72 98.82l-117.19 134H629.9l-117.18-134z" />
      <path fill="#4c4981" d="M512.72 104.94L400.96 229.76h223.51L512.72 104.94z" />
      <path fill="url(#prefix__y)" d="M512.72 50.46l-87.7 117.17h175.39L512.72 50.46z" />
      <path fill="#4c4981" d="M512.72 53.91L428.9 165.9h167.63L512.72 53.91z" />
      <path fill="url(#prefix__z)" d="M513.49 0L453 104.77h120.98L513.49 0z" />
      ...
      <path
        ...
        fill="url(#prefix__A)"
      />
      <path fill="#71412d" d="M876.32 578.98h-13.54v-10.59h13.54zM872.2 595.46h-6.47v-16.48h6.47z" />
      <path fill="none" stroke="#71412d" strokeMiterlimit={10} strokeWidth={1.84} d="M770.28 435.85l95.45 143.13" />
      <path fill="#71412d" d="M276.32 568.38h13.54v10.59h-13.54zM280.44 578.98h6.47v16.48h-6.47z" />
      <path fill="none" stroke="#71412d" strokeMiterlimit={10} strokeWidth={1.84} d="M382.35 435.85l-95.44 143.13" />
      <path fill={primaryColor} d="M575.98 96.07L712.5 332.53l136.52 236.45H302.95l136.52-236.45L575.98 96.07z" />
      <path
        ...
        opacity={0.2}
      />
      <path fill={primaryColor} d="M438.28 539.46H714.6v39.43H438.28z" />
      <path fill="url(#prefix__B)" d="M433.73 534.36h285v48h-285z" />
      <path opacity={0.2} d="M438.28 539.46H714.6v39.43H438.28z" />
      <path fill="url(#prefix__C)" d="M208.73 589.5h8.79v11.9h-8.79z" />
      <path
        d="M277.65 675.81c-10.57 0-19.14 7.57-19.14 18.1h38.28c0-10.53-8.57-18.1-19.14-18.1z"
        transform="translate(-64.52 -100.01)"
        fill="url(#prefix__D)"
      />
      <path fill="url(#prefix__E)" d="M244.28 600.99h6.52v8.82h-6.52z" />
      <path
        d="M312.07 691c-7.84 0-14.2 5-14.2 13.42h28.39c0-8.42-6.36-13.42-14.19-13.42z"
        transform="translate(-64.52 -100.01)"
        fill="url(#prefix__F)"
      />
      <path fill="url(#prefix__G)" d="M211.06 630.72h4.78v6.46h-4.78z" />
      <path
      ...
      <path d="M214.4 578.45c-9.65 0-17.48 6.92-17.48 16.54h35c-.03-9.62-7.86-16.54-17.52-16.54z" fill="#ff6e40" />
      <path fill="#d5b7ac" d="M242.86 601.47h5.96v8.06h-5.96z" />
      <path d="M245.84 592.34c-7.16 0-13 4.57-13 12.26h25.93c.04-7.69-5.76-12.26-12.93-12.26z" fill="#ff6e40" />
      <path fill="#d5b7ac" d="M212.51 628.62h4.36v5.9h-4.36z" />
      <path d="M214.69 622.54c-5.24 0-9.49 3.22-9.49 9h19c-.01-5.78-4.26-9-9.51-9z" fill="#ff6e40" />
      <ellipse cx={913.96} cy={680.54} rx={156.99} ry={19.44} fill={primaryColor} opacity={0.1} />
      <path
        ...
        fill={primaryColor}
      />
      <path fill="#33323d" d="M851.77 628.4l44.02-7.96h65.92l-9.42 14.52h-91.55l-8.97-6.56z" />
      <path
      ...
      <path
        ...
        fill={primaryColor}
      />
      <ellipse cx={290.67} cy={623.54} rx={18.68} ry={3.16} fill={primaryColor} opacity={0.1} />
      <path
      ...
      <path
        ...
        opacity={0.2}
      />
      <ellipse cx={399} cy={586.75} rx={14.37} ry={2.43} fill={primaryColor} opacity={0.1} />
      <path
      ...
      <path
        ...
        opacity={0.2}
      />
      <ellipse cx={710.79} cy={620.34} rx={34.31} ry={5.8} fill={primaryColor} opacity={0.1} />
      <path
