...
const UndrawSwipeProfiles = (_props: any) => {
  ...
  delete props.style;
  return (
    <svg data-name="Layer 1" width="1em" height="1em" viewBox="0 0 945.76 774.02" style={style} {...props}>
      <defs>
        <linearGradient
          id="prefix__a"
          x1={762.62}
        ...
        <linearGradient id="prefix__b" x1={894.5} y1={336.85} x2={894.5} y2={132.23} xlinkHref="#prefix__a" />
        <linearGradient
          id="prefix__c"
          x1={-389.38}
          y1={725.38}
        ...
        <linearGradient
          ...
          xlinkHref="#prefix__a"
        />
        <linearGradient id="prefix__e" x1={469.32} y1={851.47} x2={753.85} y2={179.59} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__f" x1={601.5} y1={460.85} x2={601.5} y2={256.23} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__g" x1={531.38} y1={640.9} x2={531.38} y2={532.9} xlinkHref="#prefix__a" />
      </defs>
      <path
      ...
      <path
        ...
        fill="#3ad29f"
      />
      <circle cx={531.38} cy={586.9} r={54} fill="url(#prefix__g)" opacity={0.5} />
      <circle cx={531.38} cy={586.9} r={45} fill={primaryColor} />
      <path
      ...
      <path
        ...
        fill={primaryColor}
      />
      <path d="M460 310.55h30.6V335a15.3 15.3 0 0 1-15.3 15.3A15.3 15.3 0 0 1 460 335v-24.45z" opacity={0.1} />
      <path d="M460 309.41h30.6v24.48a15.3 15.3 0 0 1-15.3 15.3 15.3 15.3 0 0 1-15.3-15.3v-24.48z" fill="#fda57d" />
      <path d="M460.1 313.83a44 44 0 0 0 30.6.08v-3.76h-30.6z" opacity={0.1} />
      ...
      <path
        ...
        fill="#4d8af0"
      />
      <path d="M748 184.55h30.6V209a15.3 15.3 0 0 1-15.3 15.3A15.3 15.3 0 0 1 748 209v-24.45z" opacity={0.1} />
      <path d="M748 183.41h30.6v24.48a15.3 15.3 0 0 1-15.3 15.3 15.3 15.3 0 0 1-15.3-15.3v-24.48z" fill="#fdb797" />
      <path d="M748.1 187.83a44 44 0 0 0 30.6.08v-3.76h-30.6z" opacity={0.1} />
      ...
      <path
        ...
        fill="#f55f44"
      />
      <path d="M163 183.55h30.6V208a15.3 15.3 0 0 1-15.3 15.3A15.3 15.3 0 0 1 163 208v-24.45z" opacity={0.1} />
      <path d="M163 182.41h30.6v24.48a15.3 15.3 0 0 1-15.3 15.3 15.3 15.3 0 0 1-15.3-15.3v-24.48z" fill="#be7c5e" />
      <path d="M163.1 186.83a44 44 0 0 0 30.6.08v-3.76h-30.6z" opacity={0.1} />
