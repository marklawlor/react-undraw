...
const UndrawProfilePic = (_props: any) => {
  ...
  delete props.style;
  return (
    <svg data-name="Layer 1" width="1em" height="1em" viewBox="0 0 698 698" style={style} {...props}>
      <defs>
        <linearGradient id="prefix__a" x1={349} y1={698} x2={349} gradientUnits="userSpaceOnUse">
      ...
      <path
        ...
        fill="#fdb797"
      />
      <path d="M293.34 516.82a152.07 152.07 0 0 0 105.66.29v-13H293.34z" opacity={0.1} />
