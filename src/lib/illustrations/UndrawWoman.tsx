...
const UndrawWoman = (_props: any) => {
  ...
  delete props.style;
  return (
    <svg data-name="Layer 1" width="1em" height="1em" viewBox="0 0 626.12 698.31" style={style} {...props}>
      <defs>
        <linearGradient id="prefix__a" x1={445.06} y1={472.29} x2={445.06} y2={295.16} gradientUnits="userSpaceOnUse">
          <stop offset={0} stopColor="gray" stopOpacity={0.25} />
          <stop offset={0.54} stopColor="gray" stopOpacity={0.12} />
          <stop offset={1} stopColor="gray" stopOpacity={0.1} />
        </linearGradient>
        <linearGradient id="prefix__b" x1={139.14} y1={646.22} x2={166.86} y2={646.22} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__c" x1={207.95} y1={646.22} x2={235.66} y2={646.22} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__d" x1={413.73} y1={586.32} x2={538.68} y2={586.32} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__e" x1={410.06} y1={781.74} x2={453.79} y2={781.74} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__f" x1={495.33} y1={781.74} x2={539.06} y2={781.74} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__g" x1={188.06} y1={206.65} x2={188.06} y2={0} xlinkHref="#prefix__a" />
      </defs>
      <path
        ...
        fill="url(#prefix__a)"
      />
      <path fill="url(#prefix__b)" d="M139.14 628.95h27.71v34.53h-27.71z" />
      <path fill="url(#prefix__c)" d="M207.95 628.95h27.71v34.53h-27.71z" />
      <path
      ...
      <path
        ...
        fill="#212121"
      />
      <ellipse cx={188.06} cy={103.32} rx={98.06} ry={103.32} fill="url(#prefix__g)" />
      <ellipse cx={188.06} cy={103.32} rx={93.17} ry={98.17} fill={primaryColor} />
      <ellipse cx={186.69} cy={110.54} rx={76.85} ry={78.64} fill={primaryColor} />
      ...
      <path d="M264.51 188.31s-19.78.34-7.19 25.29l21-4.28 2.23-21a3 3 0 0 0-3.8-3.26z" fill="#ffcfbe" />
      <rect
        x={551.66}
        y={267.37}
        width={5.69}
      ...
      <path fill={primaryColor} d="M181.54 103.91h13.04v6.29h-13.04z" />
      ...
      <circle cx={158.53} cy={107.05} r={25.39} fill={primaryColor} />
      <circle cx={158.53} cy={107.05} r={17.79} opacity={0.3} />
      <circle cx={217.29} cy={107.05} r={25.39} fill={primaryColor} />
