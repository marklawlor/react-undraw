...
const UndrawTaken = (_props: any) => {
  ...
  delete props.style;
  return (
    <svg data-name="Layer 1" width="1em" height="1em" viewBox="0 0 840 726.85" style={style} {...props}>
      <defs>
        <linearGradient id="prefix__a" x1={432} y1={245.78} x2={432} y2={18.85} gradientUnits="userSpaceOnUse">
        ...
        <linearGradient
          ...
          xlinkHref="#prefix__a"
        />
        <linearGradient id="prefix__d" x1={432} y1={258.09} x2={432} y2={103.27} xlinkHref="#prefix__a" />
      </defs>
      <ellipse cx={432} cy={132.31} rx={146.46} ry={113.46} fill="url(#prefix__a)" opacity={0.8} />
      <ellipse cx={432} cy={132.31} rx={143.21} ry={110.94} fill={primaryColor} />
      <path
