...
const UndrawNotes = (_props: any) => {
  ...
  delete props.style;
  return (
    <svg data-name="Layer 1" width="1em" height="1em" viewBox="0 0 910.74 527.39" style={style} {...props}>
      <defs>
        <linearGradient id="prefix__a" x1={209.98} y1={290.83} x2={209.98} gradientUnits="userSpaceOnUse">
          <stop offset={0} stopColor="gray" stopOpacity={0.25} />
          <stop offset={0.54} stopColor="gray" stopOpacity={0.12} />
          <stop offset={1} stopColor="gray" stopOpacity={0.1} />
        </linearGradient>
        <linearGradient id="prefix__b" x1={356.48} y1={409.11} x2={356.48} y2={118.28} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__c" x1={502.98} y1={527.39} x2={502.98} y2={236.57} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__d" x1={912.16} y1={688.94} x2={912.16} y2={281.8} xlinkHref="#prefix__a" />
      </defs>
      <path fill="url(#prefix__a)" d="M0 0h419.96v290.83H0z" opacity={0.5} />
      ...
      />
      <path fill="url(#prefix__b)" d="M146.5 118.28h419.96v290.83H146.5z" opacity={0.5} />
      ...
      />
      <path fill="url(#prefix__c)" d="M293 236.57h419.96V527.4H293z" opacity={0.5} />
      <path fill="#eee" d="M297.34 240.91H709.7v283.23H297.34z" />
      <circle cx={364.35} cy={336.94} r={7.6} fill={primaryColor} />
      <circle cx={364.35} cy={382.52} r={7.6} fill={primaryColor} />
      <circle cx={364.35} cy={428.1} r={7.6} fill={primaryColor} />
      <path
        fill="#dfdfdf"
      ...
      <path
        ...
        fill={primaryColor}
      />
      <path d="M808.45 486.16h-25l-32.79 6.15a2.37 2.37 0 0 0-1.93 2.33 2.37 2.37 0 0 0 2.37 2.37h57.31z" fill="#333" />
      <path
      ...
      <path
        ...
        fill="#fda57d"
      />
      <path d="M766.13 219.21s-21.87 4.78-5.51 30.38" fill={primaryColor} />
      <path d="M792.17 221.38s-21.87 4.78-5.51 30.38" opacity={0.05} />
      <path d="M793.26 221.38s-21.87 4.78-5.51 30.38" fill={primaryColor} />
      <path
