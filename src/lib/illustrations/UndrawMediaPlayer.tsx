...
const UndrawMediaPlayer = (_props: any) => {
  ...
  delete props.style;
  return (
    <svg data-name="Layer 1" width="1em" height="1em" viewBox="0 0 1014.533 597.436" style={style} {...props}>
      <path
      ...
      <rect x={2.5} y={0.5} width={962} height={523} rx={13.638} fill="none" stroke="#3f3d56" strokeMiterlimit={10} />
      <path fill="none" stroke="#3f3d56" strokeMiterlimit={10} d="M0 37.039h962M0 100.5h962" />
      <circle cx={24.5} cy={22.5} r={10} fill="#f86b75" />
      <circle cx={55.5} cy={22.5} r={10} fill="#fad375" />
      <circle cx={86.5} cy={22.5} r={10} fill="#8bcc55" />
      <circle cx={27.5} cy={18.5} r={10} fill="none" stroke="#3f3d56" strokeMiterlimit={10} />
      <circle cx={58.5} cy={18.5} r={10} fill="none" stroke="#3f3d56" strokeMiterlimit={10} />
      <circle cx={89.5} cy={18.5} r={10} fill="none" stroke="#3f3d56" strokeMiterlimit={10} />
      <circle cx={225} cy={74} r={20} fill="#f2f2f2" />
      <circle cx={230} cy={69} r={20} fill="none" stroke="#3f3d56" strokeMiterlimit={10} />
      <rect x={505} y={63.5} width={99} height={27} rx={5.423} fill={primaryColor} />
      <rect x={646} y={63.5} width={99} height={27} rx={5.423} fill={primaryColor} />
      <rect x={512} y={55.5} width={99} height={27} rx={4.222} fill="none" stroke="#3f3d56" strokeMiterlimit={10} />
      <rect x={653} y={55.5} width={99} height={27} rx={4.222} fill="none" stroke="#3f3d56" strokeMiterlimit={10} />
      <rect
        x={115.5}
        y={165.5}
        width={710}
      ...
      <path
        ...
        fill="#605d82"
      />
      <path d="M337.83 316.2s-10.119-27.694-1.065-26.628 6.924 12.781 6.924 12.781V316.2z" fill="#fbbebe" />
      <path
        ...
        fill="#605d82"
      />
      <path d="M474.17 317.265s10.119-27.693 1.065-26.628-6.924 12.781-6.924 12.781v13.847z" fill="#fbbebe" />
      <path
      ...
      <path
        ...
        fill={primaryColor}
      />
      <path d="M907.862 580.861c0-76.184 47.71-137.832 106.67-137.832" fill="#46455b" />
      <path
      ...
      <path
        ...
        opacity={0.2}
      />
      <path fill="none" stroke="#3f3d56" strokeMiterlimit={10} d="M275 596h237M876.888 596.479h74" />
    </svg>
  );
};
