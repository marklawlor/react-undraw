...
const UndrawTeam = (_props: any) => {
  ...
  delete props.style;
  return (
    <svg data-name="Layer 1" width="1em" height="1em" viewBox="0 0 781.43 756.44" style={style} {...props}>
      <defs>
        <linearGradient id="prefix__a" x1={116.72} y1={237.98} x2={116.72} y2={6.21} gradientUnits="userSpaceOnUse">
          <stop offset={0} stopColor="gray" stopOpacity={0.25} />
          <stop offset={0.54} stopColor="gray" stopOpacity={0.12} />
          <stop offset={1} stopColor="gray" stopOpacity={0.1} />
        </linearGradient>
        <linearGradient id="prefix__b" x1={385.08} y1={490.21} x2={385.08} y2={258.44} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__c" x1={384.97} y1={232.29} x2={384.97} y2={0.51} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__d" x1={661.23} y1={231.77} x2={661.23} y2={0} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__e" x1={115.89} y1={482.62} x2={115.89} y2={250.85} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__f" x1={665.55} y1={495.47} x2={665.55} y2={263.7} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__g" x1={116.72} y1={743.15} x2={116.72} y2={511.38} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__h" x1={392.03} y1={756.44} x2={392.03} y2={524.67} xlinkHref="#prefix__a" />
      </defs>
      <circle cx={116.72} cy={122.09} r={115.89} fill="url(#prefix__a)" opacity={0.5} />
      ...
      <path
        ...
        fill="#be7c5e"
      />
      <path d="M98.25 177.82a50.5 50.5 0 0 0 35.09.1v-4.31H98.25z" opacity={0.1} />
      ...
      <circle cx={385.08} cy={374.32} r={115.89} fill="url(#prefix__b)" opacity={0.5} />
      ...
      <path
        ...
        fill="#fda57d"
      />
      <path d="M366.6 430.05a50.5 50.5 0 0 0 35.09.1v-4.31H366.6z" opacity={0.1} />
      ...
      <path
        ...
        fill="#f55f44"
      />
      <path d="M348.39 336.37s21.19 43 81 18l-13.92-21.83-24.67-8.86z" opacity={0.1} />
      <path d="M348.39 335.73s21.19 43 81 18l-13.92-21.83-24.67-8.86z" fill="#f55f44" />
      <path d="M364.72 320.07a249.85 249.85 0 0 1 39.18 0s-28.94 2.69-39.18 0z" fill="#333" />
      <path
      ...
      <path fill="#f55f44" d="M345.22 337l9.81-5.06 2.21 8.11-6.01 4.09-6.01-7.14z" />
      <circle cx={384.97} cy={116.4} r={115.89} fill="url(#prefix__c)" opacity={0.5} />
      ...
      <path
        ...
        fill="#be7c5e"
      />
      <path d="M366.49 172.13a50.5 50.5 0 0 0 35.09.1v-4.31h-35.09z" opacity={0.1} />
      ...
      <path d="M336.02 106.38h95.9s-8.19-38.72-44.44-36.25-51.46 36.25-51.46 36.25z" opacity={0.1} />
      <circle cx={661.23} cy={115.89} r={115.89} fill="url(#prefix__d)" opacity={0.5} />
      ...
      <path
        ...
        fill="#fda57d"
      />
      <path d="M642.72 171.61a50.5 50.5 0 0 0 35.09.1v-4.31h-35.09z" opacity={0.1} />
      <circle cx={660.36} cy={123.67} r={50.29} fill="#fda57d" />
      <path d="M624.54 77.93s21.19 43 81 18L691.62 74.1l-24.67-8.86z" opacity={0.1} />
      <path d="M624.54 77.3s21.19 43 81 18l-13.92-21.83-24.67-8.86z" fill="#72351c" />
      <path
      ...
      <circle cx={115.89} cy={366.73} r={115.89} fill="url(#prefix__e)" opacity={0.5} />
      ...
      <path
        ...
        fill="#fdb797"
      />
      <path d="M97.41 422.46a50.5 50.5 0 0 0 35.09.1v-4.34H97.41z" opacity={0.1} />
      <circle cx={115.01} cy={374.52} r={50.29} fill="#fdb797" />
      <path d="M79.2 328.77s21.19 43 81 18l-13.92-21.83-24.67-8.86z" opacity={0.1} />
      <path d="M79.2 328.14s21.19 43 81 18l-13.92-21.83-24.67-8.86z" fill="#333" />
      <path
      ...
      <circle cx={665.55} cy={379.58} r={115.89} fill="url(#prefix__f)" opacity={0.5} />
      ...
      <path
        ...
        fill="#fdb797"
      />
      <path d="M647.07 435.31a50.5 50.5 0 0 0 35.09.1v-4.31h-35.09z" opacity={0.1} />
      ...
      <rect
        ...
        strokeWidth={2}
      />
      <path d="M654.72 388.65s6.82-3.7 19.5 0" fill="none" stroke="#333" strokeMiterlimit={10} strokeWidth={2} />
      <path d="M699.44 350.92l12.34 28.67s15.09-19.02-12.34-28.67z" fill="#858585" />
      <path
        fill="none"
        stroke="#333"
        strokeLinecap="round"
      ...
      />
      <path d="M629.92 350.92l-12.34 28.67s-15.09-19.02 12.34-28.67z" fill="#858585" />
      <path
        fill="none"
        stroke="#333"
        strokeLinecap="round"
      ...
      />
      <circle cx={116.72} cy={627.26} r={115.89} fill="url(#prefix__g)" opacity={0.5} />
      ...
      <path
        ...
        fill="#fdb797"
      />
      <path d="M98.25 682.99a50.5 50.5 0 0 0 35.09.1v-4.31H98.25z" opacity={0.1} />
      ...
      <path
        ...
        fill="#fdd835"
      />
      <circle cx={392.03} cy={640.55} r={115.89} fill="url(#prefix__h)" opacity={0.5} />
      ...
      <path
        ...
        fill="#fda57d"
      />
      <path d="M373.56 696.28a50.5 50.5 0 0 0 35.09.1v-4.31h-35.09z" opacity={0.1} />
