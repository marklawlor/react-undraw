...
const UndrawMetrics = (_props: any) => {
  ...
  delete props.style;
  return (
    <svg data-name="Layer 1" width="1em" height="1em" viewBox="0 0 902.289 674.064" style={style} {...props}>
      <path
        d="M181.58 390.433s23.126 1.542 27.237-1.542 21.585 4.112 23.127 8.223-24.669 4.626-28.78 4.626-23.64 6.167-23.64 6.167z"
        fill="#fbbebe"
      />
      <path d="M240.222 338.82a56.628 56.628 0 0 0-37.317 78.332l51.524-23.505z" fill={primaryColor} />
      <path d="M266.589 402.418l-51.525 23.506a56.636 56.636 0 1 0 37.317-78.333z" fill={primaryColor} />
      <path
      ...
      <path
        ...
        opacity={0.1}
      />
      <path fill="none" stroke="#3f3d56" strokeMiterlimit={10} d="M0 673.564h358.509M351.51 613.032s211-123 483 0" />
      <path
        ...
        strokeMiterlimit={10}
      />
      <path fill="none" stroke="#3f3d56" strokeMiterlimit={10} d="M387.009 61.971h408V533.03h-408z" />
      <circle cx={593.009} cy={31} r={10} fill="none" stroke="#3f3d56" strokeMiterlimit={10} />
      <path
      ...
      <ellipse cx={836.64} cy={492.44} rx={16.296} ry={7.915} fill="#57b894" />
      ...
      <path fill="none" stroke="#3f3d56" strokeMiterlimit={10} d="M455.509 161.032v226h265" />
      <path
        fill={primaryColor}
