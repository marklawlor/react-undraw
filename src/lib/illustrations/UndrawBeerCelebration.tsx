...
const UndrawBeerCelebration = (_props: any) => {
  ...
  delete props.style;
  return (
    <svg data-name="Layer 1" width="1em" height="1em" viewBox="0 0 815.19 739" style={style} {...props}>
      <defs>
        <linearGradient
          id="prefix__a"
          x1={951.7}
        ...
        <linearGradient id="prefix__b" x1={785.7} y1={711.37} x2={785.7} y2={333.37} xlinkHref="#prefix__a" />
        <linearGradient
          id="prefix__c"
          x1={768.63}
          y1={421.56}
      ...
      <circle
        ...
        opacity={0.4}
      />
      <path d="M742 424.5a1.5 1.5 0 0 0 0-3 1.5 1.5 0 0 0 0 3z" fill="#f5f5f5" />
      <path
