...
const UndrawChoose = (_props: any) => {
  ...
  delete props.style;
  return (
    <svg data-name="Layer 1" width="1em" height="1em" viewBox="0 0 567 785.72" style={style} {...props}>
      <defs>
        <linearGradient id="prefix__a" x1={378.18} y1={511.24} x2={697.95} y2={511.24} gradientUnits="userSpaceOnUse">
      ...
      />
      <path opacity={0.1} d="M528.76 115.47l-54.26-16.4-3.34 74.2 57.1 17.21.5-75.01z" />
      <path fill="#3ad29f" d="M528.76 257.59l-54.26-16.4-3.34 74.2 57.1 17.21.5-75.01z" />
      <path fill="#3ad29f" d="M146.81 142.12v75.5l324.35 97.77 3.34-74.2-327.69-99.07z" />
      <path opacity={0.1} d="M528.76 257.59l-54.26-16.4-3.34 74.2 57.1 17.21.5-75.01z" />
      <path
        fill="none"
        stroke="#fff"
        strokeLinecap="round"
      ...
      />
      <g opacity={0.4} fill="none" stroke="#fff" strokeLinecap="round" strokeMiterlimit={10} strokeWidth={7}>
        <path d="M488.78 128.3l17.77 31.09M510.99 132.74l-22.21 22.21" />
      </g>
      <path fill="#f5f5f5" d="M528.76 390.83l-54.26-16.4-3.34 74.2 57.1 17.21.5-75.01z" />
      <path fill="#f5f5f5" d="M146.81 275.36v75.5l324.35 97.77 3.34-74.2-327.69-99.07z" />
      <path opacity={0.1} d="M528.76 390.83l-54.26-16.4-3.34 74.2 57.1 17.21.5-75.01z" />
      <g opacity={0.4} fill="none" stroke="#fff" strokeLinecap="round" strokeMiterlimit={10} strokeWidth={7}>
        <path d="M488.78 403.66l17.77 31.09M510.99 408.1l-22.21 22.21" />
      </g>
      <ellipse cx={371.09} cy={243.78} rx={11.1} ry={22.21} opacity={0.3} />
      <ellipse cx={371.09} cy={243.78} rx={93.27} ry={186.53} fill={primaryColor} opacity={0.1} />
      <ellipse cx={371.09} cy={243.78} rx={51.07} ry={102.15} fill="#fff" opacity={0.1} />
      <path
      ...
      <path
        ...
        opacity={0.05}
      />
      <path fill="#fda57d" d="M146.81 212.69l-4.44 31.09 39.97 22.2v-44.41l-35.53-8.88z" />
      <path
