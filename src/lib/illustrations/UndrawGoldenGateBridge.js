...
const UndrawGoldenGateBridge = props => (
  ...
  >
    ...
    <path
      ...
      opacity={0.2}
    />
    <ellipse cx={331.45} cy={200.38} rx={48.05} ry={47.41} fill="url(#a)" />
    <circle cx={331.45} cy={200.38} r={41.88} fill="#ff9800" />
    <path fill="url(#b)" d="M899.04 247.4h19.92v115.09h-19.92z" />
    <path fill="url(#c)" d="M904.73 193.96h8.54v69.88h-8.54z" />
    <path fill="url(#d)" d="M217.04 247.4h19.92v115.09h-19.92z" />
    <path fill="url(#e)" d="M222.73 193.96h8.54v69.88h-8.54z" />
    <path fill="url(#f)" d="M125.5 444.96h886v28h-886z" />
    <path
      fill={props.primaryColor}
      d="M128.5 448.96h879v17h-879zM128.5 465.96h879v3h-879z"
    />
    <path opacity={0.2} d="M132 468.93h879v3H132z" />
    <path fill={props.primaryColor} d="M214 351.46h26v116h-26z" />
    <path fill={props.primaryColor} d="M220 250.46h14v112h-14z" />
    <path
      fill={props.primaryColor}
      d="M224 198.46h6v68h-6zM922 467.46h-26v-116h26z"
    />
    <path fill={props.primaryColor} d="M902 250.46h14v112h-14z" />
    <path
      fill={props.primaryColor}
    ...
    <rect
      ...
      fill={props.primaryColor}
    />
    <circle cx={717.37} cy={430.9} r={0.58} fill={props.primaryColor} />
    <circle cx={717.37} cy={435.5} r={0.58} fill={props.primaryColor} />
    <circle cx={717.37} cy={440.11} r={0.58} fill={props.primaryColor} />
    <circle cx={746.79} cy={440.11} r={0.58} fill={props.primaryColor} />
    <circle cx={746.79} cy={435.5} r={0.58} fill={props.primaryColor} />
    <circle cx={746.79} cy={430.9} r={0.58} fill={props.primaryColor} />
    <rect
      x={715.9}
      y={445.29}
      width={1.75}
    ...
    <rect
      ...
      fill={props.primaryColor}
    />
    <circle cx={429.37} cy={430.9} r={0.58} fill={props.primaryColor} />
    <circle cx={429.37} cy={435.5} r={0.58} fill={props.primaryColor} />
    <circle cx={429.37} cy={440.11} r={0.58} fill={props.primaryColor} />
    <circle cx={458.79} cy={440.11} r={0.58} fill={props.primaryColor} />
    <circle cx={458.79} cy={435.5} r={0.58} fill={props.primaryColor} />
    <circle cx={458.79} cy={430.9} r={0.58} fill={props.primaryColor} />
    <rect
      x={427.9}
      y={445.29}
      width={1.75}
    ...
    <rect
      ...
      fill={props.primaryColor}
    />
    <circle cx={285.37} cy={430.9} r={0.58} fill={props.primaryColor} />
    <circle cx={285.37} cy={435.5} r={0.58} fill={props.primaryColor} />
    <circle cx={285.37} cy={440.11} r={0.58} fill={props.primaryColor} />
    <circle cx={314.79} cy={440.11} r={0.58} fill={props.primaryColor} />
    <circle cx={314.79} cy={435.5} r={0.58} fill={props.primaryColor} />
    <circle cx={314.79} cy={430.9} r={0.58} fill={props.primaryColor} />
    <rect
      x={283.9}
      y={445.29}
      width={1.75}
