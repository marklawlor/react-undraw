...
const UndrawFriendship = (_props: any) => {
  ...
  delete props.style;
  return (
    <svg data-name="Layer 1" width="1em" height="1em" viewBox="0 0 1142.23 781.11" style={style} {...props}>
      <defs>
        <linearGradient
          id="prefix__a"
          x1={380.12}
      ...
      <path
        ...
        opacity={0.1}
      />
      <circle cx={939.95} cy={375.52} r={102.23} fill={primaryColor} />
      <circle cx={831.23} cy={347.59} r={102.23} fill={primaryColor} />
      <circle cx={711.55} cy={348.59} r={102.23} fill={primaryColor} />
      <circle cx={672.65} cy={375.52} r={102.23} fill={primaryColor} />
      <circle cx={606.82} cy={384.5} r={102.23} fill={primaryColor} />
      <circle cx={579.89} cy={303.71} r={102.23} fill={primaryColor} />
      <circle cx={609.81} cy={209.95} r={102.23} fill={primaryColor} />
      <circle cx={666.66} cy={209.95} r={102.23} fill={primaryColor} />
      <circle cx={699.58} cy={168.06} r={102.23} fill={primaryColor} />
      <circle cx={783.36} cy={213.94} r={102.23} fill={primaryColor} />
      <circle cx={978.85} cy={303.71} r={102.23} fill={primaryColor} />
      <circle cx={920} cy={252.84} r={102.23} fill={primaryColor} />
      <circle cx={882.1} cy={201.97} r={102.23} fill={primaryColor} />
      <circle cx={810.29} cy={125.17} r={102.23} fill={primaryColor} />
      <circle cx={943.94} cy={209.95} r={102.23} fill={primaryColor} />
      <g opacity={0.1}>
      ...
      <path d="M889.46 554.67s62.5-52.53 31.58-127.33l-30.92-11.58-33.55 103.29z" fill="#67647e" />
      <path
        d="M892.79 412.2l7.4 2.77-32.94 101.41 28.74 31.12c-2.38 2.37-3.86 3.61-3.86 3.61l-32.9-35.62z"
        opacity={0.1}
      />
      <ellipse cx={579.5} cy={687.94} rx={556.5} ry={93.16} fill={primaryColor} opacity={0.1} />
      <path
      ...
      <path
        ...
        opacity={0.1}
      />
      <path d="M22.04 553.66s57.74 44.58 79.17 116.89" fill="none" stroke="#535461" strokeMiterlimit={10} />
      <path
        d="M115.75 609.12s-41-7-13 60.91c0 0 28.49-10.86 30.71-37.88a21.56 21.56 0 0 0-17.15-22.92z"
        fill={primaryColor}
      />
      <path d="M116.35 609.05s7.81 37.56-13.56 61" fill="none" stroke="#535461" strokeMiterlimit={10} />
      <path
      ...
      <path
        ...
        opacity={0.2}
      />
      <circle cx={939.95} cy={352.58} r={102.23} fill={primaryColor} />
      <circle cx={831.23} cy={324.65} r={102.23} fill={primaryColor} />
      <circle cx={711.55} cy={325.65} r={102.23} fill={primaryColor} />
      <circle cx={672.65} cy={352.58} r={102.23} fill={primaryColor} />
      <circle cx={606.82} cy={361.56} r={102.23} fill={primaryColor} />
      <circle cx={579.89} cy={280.77} r={102.23} fill={primaryColor} />
      <circle cx={609.81} cy={187.01} r={102.23} fill={primaryColor} />
      <circle cx={666.66} cy={187.01} r={102.23} fill={primaryColor} />
      <circle cx={699.58} cy={145.12} r={102.23} fill={primaryColor} />
      <circle cx={783.36} cy={191} r={102.23} fill={primaryColor} />
      <circle cx={978.85} cy={280.77} r={102.23} fill={primaryColor} />
      <circle cx={920} cy={229.9} r={102.23} fill={primaryColor} />
      <circle cx={882.1} cy={179.03} r={102.23} fill={primaryColor} />
      <circle cx={810.29} cy={102.23} r={102.23} fill={primaryColor} />
      <circle cx={943.94} cy={187.01} r={102.23} fill={primaryColor} />
      <path
      ...
      <path
        ...
        fill="#ffd2d9"
      />
      <path d="M876.31 636.11a49.72 49.72 0 0 0 9.9 4.4c4.93 1.52 10.58-.08 13.31-1.06v-3.9l-23-2.61z" opacity={0.1} />
      <path
        d="M899.78 632.16l1.34 5.59s-8.16 3.8-14.94 1.72a59.33 59.33 0 0 1-13-6.26c-1-.52 4.17-6.26 4.17-6.26z"
        fill="#cedad5"
      />
      <path d="M749.48 695.82a42.39 42.39 0 0 0-11.48-6.27 41 41 0 0 1-11-5.74" opacity={0.1} />
      <path
        ...
        opacity={0.2}
      />
      <path d="M679.19 737.24q-.11.47-.25.93c-.51-.29-1.24-.85.25-.93z" fill="#0f0" opacity={0.05} />
      <path
      ...
      <path
        ...
        opacity={0.1}
      />
      <path d="M483.33 627.87l29.28 29.28s-10.19 8.91-8.06 18.25l-21.22-23.77z" fill="#c4c8e2" />
      <path d="M483.54 627.87v23.77l3.4 3.81 10.09 11.3 7.73 8.66c-2.12-9.34 8.06-18.25 8.06-18.25z" opacity={0.1} />
      <path
        ...
        fill="#d39999"
      />
      <path d="M482.9 562.09s-6.37 17.4 0 30.56-37.78-7.22-37.78-7.22 9.76-4.67 6.37-27.16z" fill="#fdc2cc" />
      <path
      ...
      <path
        ...
        fill="#5f5d7e"
      />
      <path d="M507.52 678.37s15.28-8.49 23.77-3 7.64 20.37-4.24 20.79-18.25-6.79-18.25-6.79z" fill="#fdc2cc" />
      <path
      ...
      <path
        ...
        opacity={0.1}
      />
      <path d="M445.12 548.08a26.86 26.86 0 0 0 .81 6.58l.09.34a26.87 26.87 0 1 0-.9-6.91z" fill="#fdc2cc" />
      <path
