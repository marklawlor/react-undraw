...
const UndrawMailSent = (_props: any) => {
  ...
  delete props.style;
  return (
    <svg data-name="Layer 1" width="1em" height="1em" viewBox="0 0 737.61 734.73" style={style} {...props}>
      <defs>
        <linearGradient id="prefix__a" x1={600} y1={817.36} x2={600} y2={82.64} gradientUnits="userSpaceOnUse">
