...
const UndrawForSale = (_props: any) => {
  ...
  delete props.style;
  return (
    <svg data-name="Layer 1" width="1em" height="1em" viewBox="0 0 886 757.3" style={style} {...props}>
      <defs>
        <linearGradient id="prefix__a" x1={709} y1={237.54} x2={768} y2={237.54} gradientUnits="userSpaceOnUse">
          <stop offset={0} stopColor="gray" stopOpacity={0.25} />
          <stop offset={0.54} stopColor="gray" stopOpacity={0.12} />
          <stop offset={1} stopColor="gray" stopOpacity={0.1} />
        </linearGradient>
        <linearGradient id="prefix__b" x1={816} y1={110} x2={816} y2={0} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__c" x1={347.64} y1={559.73} x2={347.64} y2={158.42} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__d" x1={205.4} y1={660.58} x2={205.4} y2={215.07} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__e" x1={527.17} y1={577.53} x2={527.17} y2={241.78} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__f" x1={356.61} y1={658.33} x2={356.61} y2={284.4} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__g" x1={719.08} y1={790.22} x2={719.08} y2={410} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__h" x1={561.04} y1={372.91} x2={561.04} y2={256.23} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__i" x1={400.09} y1={530.21} x2={400.09} y2={427.08} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__j" x1={719.9} y1={530.21} x2={719.9} y2={427.08} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__k" x1={560.01} y1={430.7} x2={560.01} y2={100.75} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__l" x1={560.52} y1={716.16} x2={560.52} y2={543.75} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__m" x1={592.29} y1={643.76} x2={592.29} y2={618.76} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__n" x1={558.44} y1={741.68} x2={558.44} y2={691.68} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__o" x1={424.15} y1={725.92} x2={424.15} y2={540.93} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__p" x1={273.95} y1={740.07} x2={273.95} y2={534.71} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__q" x1={506.91} y1={734.12} x2={506.91} y2={579.36} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__r" x1={343.65} y1={739.03} x2={343.65} y2={566.66} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__s" x1={45.22} y1={748.2} x2={45.22} y2={468.2} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__t" x1={147} y1={528.64} x2={147} y2={479.76} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__u" x1={45.67} y1={511.76} x2={45.67} y2={495.76} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__v" x1={259.89} y1={511.76} x2={259.89} y2={495.76} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__w" x1={75.89} y1={627.76} x2={247.44} y2={627.76} xlinkHref="#prefix__a" />
        <linearGradient
          id="prefix__x"
          x1={500.45}
          y1={749.89}
      ...
      <path fill="url(#prefix__a)" d="M709 242.4V176h59v123.07l-59-56.67z" />
      <path fill={primaryColor} d="M716 247v-58h44v110.07L716 247z" />
      <circle cx={816} cy={55} r={55} fill="url(#prefix__b)" />
      ...
      <path
        ...
        fill="#00897b"
      />
      <path fill="url(#prefix__d)" d="M196.44 215.07h17.91v445.51h-17.91z" />
      ...
      <path fill="url(#prefix__f)" d="M346.43 284.4h20.37v373.92h-20.37z" />
      ...
      <circle cx={561.04} cy={314.57} r={58.34} fill="url(#prefix__h)" />
      <path fill="url(#prefix__i)" d="M348.53 427.08h103.13v103.13H348.53z" />
      <path fill="url(#prefix__j)" d="M668.34 427.08h103.13v103.13H668.34z" />
      <path
        fill="url(#prefix__k)"
      ...
      />
      <path fill="url(#prefix__l)" d="M497.5 543.75h126.05v172.41H497.5z" />
      <path fill={primaryColor} d="M501.14 547.4H619.9v168.76H501.14zM353.22 430.72h95.84v33.86h-95.84z" />
      <path fill={primaryColor} opacity={0.2} d="M353.22 464.58h95.84v61.98h-95.84z" />
      <path fill={primaryColor} d="M671.99 430.72h95.84v33.86h-95.84z" />
      <path fill={primaryColor} opacity={0.2} d="M671.99 464.58h95.84v61.98h-95.84z" />
      <path d="M560.52 367.18A53.13 53.13 0 0 0 613.65 314H507.39a53.13 53.13 0 0 0 53.13 53.18z" fill={primaryColor} />
      <path d="M560.52 366.66a53.13 53.13 0 0 0 53.13-53.13H507.39a53.13 53.13 0 0 0 53.13 53.13z" opacity={0.2} />
      <path
      ...
      <path
        ...
        opacity={0.2}
      />
      <circle cx={592.29} cy={631.26} r={12.5} fill="url(#prefix__m)" />
      <circle cx={592.29} cy={631.26} r={9.38} fill="#263238" />
      <path fill="url(#prefix__n)" d="M481.87 691.68H635v50H481.87z" />
      ...
      <path
        ...
        fill="#00897b"
      />
      <path fill="url(#prefix__p)" d="M269.82 534.71h8.26v205.36h-8.26z" />
      ...
      <path fill="url(#prefix__r)" d="M338.96 566.66h9.39v172.36h-9.39z" />
      ...
      <path fill="url(#prefix__s)" d="M22.56 468.2h45.33v280H22.56z" />
      <path fill="#f5f5f5" d="M26.11 473.53h38.22v264.89H26.11z" />
      <path fill="url(#prefix__t)" d="M11 479.76h272v48.89H11z" />
      <path fill="#f5f5f5" d="M14.56 523.31v-38.22h264.89v38.22z" />
      <circle cx={45.67} cy={503.76} r={8} fill="url(#prefix__u)" />
      <circle cx={259.89} cy={503.76} r={8} fill="url(#prefix__v)" />
      <circle cx={45.67} cy={503.76} r={6.22} fill="#e6e6e6" />
      <circle cx={259.89} cy={503.76} r={6.22} fill="#e6e6e6" />
      <path fill="url(#prefix__w)" d="M75.89 569.53h171.56v116.44H75.89z" />
      <path fill={primaryColor} d="M77.22 570.87h168.89v112H77.22z" />
      <path
        fill="#fff"
      ...
      <path
        ...
        fill="#00897b"
      />
      <path fill="url(#prefix__y)" d="M790.69 570.59h7.51V757.3h-7.51z" />
      ...
      <path fill="url(#prefix__A)" d="M726.81 599.65h8.54v156.71h-8.54z" />
