...
const UndrawFilter = (_props: any) => {
  ...
  delete props.style;
  return (
    <svg data-name="Layer 1" width="1em" height="1em" viewBox="0 0 857.1 758.83" style={style} {...props}>
      <defs>
        <linearGradient
          id="prefix__a"
          x1={728.85}
        ...
        <linearGradient
          ...
          xlinkHref="#prefix__a"
        />
        <linearGradient id="prefix__e" x1={118.53} y1={758.83} x2={118.53} y2={526.53} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__f" x1={424.76} y1={252.76} x2={424.76} y2={157.57} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__g" x1={266.79} y1={132.04} x2={266.79} y2={50.65} xlinkHref="#prefix__a" />
        <linearGradient
          id="prefix__h"
          x1={879.08}
          y1={629.37}
        ...
        <linearGradient
          ...
          xlinkHref="#prefix__a"
        />
        <linearGradient id="prefix__l" x1={412.8} y1={499.65} x2={412.8} y2={373.23} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__m" x1={738.57} y1={755.54} x2={738.57} y2={523.23} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__n" x1={427.78} y1={756.43} x2={427.78} y2={522.45} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__o" x1={426.61} y1={68.13} x2={426.61} y2={0} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__p" x1={713.61} y1={139.13} x2={713.61} y2={71} xlinkHref="#prefix__a" />
      </defs>
      <g opacity={0.5}>
        <path
      ...
      <path fill="url(#prefix__e)" d="M0 526.53h237.07v232.3H0z" />
      <path fill="#fff" d="M1.19 528.31h234.69v228.73H1.19z" />
      <path fill={primaryColor} d="M25.02 547.31h187.03v145.2H25.02z" />
      <path fill="#e0e0e0" d="M36.4 708.02h165.15v7.61H36.4zM62.75 723.23H175.2v7.61H62.75z" />
      <path fill="url(#prefix__f)" d="M382.92 157.57h83.67v95.18h-83.67z" opacity={0.5} />
      ...
      <path
        ...
        fill="#fff"
      />
      <path fill="url(#prefix__g)" d="M231.01 50.65h71.54v81.39h-71.54z" opacity={0.5} />
      ...
      <path fill="url(#prefix__m)" d="M620.03 523.23H857.1v232.3H620.03z" />
      <path fill="#fff" d="M621.23 525.02h234.69v228.73H621.23z" />
      <path fill={primaryColor} d="M645.05 544.01h187.03v145.2H645.05z" />
      <path fill="#e0e0e0" d="M658.27 709.61h165.15v7.61H658.27zM684.62 724.82h112.45v7.61H684.62z" />
      <path fill="url(#prefix__n)" d="M308.39 522.45h238.78v233.98H308.39z" />
      <path fill="#fff" d="M309.59 524.25h236.38v230.38H309.59z" />
      <path fill={primaryColor} d="M333.59 543.38h188.38v146.25H333.59z" />
      ...
      />
      <g opacity={0.5}>
        <path fill="url(#prefix__o)" d="M396.67 0h59.89v68.13h-59.89z" opacity={0.5} />
      ...
      <g opacity={0.5}>
        <path fill="url(#prefix__p)" d="M683.67 71h59.89v68.13h-59.89z" opacity={0.5} />
