...
const UndrawToTheStars = props => (
  ...
  >
    ...
    <path
      ...
      fill="url(#o)"
    />
    <circle cx={710.43} cy={603.27} r={13.36} fill="url(#p)" opacity={0.7} />
    <circle cx={710.43} cy={603.27} r={12.38} fill="url(#q)" />
    <circle cx={771.61} cy={732.18} r={14.57} fill="url(#r)" opacity={0.7} />
    <circle cx={771.61} cy={732.18} r={13.84} fill="url(#s)" />
    <circle cx={148.17} cy={649.15} r={16.01} fill="url(#t)" opacity={0.7} />
