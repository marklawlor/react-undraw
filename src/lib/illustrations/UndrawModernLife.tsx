...
const UndrawModernLife = (_props: any) => {
  ...
  delete props.style;
  return (
    <svg data-name="Layer 1" width="1em" height="1em" viewBox="0 0 664.5 714" style={style} {...props}>
      <path fill="#3c354c" d="M132.5 713h532v1h-532z" />
      <path
      ...
      <path
        ...
        opacity={0.1}
      />
      <path d="M365.18 292l-17.22-10s-41.62-5.74-35.88-25.83 34.45 0 34.45 0L365.18 269z" fill="#ffc1c7" />
      <path d="M365.18 292l-17.22-10s-41.62-5.74-35.88-25.83 34.45 0 34.45 0L365.18 269z" opacity={0.1} />
      <path
      ...
      <path
        ...
        opacity={0.1}
      />
      <circle cx={386.71} cy={137.01} r={34.44} fill="#ffc1c7" />
      <path
      ...
      <path
        ...
        fill={primaryColor}
      />
      <ellipse cx={411} cy={137.5} rx={6.91} ry={10.36} fill="#ffc1c7" />
      <circle cx={411} cy={138.65} r={3.45} fill="#f2f2f2" />
      <ellipse cx={675.87} cy={236.83} rx={4.03} ry={1.73} transform="rotate(-63.3 466.557 407.517)" fill="#f2f2f2" />
      <path
      ...
      <path
        ...
        opacity={0.1}
      />
      <path fill="#3c354c" opacity={0.3} d="M63 38h127v12H63z" />
      <path d="M247.5 192.87L221.72 148H0V1h292v147h-44.5zM1 147h221.3l24.2 42.13V147H291V2H1z" opacity={0.1} />
      <path d="M247.5 191.87L221.72 147H0V0h292v147h-44.5zM1 146h221.3l24.2 42.13V146H291V1H1z" fill="#f2f2f2" />
      <circle cx={33} cy={44} r={16.5} fill="#3c354c" opacity={0.3} />
      <circle cx={239.5} cy={112.5} r={6} fill={primaryColor} opacity={0.3} />
      <circle cx={254.5} cy={112.5} r={6} fill={primaryColor} opacity={0.3} />
      <circle cx={269.5} cy={112.5} r={6} fill={primaryColor} opacity={0.3} />
    </svg>
  );
};
