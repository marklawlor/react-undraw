...
const UndrawHiring = (_props: any) => {
  ...
  delete props.style;
  return (
    <svg data-name="Layer 1" width="1em" height="1em" viewBox="0 0 874.47 747.94" style={style} {...props}>
      <defs>
        <linearGradient
          id="prefix__a"
          x1={769.97}
        ...
        <linearGradient
          ...
          xlinkHref="#prefix__a"
        />
        <linearGradient id="prefix__e" x1={480.71} y1={712.84} x2={480.71} y2={165.47} xlinkHref="#prefix__a" />
        <linearGradient
          id="prefix__f"
          x1={-513.22}
          y1={427.6}
          ...
          xlinkHref="#prefix__a"
        />
        <linearGradient id="prefix__g" x1={652.07} y1={747.94} x2={652.07} y2={579.17} xlinkHref="#prefix__a" />
      </defs>
      <path
        ...
        opacity={0.5}
      />
      <path fill="#f5f5f5" d="M407.334 534.045L487.19 4.765l381.759 57.6-79.857 529.28z" />
      <path
        fill="#e0e0e0"
      ...
      />
      <path fill={primaryColor} d="M663.363 172.172L780.26 189.81l-2.52 16.7-116.897-17.637z" />
      <path
        fill="#e0e0e0"
      ...
      />
      <path fill={primaryColor} d="M465.6 492.449l91.841 13.857-2.52 16.7-91.84-13.856z" />
      <path
        ...
        opacity={0.5}
      />
      <circle cx={736.97} cy={217.05} r={54.67} transform="rotate(-81.42 611.44 273.601)" fill="#f5f5f5" />
      <path
      ...
      <path
        ...
        fill="#fda57d"
      />
      <path d="M564 148.91a24.33 24.33 0 0 0 16.71 2.57l.31-2.05-16.72-2.52z" opacity={0.1} />
      <circle cx={738.61} cy={203.36} r={24.23} transform="rotate(-81.42 613.083 259.916)" fill="#fda57d" />
      <path d="M554.3 114.78l45.7 6.89s-1.12-19-18.57-20.47-27.13 13.58-27.13 13.58z" fill="#333" />
      <ellipse cx={715.3} cy={198.8} rx={4.23} ry={2.25} transform="rotate(-81.42 589.763 255.354)" fill="#fda57d" />
      <ellipse cx={762.11} cy={205.86} rx={4.23} ry={2.25} transform="rotate(-81.42 636.58 262.415)" fill="#fda57d" />
      <path d="M554.23 115.4l45.7 6.89s-1.12-19-18.57-20.47-27.13 13.58-27.13 13.58z" opacity={0.1} />
      <path
        ...
        opacity={0.5}
      />
      <path fill="#f5f5f5" d="M5.635 143.413L386.63 80.955l86.593 528.219L92.23 671.632z" />
      <path
        fill="#e0e0e0"
      ...
      />
      <path fill={primaryColor} d="M224.785 248.561l116.663-19.125 2.733 16.668-116.663 19.125z" />
      <path
        fill="#e0e0e0"
      ...
      />
      <path fill={primaryColor} d="M134.975 614.104l91.657-15.026 2.732 16.668-91.656 15.026z" />
      <path
        ...
        opacity={0.5}
      />
      <circle cx={297.63} cy={320.86} r={56.2} transform="rotate(-9.31 -250.72 1282.25)" fill="#f5f5f5" />
      <path
        ...
        fill="#4d8af0"
      />
      <circle cx={292.23} cy={301.74} r={24.91} transform="rotate(-9.31 -256.087 1263.145)" fill="#333" />
      <path
      ...
      <path
        ...
        fill="#fda57d"
      />
      <path d="M125.57 255.89a25 25 0 0 0 17.16-2.76l-.35-2.11-17.15 2.82z" opacity={0.1} />
      <circle cx={293.11} cy={307.08} r={24.91} transform="rotate(-9.31 -255.223 1268.47)" fill="#fda57d" />
      <path d="M105.41 226.19l46.89-7.68s-7.11-18.28-24.63-14.16-22.26 21.84-22.26 21.84z" opacity={0.1} />
      <path d="M105.3 225.56l46.93-7.69s-7.11-18.28-24.63-14.16-22.3 21.85-22.3 21.85z" fill="#333" />
      <ellipse
        cx={268.86}
        cy={309.97}
        rx={2.32}
        ...
        fill="#fda57d"
      />
      <ellipse cx={316.89} cy={302.1} rx={2.32} ry={4.35} transform="rotate(-9.31 -231.456 1263.544)" fill="#fda57d" />
      <path fill="url(#prefix__e)" d="M282.63 165.47h396.16v547.37H282.63z" opacity={0.5} />
      ...
      <path
        ...
        fill="#be7c5e"
      />
      <path d="M389.58 300.97a25.58 25.58 0 0 0 17.77 0v-2.18h-17.77z" opacity={0.1} />
      ...
      <path d="M374.14 267.71h48.58s-4.15-19.62-22.51-18.36-26.07 18.36-26.07 18.36z" opacity={0.1} />
      <path
        fill="#e0e0e0"
        d="M339.15 401.6H617.8v16.89H339.15zM339.15 443.82H617.8v16.89H339.15zM474.26 266.5h143.55v16.89H474.26z"
      />
      <path fill={primaryColor} d="M486.92 308.72h118.22v16.89H486.92z" />
      <path
        fill="#e0e0e0"
      ...
      />
      <path fill={primaryColor} d="M339.15 654.93h92.88v16.89h-92.88z" />
      <circle cx={652.07} cy={663.56} r={84.39} fill="url(#prefix__g)" opacity={0.5} />
      <circle cx={652.07} cy={663.56} r={79.42} fill="#69f0ae" />
      <path fill="#fff" d="M617.6 652.96l29.78 27.3 42.19-62.04 14.9 12.41-57.09 74.45-42.19-47.15 12.41-4.97z" />
    </svg>
  );
};
