...
const UndrawVoiceControl = (_props: any) => {
  ...
  return (
    <svg data-name="Layer 1" width="1em" height="1em" viewBox="0 0 972.57 830.55" style={style} {...props}>
      ...
      <path d="M360.73 602.95l106.71-4.37v17.14H343.6a18.92 18.92 0 0 1 17.13-12.77z" fill="#333f4f" />
      <path d="M574.16 602.95l-106.72-4.37v17.14h123.85a18.92 18.92 0 0 0-17.13-12.77z" fill="#333f4f" />
      <path
      ...
      <path
        ...
        opacity={0.1}
      />
      <path d="M455.41 264.95a33.26 33.26 0 1 0 33.27-33.27 33.06 33.06 0 0 0-33.27 33.27z" fill="#fbbebe" />
      <path
      ...
      <circle cx={822.99} cy={92.87} r={21.63} fill={primaryColor} opacity={0.1} />
      <circle cx={918.99} cy={145.87} r={17.01} fill={primaryColor} opacity={0.1} />
      <circle cx={966.57} cy={63.9} r={6} fill={primaryColor} opacity={0.1} />
      <path
      ...
      <path
        ...
        fill="#d3dae1"
      />
      <path d="M762.37 398.09s-3.42 15.92 11.79 17.8l.94-1.76s-11.81-11.09-12.73-16.04z" fill={primaryColor} />
      <path
      ...
      <path
        ...
        fill={primaryColor}
      />
      <path d="M781.82 373.8s-10.14 36-1.41 41.39 3.65-38.2 1.41-41.39z" fill={primaryColor} />
      ...
      <path d="M762.37 398.09s-2 15.92 13.2 17.8l.94-1.76s-13.22-11.09-14.14-16.04z" fill={primaryColor} />
      <path
      ...
      <path
        ...
        opacity={0.1}
      />
      <path d="M781.82 373.8s-8.72 36 0 41.39 2.24-38.2 0-41.39z" fill={primaryColor} />
