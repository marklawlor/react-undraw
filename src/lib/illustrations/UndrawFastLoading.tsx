...
const UndrawFastLoading = (_props: any) => {
  ...
  delete props.style;
  return (
    <svg data-name="Layer 1" width="1em" height="1em" viewBox="0 0 942 745.6" style={style} {...props}>
      <defs>
        <linearGradient id="prefix__a" x1={219.48} y1={505.38} x2={219.48} gradientUnits="userSpaceOnUse">
          <stop offset={0} stopColor="gray" stopOpacity={0.25} />
          <stop offset={0.54} stopColor="gray" stopOpacity={0.12} />
          <stop offset={1} stopColor="gray" stopOpacity={0.1} />
        </linearGradient>
        <linearGradient id="prefix__b" x1={425.02} y1={459.78} x2={425.02} y2={162.72} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__c" x1={600} y1={824.36} x2={600} y2={334.87} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__d" x1={617.59} y1={479.82} x2={617.59} y2={137.05} xlinkHref="#prefix__a" />
      </defs>
      <rect x={52.32} width={334.33} height={505.38} rx={4.5} ry={4.5} fill="url(#prefix__a)" opacity={0.5} />
      <rect x={56.6} y={3.71} width={325.76} height={495.16} rx={4.5} ry={4.5} fill="#f2f2f2" />
      <rect x={89.18} y={94.93} width={65.15} height={58.64} rx={4.5} ry={4.5} fill={primaryColor} opacity={0.5} />
      ...
      <rect x={89.18} y={186.14} width={65.15} height={58.64} rx={4.5} ry={4.5} fill={primaryColor} opacity={0.5} />
      ...
      <rect x={89.18} y={277.35} width={65.15} height={58.64} rx={4.5} ry={4.5} fill={primaryColor} opacity={0.5} />
      ...
      <rect x={296.84} y={227.52} width={68.69} height={61.82} rx={4.5} ry={4.5} fill={primaryColor} opacity={0.5} />
      ...
      <path
        ...
        opacity={0.7}
      />
      <path fill="#fdb797" d="M463.72 373h11.18v15.18h-11.18zM502.06 373h11.18v15.18h-11.18z" />
      <path fill="#4d8af0" d="M451.74 248.4h73.49v26.36h-73.49z" />
      <path d="M451.74 248.4h73.49v26.36h-73.49z" opacity={0.05} />
      <path d="M451.74 253.19s27.42 6.39 36.74 6.39 36.74-6.39 36.74-6.39v-4h-73.48z" opacity={0.1} />
      <path
      ...
      <path
        ...
        fill="#4d8af0"
      />
      <path d="M479.7 166.66a36.77 36.77 0 0 0 17.57 0v-12.52H479.7z" opacity={0.1} />
      ...
      <path
        ...
        fill="#333"
      />
      <path d="M459.73 212.45s-3.2 16.77 2.4 24M517.24 212.45s3.2 16.77-2.4 24" opacity={0.1} />
    </svg>
  );
};
