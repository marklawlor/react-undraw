...
const UndrawSearchEngines = (_props: any) => {
  ...
  delete props.style;
  return (
    <svg data-name="Layer 1" width="1em" height="1em" viewBox="0 0 871.91 538.91" style={style} {...props}>
      <defs>
        <linearGradient id="prefix__b" x1={435.95} y1={538.91} x2={435.95} y2={377.68} gradientUnits="userSpaceOnUse">
          <stop offset={0} stopColor="gray" stopOpacity={0.25} />
          <stop offset={0.54} stopColor="gray" stopOpacity={0.12} />
          <stop offset={1} stopColor="gray" stopOpacity={0.1} />
        </linearGradient>
        <linearGradient id="prefix__c" x1={895.46} y1={705.26} x2={895.46} y2={584.97} gradientUnits="userSpaceOnUse">
        ...
        <linearGradient id="prefix__a" x1={858.28} y1={627.87} x2={858.28} y2={622.08} gradientUnits="userSpaceOnUse">
          <stop offset={0} stopOpacity={0.12} />
          <stop offset={0.55} stopOpacity={0.09} />
          <stop offset={1} stopOpacity={0.02} />
        </linearGradient>
        <linearGradient id="prefix__d" x1={884.88} y1={621.23} x2={884.88} y2={603.52} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__e" x1={547.45} y1={337.11} x2={547.45} y2={180.55} xlinkHref="#prefix__b" />
        <clipPath id="prefix__f" transform="translate(-164.05 -180.55)">
          <path
        ...
        <linearGradient id="prefix__g" x1={378.88} y1={511.52} x2={378.88} y2={366.33} xlinkHref="#prefix__b" />
        <linearGradient id="prefix__h" x1={378.07} y1={483.02} x2={378.07} y2={406.49} xlinkHref="#prefix__b" />
        <linearGradient id="prefix__i" x1={481.22} y1={511.34} x2={481.22} y2={371.35} xlinkHref="#prefix__b" />
        <linearGradient id="prefix__j" x1={443.8} y1={328.74} x2={443.8} y2={216.51} xlinkHref="#prefix__b" />
        <linearGradient id="prefix__k" x1={708.4} y1={487.94} x2={708.4} y2={415.88} xlinkHref="#prefix__b" />
        <linearGradient id="prefix__l" x1={744.45} y1={486.82} x2={744.45} y2={417.99} xlinkHref="#prefix__b" />
        <linearGradient id="prefix__m" x1={780.78} y1={486.82} x2={780.78} y2={437.78} xlinkHref="#prefix__b" />
        <linearGradient id="prefix__n" x1={832.79} y1={509.37} x2={832.79} y2={437.64} xlinkHref="#prefix__b" />
        <linearGradient id="prefix__o" x1={858.05} y1={379.79} x2={858.05} y2={324.38} xlinkHref="#prefix__b" />
        <linearGradient id="prefix__p" x1={898.6} y1={381.19} x2={898.6} y2={297.72} xlinkHref="#prefix__b" />
        <linearGradient id="prefix__q" x1={939.58} y1={380.99} x2={939.58} y2={323.88} xlinkHref="#prefix__b" />
        <linearGradient id="prefix__r" x1={816.78} y1={381.19} x2={816.78} y2={323.68} xlinkHref="#prefix__b" />
        <linearGradient id="prefix__s" x1={976.13} y1={379.79} x2={976.13} y2={324.99} xlinkHref="#prefix__b" />
        <linearGradient id="prefix__t" x1={784.46} y1={379.79} x2={784.46} y2={289.72} xlinkHref="#prefix__b" />
      </defs>
      <path fill="url(#prefix__b)" d="M0 377.68h871.91v161.23H0z" />
