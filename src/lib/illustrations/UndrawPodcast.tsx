...
const UndrawPodcast = (_props: any) => {
  ...
  delete props.style;
  return (
    <svg data-name="Layer 1" width="1em" height="1em" viewBox="0 0 1140.21 776" style={style} {...props}>
      <defs>
        <linearGradient id="prefix__a" x1={623.53} y1={767.89} x2={623.53} y2={127.97} gradientUnits="userSpaceOnUse">
      ...
      <g opacity={0.1} fill={primaryColor}>
        <path d="M664.66 225.49s-6.06-2.06-9 3.29a9.75 9.75 0 0 0 .13 9.38c1.92 3.46 5.87 8 13.35 7.56 6.35-.34 8.46-5.18 9-9.69a10 10 0 0 0-13.22-10.66z" />
        <path
        ...
        <path d="M661.04 215.21s3.85 10.44 3.53 13.17l3.05-.32s-5.14-9.15-3.85-12.85z" opacity={0.2} />
        <path d="M676.78 216.09s-6.07-3.1-8.78-.54-3.13 9.11-3.13 9.11 9.89 1.34 11.91-8.57z" />
        <path d="M676.78 216.09s-6.07-3.1-8.78-.54-3.13 9.11-3.13 9.11 9.89 1.34 11.91-8.57z" opacity={0.1} />
        <path d="M664.86 224.66s1.59-7.6 11.91-8.58" />
      </g>
      <g opacity={0.1} fill={primaryColor}>
        <path d="M792.66 324.49s-6.06-2.06-9 3.29a9.75 9.75 0 0 0 .13 9.38c1.92 3.46 5.87 8 13.35 7.56 6.35-.34 8.46-5.18 9-9.69a10 10 0 0 0-13.22-10.66z" />
        <path
        ...
        <path d="M789.04 314.21s3.85 10.44 3.53 13.17l3.05-.32s-5.14-9.15-3.85-12.85z" opacity={0.2} />
        <path d="M804.78 315.09s-6.07-3.1-8.78-.54-3.13 9.11-3.13 9.11 9.89 1.34 11.91-8.57z" />
        <path d="M804.78 315.09s-6.07-3.1-8.78-.54-3.13 9.11-3.13 9.11 9.89 1.34 11.91-8.57z" opacity={0.1} />
      ...
      />
      <g opacity={0.1}>
        <path d="M405.75 212.22h-8.53v-59h8.53a24.56 24.56 0 0 1 24.56 24.56v9.82a24.56 24.56 0 0 1-24.56 24.62z" />
        <rect
          x={419.88}
          y={215.27}
          width={14.48}
      ...
      />
      <path opacity={0.1} d="M60.23 650.72l-2.78 49.08h1072.36l-1.85-49.08H60.23z" />
      <path
      ...
      <path
        ...
        fill="#865a61"
      />
      <path d="M322.77 446.53s7.41 12 7.41 20.37c0 0 5.56-20.37 10.19-20.37" opacity={0.05} />
      <path
      ...
      <path d="M297.49 537.93a45.65 45.65 0 0 1-3.39 3.82 2.78 2.78 0 1 1 3.39-3.82z" opacity={0.1} />
      ...
      <path d="M792.37 553s10.09 27.33 9.25 34.48l8-.84s-13.51-23.97-10.1-33.64z" fill={primaryColor} />
      <path d="M792.37 553s10.09 27.33 9.25 34.48l8-.84s-13.51-23.97-10.1-33.64z" opacity={0.2} />
      <path d="M833.56 555.28s-15.88-8.12-23-1.41-8.2 23.86-8.2 23.86 25.91 3.57 31.2-22.45z" fill={primaryColor} />
      <path
        d="M833.56 555.28s-15.88-8.12-23-1.41-8.2 23.86-8.2 23.86 25.91 3.57 31.2-22.45z"
        fill="#fff"
        opacity={0.1}
      />
      <path d="M802.37 577.73s4.17-19.91 31.19-22.45" fill="none" stroke={primaryColor} strokeMiterlimit={10} />
    </svg>
  );
};
