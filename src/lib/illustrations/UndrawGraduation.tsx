...
const UndrawGraduation = (_props: any) => {
  ...
  delete props.style;
  return (
    <svg data-name="Layer 1" width="1em" height="1em" viewBox="0 0 851.55 585.04" style={style} {...props}>
      <defs>
        <linearGradient id="prefix__a" x1={555.01} y1={665.76} x2={555.01} y2={227.01} gradientUnits="userSpaceOnUse">
      ...
      <path
        ...
        fill={primaryColor}
      />
      <path opacity={0.15} d="M198.5 249.4v16.55l229.01 80.02 201.42-85.53 2.76-16.56-204.18 74.5L198.5 249.4z" />
      <path
        ...
        opacity={0.15}
      />
      <path fill={primaryColor} d="M802.91 147.31h11.04v49.82h-11.04z" />
      <path opacity={0.1} d="M802.91 147.31h11.04v49.82h-11.04z" />
      <path d="M758.77 343.36s33.11 27.9 55.18 5.52l-2.76-93.81-16.55-8.28z" fill={primaryColor} />
      <path d="M758.77 343.36s33.11 27.9 55.18 5.52l-2.76-93.81-16.55-8.28z" opacity={0.1} />
      <path
        fill={primaryColor}
        d="M10.88 161.11v19.31l416.63 157.27 375.24-168.3-2.75-16.56-375.25 165.55L10.88 161.11z"
      />
      <path opacity={0.07} d="M10.88 161.11v19.31l416.63 157.27 375.24-168.3-2.75-16.56-375.25 165.55L10.88 161.11z" />
      <path fill={primaryColor} d="M10.88 161.11l415.87 161.27L800 152.83 402.68 50.74 10.88 161.11z" />
      <ellipse cx={410.88} cy={145.86} rx={27.51} ry={17.86} fill={primaryColor} />
      <ellipse cx={410.88} cy={145.86} rx={27.51} ry={17.86} opacity={0.1} />
      <path fill={primaryColor} d="M430.12 147.16h383.52v8.28H430.12z" />
      <path opacity={0.1} d="M430.12 147.16h383.52v8.28H430.12z" />
      <circle cx={805.67} cy={208.17} r={16.55} fill={primaryColor} />
      <circle cx={805.67} cy={208.17} r={16.55} opacity={0.1} />
      <path d="M786.36 252.31s5.52 8.58 24.83 2.76l-2.76-35.87h-8.28z" fill={primaryColor} />
      <path d="M786.36 252.31s5.52 8.58 24.83 2.76l-2.76-35.87h-8.28z" opacity={0.1} />
      <path
        fill="#fff"
        opacity={0.2}
      ...
      <path
        ...
        opacity={0.15}
      />
      <ellipse cx={172.54} cy={542.89} rx={35.09} ry={5.26} transform="rotate(-68.68 -29.902 553.21)" fill="#e0e0e0" />
      <ellipse cx={628.58} cy={721.1} rx={35.09} ry={3.58} transform="rotate(-68.68 426.12 731.418)" fill="#e0e0e0" />
      <path fill="#f55f44" d="M234.445 461.792l17.36 11.923-39.735 57.859-17.36-11.923z" />
      <path opacity={0.05} d="M243.154 538.607l-23.45-3.363 9.962-69.48 23.45 3.363z" />
      <path fill="#f55f44" d="M241.853 539.225l-20.849-2.949 9.827-69.488 20.849 2.949z" />
      <path transform="rotate(-68.68 198.117 642.217)" fill="url(#prefix__b)" d="M363.72 387.11h73.7v489.57h-73.7z" />
      <path
        d="M477.39 571.6c-8.91-3.34-462.6-180.57-456.06-178 20.86-39 25.52-65.38 25.52-65.38l456.06 178s-12.95 28.28-25.52 65.38z"
        fill="#f5f5f5"
      />
      <path opacity={0.05} d="M247.837 403.78l37.534 14.53-25.268 65.277-37.535-14.53z" />
      <path fill="#f55f44" d="M247.935 406.673l34.328 13.398-25.52 65.386-34.327-13.397z" />
      <path opacity={0.05} d="M252.837 408.59l22.889 8.932-25.52 65.387-22.888-8.933z" />
      <path fill="#f55f44" d="M254.477 409.23l19.619 7.656-25.52 65.387-19.618-7.657z" />
      <circle cx={455.91} cy={745.92} r={2.93} transform="rotate(-.86 -11737.608 9879.75)" fill="#dbdbdb" />
