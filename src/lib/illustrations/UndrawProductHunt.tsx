...
const UndrawProductHunt = (_props: any) => {
  ...
  delete props.style;
  return (
    <svg data-name="Layer 1" width="1em" height="1em" viewBox="0 0 830.52 709.6" style={style} {...props}>
      <defs>
        <linearGradient id="prefix__a" x1={530.5} y1={797} x2={530.5} y2={106} gradientUnits="userSpaceOnUse">
      ...
      <path
        ...
        fill={primaryColor}
      />
      <path d="M335.15 180.24h26.77v41.64a9 9 0 0 1-9 9h-8.72a9 9 0 0 1-9-9v-41.64h-.05z" fill="#fdb797" />
      <path d="M406.59 256.84l72-112.93L442.26 55l-24.89 9.6 20.08 75.53s-28.68 76.87-54.5 76.2z" fill={primaryColor} />
      <path d="M335.15 197.28a44.09 44.09 0 0 0 26.77 0v-15.12h-26.77z" opacity={0.1} />
      ...
      <path d="M290.47 255.89l-72-112.93 36.33-87 24.86 9.56-20.08 73.62s28.68 76.87 54.5 76.2z" fill={primaryColor} />
      <path
      ...
      <path
        ...
        opacity={0.1}
      />
      <ellipse cx={590.33} cy={648.61} rx={18.19} ry={44.66} fill="url(#prefix__b)" />
      <path
      ...
      <path
        ...
        fill="#ffe9a1"
      />
      <path d="M589.78 412.52l-1.68 1.68a3.53 3.53 0 0 0 3.09 0z" fill="#f25f1d" />
      ...
      <path
        ...
        opacity={0.1}
      />
      <path d="M510.26 433.31h158.4V558.9a79.2 79.2 0 0 1-79.2 79.2 79.2 79.2 0 0 1-79.2-79.2V433.31z" fill="#cfd8dc" />
      <path
