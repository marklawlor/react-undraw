...
const UndrawJavaScriptFrameworks = (_props: any) => {
  ...
  delete props.style;
  return (
    <svg data-name="Layer 1" width="1em" height="1em" viewBox="0 0 787.17 730" style={style} {...props}>
      <defs>
        <linearGradient id="prefix__a" x1={278.97} y1={470.3} x2={278.97} y2={199.62} gradientUnits="userSpaceOnUse">
          <stop offset={0} stopColor="gray" stopOpacity={0.25} />
          <stop offset={0.54} stopColor="gray" stopOpacity={0.12} />
          <stop offset={1} stopColor="gray" stopOpacity={0.1} />
        </linearGradient>
        <linearGradient id="prefix__b" x1={191.8} y1={163.04} x2={191.8} y2={0} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__c" x1={563.67} y1={215.47} x2={563.67} y2={0.88} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__d" x1={639.88} y1={470.3} x2={639.88} y2={255.7} xlinkHref="#prefix__a" />
        <linearGradient
          id="prefix__e"
          x1={453.7}
          y1={780.9}
        ...
        <linearGradient
          ...
          xlinkHref="#prefix__a"
        />
        <linearGradient id="prefix__g" x1={259.49} y1={698.31} x2={357.92} y2={698.31} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__h" x1={235.32} y1={696.9} x2={235.32} y2={566.04} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__i" x1={270.35} y1={696.9} x2={270.35} y2={566.04} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__j" x1={319.81} y1={696.88} x2={319.81} y2={561.94} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__k" x1={840.16} y1={682.09} x2={972.2} y2={682.09} xlinkHref="#prefix__a" />
      </defs>
      <path fill="url(#prefix__a)" d="M136.93 199.62h284.09V470.3H136.93z" />
      <path fill="#fff" d="M143.02 205.71h271.9V464.2h-271.9z" />
      <path fill={primaryColor} d="M152.78 215.47h252.39v238.98H152.78z" />
      <path d="M325.16 268.55h30.8l-77 132.81-77-132.81h58.9l18.09 30.8 17.71-30.8z" fill="#41b883" />
      <path d="M201.98 268.55l77 132.81 77-132.81h-30.8l-46.2 79.69-46.58-79.69z" fill="#41b883" />
      <path d="M232.39 268.55l46.58 80.07 46.2-80.07h-28.49l-17.71 30.8-18.09-30.8z" fill="#35495e" />
      <path fill="url(#prefix__b)" d="M5.25 0h373.1v163.04H5.25z" opacity={0.5} />
      <path fill="#fff" d="M10.12 2.09h363.34v156.07H10.12z" />
      <path fill={primaryColor} d="M20.56 11.85h342.46v136.56H20.56z" />
      <path
      ...
      <path
        ...
        fill="#21609b"
      />
      <path fill="url(#prefix__c)" d="M456.38.88h214.59v214.59H456.38z" />
      <path fill="#fff" d="M462.47 6.97h202.4v202.4h-202.4z" />
      <path fill={primaryColor} d="M472.23 16.73h182.89v182.89H472.23z" />
      <path d="M497.72 69.52L563.77 46l67.81 23.1-11 87.4-56.81 31.5-56-31.07z" fill="#e23237" />
      ...
      <path
        ...
        fill="#fff"
      />
      <path fill="url(#prefix__d)" d="M497.83 255.7h284.09v214.59H497.83z" />
      <path fill="#fff" d="M503.93 261.8h271.9v202.4h-271.9z" />
      <path fill={primaryColor} d="M513.68 271.55h252.39v182.89H513.68z" />
      <path
      ...
      <path
        ...
        fill="#fff"
      />
      <path d="M640.58 350.74a12.15 12.15 0 1 1-12.19 12.11 12.15 12.15 0 0 1 12.19-12.11" fill="#53c1de" />
      <g opacity={0.7}>
        <path fill="url(#prefix__e)" d="M602.37 565.04V695.9H569.4V565.04h32.97z" opacity={0.1} />
        <path fill="url(#prefix__f)" d="M567.34 565.04V695.9H534.36V565.04H567.34z" opacity={0.1} />
      </g>
      <path
      ...
      <path
        ...
        opacity={0.6}
      />
      <rect x={56.36} y={660.52} width={86.64} height={36.87} rx={14.3} ry={14.3} fill={primaryColor} />
      <path
      ...
      />
      <g opacity={0.7}>
        <path fill="url(#prefix__h)" d="M218.83 566.04V696.9H251.81V566.04H218.83z" opacity={0.1} />
        <path fill="url(#prefix__i)" d="M253.87 566.04V696.9h32.97V566.04h-32.97z" opacity={0.1} />
        <path
          fill="url(#prefix__j)"
      ...
      <path fill={primaryColor} d="M222.21 586.85h31.31v5.87h-31.31zM222.21 670.99h31.31v5.87h-31.31z" />
      <path opacity={0.1} d="M245.69 569.24h7.83V693.5h-7.83z" />
      <path fill="#535461" d="M255.47 569.24h31.31V693.5h-31.31z" />
      <path fill={primaryColor} d="M255.47 586.85h31.31v5.87h-31.31zM255.47 670.99h31.31v5.87h-31.31z" />
      <path opacity={0.1} d="M278.95 569.24h7.83V693.5h-7.83z" />
      <path fill="#535461" d="M286.914 573.46l30.254-8.066 32.014 120.065-30.253 8.067z" />
      <path
        fill={primaryColor}
        d="M291.456 590.478l30.253-8.067 1.513 5.672-30.253 8.066zM313.14 671.777l30.253-8.066 1.513 5.672-30.253 8.066z"
      />
      <path opacity={0.1} d="M309.617 567.413l7.566-2.017 32.014 120.065-7.566 2.018z" />
      <path fill="#535461" d="M598.17 693.5h-31.31V569.24h31.31z" />
      <path fill={primaryColor} d="M598.17 592.73h-31.31v-5.87h31.31zM598.17 676.87h-31.31V671h31.31z" />
      <path opacity={0.1} d="M574.69 693.5h-7.83V569.24h7.83z" />
      <path fill="#535461" d="M564.91 693.5H533.6V569.24h31.31z" />
      <path fill={primaryColor} d="M564.91 592.73H533.6v-5.87h31.31zM564.91 676.87H533.6V671h31.31z" />
      ...
      <path
        ...
        opacity={0.6}
      />
      <path d="M642.23 634.16h113.52s22.39 28.57-12.36 71h-89.57s-32.43-29.3-11.59-71z" fill={primaryColor} />
      <path
        ...
        fill="#4db6ac"
      />
      <path d="M697.58 586.77s4.55-22.49-22.48-43.34c0 0-29.37 49.93 21.22 59.33z" fill="#4db6ac" />
      <path d="M696.72 617.69s-3.14-31.79 30.86-37.97c0 0-12.41 44.39-30.91 52.31z" fill="#4db6ac" />
      <path
      ...
      <path
        ...
        opacity={0.1}
      />
      <path fill="#e0e0e0" d="M0 692.4h787.17v26.68H0zM33.35 719.08h720.46V730H33.35z" />
