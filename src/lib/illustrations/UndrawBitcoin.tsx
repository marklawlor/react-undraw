...
const UndrawBitcoin = (_props: any) => {
  ...
  delete props.style;
  return (
    <svg data-name="Layer 1" width="1em" height="1em" viewBox="0 0 682 729.04" style={style} {...props}>
      <defs>
        <linearGradient id="prefix__a" x1={133.13} y1={136.42} x2={133.13} y2={112.55} gradientUnits="userSpaceOnUse">
          <stop offset={0} stopColor="gray" stopOpacity={0.25} />
          <stop offset={0.54} stopColor="gray" stopOpacity={0.12} />
          <stop offset={1} stopColor="gray" stopOpacity={0.1} />
        </linearGradient>
        <linearGradient id="prefix__b" x1={489.15} y1={260.63} x2={489.15} y2={85.48} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__c" x1={513.83} y1={188.41} x2={513.83} y2={161.09} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__d" x1={538.04} y1={200.61} x2={538.04} y2={160.52} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__e" x1={521.42} y1={391.07} x2={521.42} y2={279.81} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__f" x1={567.94} y1={627.32} x2={604.26} y2={627.32} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__g" x1={826.94} y1={703.92} x2={863.26} y2={703.92} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__h" x1={826.94} y1={684.58} x2={863.26} y2={684.58} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__i" x1={840.76} y1={659.51} x2={849.44} y2={659.51} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__j" x1={567.94} y1={675.48} x2={580.97} y2={675.48} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__k" x1={591.23} y1={675.48} x2={604.26} y2={675.48} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__l" x1={840.76} y1={656.16} x2={849.44} y2={656.16} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__m" x1={567.15} y1={551.13} x2={605.05} y2={551.13} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__n" x1={567.94} y1={555.48} x2={604.26} y2={555.48} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__o" x1={831.28} y1={628.45} x2={863.01} y2={628.45} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__p" x1={831.28} y1={628.05} x2={863.01} y2={628.05} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__q" x1={602.48} y1={555.48} x2={605.64} y2={555.48} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__r" x1={566.56} y1={555.48} x2={569.72} y2={555.48} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__s" x1={630.31} y1={532.19} x2={639} y2={532.19} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__t" x1={827.34} y1={651.42} x2={863.03} y2={651.42} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__u" x1={854.75} y1={646.88} x2={895.24} y2={646.88} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__v" x1={533.2} y1={532.19} x2={541.89} y2={532.19} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__w" x1={794.97} y1={646.88} x2={835.45} y2={646.88} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__x" x1={827.73} y1={805.18} x2={839.18} y2={805.18} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__y" x1={851.02} y1={805.18} x2={862.47} y2={805.18} xlinkHref="#prefix__a" />
      </defs>
      <path d="M128.15 116.08l11.04-4.26 2.9 6.31 1.34 15.08-2.47 1.79-12.81-18.92zM181.79 145.78l-12.61 7.29 13.25 19.54 3.09-2.25 1.92-15.51-5.65-9.07z" />
      <g opacity={0.05}>
        <path d="M208.24 54.75c-2.54 3.84-4.91 8-5.64 10.92l2-1.38c-.25-2.17 1.4-5.77 3.64-9.54zM219.61 107.01L221 77.78c-31 19.67-76.36 37.62-76.36 37.62l-2.19 3.47s45.41-17.95 76.36-37.62l-1.3 27.53z" />
      </g>
      <g opacity={0.5}>
        <path fill="url(#prefix__a)" d="M138.46 136.42l2.54-1.85-1.37-15.53-2.99-6.49-11.37 4.39 13.19 19.48z" />
        <path
      ...
      <path
        ...
        fill="#fda57d"
      />
      <path d="M267.58 52.39l.83 5 23.14 2s4.84-16.69-3.28-24z" fill="#f55f44" />
      <path d="M288.27 35.46l-8.55-18.25s-16.15-28.69-63.85 27.59l31.46 25.12 20.36-14.8z" fill="#f55f44" />
      <path
        ...
        fill="#fda57d"
      />
      <path d="M286.18 16.76a13.53 13.53 0 0 0 3.64 13.35l7.85-5.71-7.61-10.47z" opacity={0.05} />
      <ellipse cx={559.03} cy={105.34} rx={13.73} ry={13.7} transform="rotate(-36.01 298.017 461.039)" fill="#fda57d" />
      <path
      ...
      <path
        ...
        fill="#5a2f32"
      />
      <ellipse cx={554.28} cy={97.5} rx={3.05} ry={1.52} transform="rotate(-35.9 293.711 451.212)" fill="#fda57d" />
      <path
        opacity={0.05}
      ...
      <path
        ...
        fill="#fda57d"
      />
      <path fill="#ccc" d="M378.48 270.77h1.74v1.74h-1.74z" />
      <path
        d="M377.35 273.39h4.3a2.35 2.35 0 0 1 2.35 2.35v14.49h-9v-14.49a2.35 2.35 0 0 1 2.35-2.35z"
        fill="#535461"
      />
      <path fill="#f7931a" d="M376.74 272.23h5.23v1.16h-5.23zM375 280.06h9v3.48h-9z" />
      <path d="M380.23 271.06v.87c-.32 0-.58-.2-.58-.44s.26-.43.58-.43z" fill="#e6e6e6" />
      <path
        d="M245.91 20.62s-3.82 10.31-2.2 13.83M244.15 35.07l-.01 1.91 18.33 3.08.22-1.53-18.54-3.46z"
        opacity={0.05}
      />
      <path fill="#f55f44" d="M248.29 19.36l-4.22 16.24 18.54 3.46 4.9-20.5-19.22.8z" />
      <path
      ...
      <path
        ...
        fill="#fda57d"
      />
      <path fill="#535461" opacity={0.2} d="M380 271l25-5 1 12-26-6v-1z" />
      <path
        ...
        opacity={0.5}
      />
      <path fill="#fda57d" d="M317.96 253.33l-9.21-8.54L324 228.26l9.21 8.53-15.25 16.54z" />
      <path d="M323.27 228.98l-6.73 7.3a14.53 14.53 0 0 0 8.91 8.87l7-7.63z" opacity={0.05} />
      <path
        d="M325.25 267.63l36.93 15.89 27.29-32.34s4.13-4.62-.79-7.78-8 5-8 5l-21 22.48-26.95-13.46z"
        fill="#fda57d"
      />
      <path fill={primaryColor} d="M323.31 249.24l18.85 10.89-2.54 17.07-17.76-14.16 1.45-13.8z" />
      <ellipse cx={330.92} cy={230.72} rx={14.5} ry={14.53} fill="#fda57d" />
      <path d="M319 243.43l-7.25-2.18-48.6 7.27.36 33s59.08-2.54 65.6-17.79l-4.35-15.21z" fill={primaryColor} />
      <path opacity={0.05} d="M322.43 263.48l17.19 13.72.73-5.81-17.04-16.34-.88 8.43z" />
      <path
        ...
        fill="#4d8af0"
      />
      <path d="M151.16 240.88L141 237.25l-7.25 25.42s8-8.72 15.22-9.44z" fill="#535461" />
      <path d="M175.8 208.93l15.2-3.63s7.25 43.58 18.12 47.21h-26.79s-2.18-42.13-6.53-43.58z" fill="#4d8af0" />
      <path d="M191 205.3l-2.17-9.44-28.27 6.54s13 2.91 15.22 6.54z" fill="#535461" />
      <path
        ...
        opacity={0.05}
      />
      <path d="M333.23 213.2a24.82 24.82 0 0 0-11.37 1.43 14 14 0 0 0-8 7.89c-1.3 3.64-.46 8.11 2.48 10.61a4.33 4.33 0 0 0 2.55 1.16c1.54.06 2.83-1.07 4-2.05a33.84 33.84 0 0 1 7.28-4.59c2.22-1 4.93-1.8 7-.53a14.53 14.53 0 0 1 2.53 2.4 10.29 10.29 0 0 0 16.76-3.36c-.56 1.35-5.74-.51-6.52-.92-2.38-1.26-3.6-3.13-4.82-5.42-2.38-4.55-6.86-6.23-11.89-6.62z" />
      <ellipse cx={585.21} cy={314.74} rx={2.18} ry={1.09} transform="rotate(-76.65 401.644 435.832)" fill="#fda57d" />
      <path
        opacity={0.05}
        d="M319.62 279.45l.49.6 10.9-5.29-.48-.66-10.91 5.35zM341.88 262l-1.78 11.93.66.38 1.4-12.18-.28-.13z"
      />
      <path fill="#e0e0e0" d="M275.83 231.44h8.7v58.83h-8.7zM259.844 66.74l8.247 2.77-18.735 55.767-8.247-2.77z" />
      <path fill="#e0e0e0" d="M281.63 237.98h-2.9V95.92l2.86.15.04 141.91z" />
      <path
      ...
      <path
        ...
        fill={primaryColor}
      />
      <path d="M306.84 256.43s-.57 12.78 3.06 15" opacity={0.05} />
      <path fill="#e0e0e0" d="M278.75 96.07l-13.08-19.33 1.37-4.09 14.55 23.42h-2.84z" />
      <path d="M343.335 234.753l1.891 1.257-3.17 4.772-1.892-1.256zM328.562 226.467l14.015 9.318-.631.95-14.015-9.319z" />
      <g opacity={0.7}>
        <path fill="url(#prefix__f)" d="M567.94 613.9h36.32v26.84h-36.32z" />
        <path
        ...
        <path
          ...
          fill="url(#prefix__i)"
        />
        <path fill="url(#prefix__j)" d="M567.94 631.27h13.03v88.43h-13.03z" />
        <path fill="url(#prefix__k)" d="M591.23 631.27h13.03v88.43h-13.03z" />
        <path
          ...
          opacity={0.1}
        />
        <circle cx={586.1} cy={551.13} r={18.95} fill="url(#prefix__m)" />
        <circle cx={586.1} cy={555.48} r={18.16} fill="url(#prefix__n)" />
        <path
        ...
        <path
          ...
          fill="url(#prefix__p)"
        />
        <ellipse cx={604.06} cy={555.48} rx={1.58} ry={2.96} fill="url(#prefix__q)" />
        <ellipse cx={568.14} cy={555.48} rx={1.58} ry={2.96} fill="url(#prefix__r)" />
        <circle cx={634.66} cy={532.19} r={4.34} fill="url(#prefix__s)" />
        <text transform="translate(579.23 599.1)" fontSize={11.84} fontFamily="Lato-Light, Lato">
          {'00'}
        </text>
        <path
        ...
        <path
          ...
          fill="url(#prefix__u)"
        />
        <circle cx={537.55} cy={532.19} r={4.34} fill="url(#prefix__v)" />
        <path
      ...
      <path fill="#4d8af0" d="M568.47 614.23h35.27v26.07h-35.27z" />
      <path d="M568.47 621.13s13.16 1.53 17.63 1.53 17.63-1.53 17.63-1.53v-6.51h-35.26z" opacity={0.1} />
      <path
      ...
      <path
        ...
        fill="#fdb797"
      />
      <path fill="#4d8af0" d="M568.47 631.1h12.65v85.86h-12.65zM591.08 631.1h12.65v85.86h-12.65z" />
      <path d="M581.89 575.01a17.64 17.64 0 0 0 8.43 0v-6h-8.43z" opacity={0.1} />
      <circle cx={586.1} cy={553.29} r={18.4} fill="#814e4d" />
      <circle cx={586.1} cy={557.5} r={17.63} fill="#fdb797" />
      <path
      ...
      <path
        ...
        fill="#814e4d"
      />
      <ellipse cx={603.54} cy={557.5} rx={1.53} ry={2.87} fill="#fdb797" />
      <ellipse cx={568.66} cy={557.5} rx={1.53} ry={2.87} fill="#fdb797" />
      <circle cx={633.25} cy={534.89} r={4.22} fill="#fdb797" />
      <path
        ...
        fill="#814e4d"
      />
      <path d="M595.47 580.14s20.53-11.52 33.18-45.25l6.13 3.83s-10.16 43-35.65 52.9z" fill={primaryColor} />
      <circle cx={538.95} cy={534.89} r={4.22} fill="#fdb797" />
      <path d="M576.73 580.14s-20.53-11.52-33.18-45.25l-6.13 3.83s10.16 43 35.65 52.9z" fill={primaryColor} />
      <path
