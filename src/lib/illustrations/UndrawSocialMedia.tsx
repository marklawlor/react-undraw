...
const UndrawSocialMedia = (_props: any) => {
  ...
  delete props.style;
  return (
    <svg data-name="Layer 1" width="1em" height="1em" viewBox="0 0 946 662.82" style={style} {...props}>
      <defs>
        <linearGradient id="prefix__a" x1={234.56} y1={283.2} x2={234.56} y2={231.17} gradientUnits="userSpaceOnUse">
          <stop offset={0} stopColor="gray" stopOpacity={0.25} />
          <stop offset={0.54} stopColor="gray" stopOpacity={0.12} />
          <stop offset={1} stopColor="gray" stopOpacity={0.1} />
        </linearGradient>
        <linearGradient id="prefix__b" x1={421} y1={184.6} x2={421} y2={143.59} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__c" x1={779.75} y1={193.65} x2={779.75} y2={135.98} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__d" x1={955.09} y1={258.09} x2={955.09} y2={208.09} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__e" x1={566} y1={144.09} x2={614} y2={144.09} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__f" x1={473} y1={662.82} x2={473} y2={623.18} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__g" x1={480.94} y1={627} x2={480.94} y2={607.6} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__h" x1={608.04} y1={637.16} x2={608.04} y2={273.59} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__i" x1={275.92} y1={743.91} x2={275.92} y2={646.42} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__j" x1={235.47} y1={719.27} x2={235.47} y2={656.06} xlinkHref="#prefix__a" />
      </defs>
      <path
      ...
      <path
        ...
        fill="#d34836"
      />
      <path fill="url(#prefix__f)" d="M0 623.18h946v39.64H0z" />
      ...
      <path fill="url(#prefix__g)" d="M316.82 607.6h328.23V627H316.82z" />
      ...
      <path
        ...
        fill="#f5f5f5"
      />
      <path fill={primaryColor} d="M239.2 187.78h485.7v239.7H239.2z" />
      <path
