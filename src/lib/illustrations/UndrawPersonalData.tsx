...
const UndrawPersonalData = (_props: any) => {
  ...
  delete props.style;
  return (
    <svg data-name="Layer 1" width="1em" height="1em" viewBox="0 0 990 808.857" style={style} {...props}>
      <path
      ...
      <path d="M21.318 449.87c0 60.13 37.722 108.785 84.339 108.785" fill="#2f2e41" />
      <path
        d="M105.657 558.655c0-60.804 42.095-110.007 94.117-110.007M51.875 455.321c0 57.117 24.055 103.334 53.782 103.334"
        fill={primaryColor}
      />
      <path d="M105.657 558.655c0-77.695 48.655-140.564 108.784-140.564" fill="#2f2e41" />
      <path
      ...
      <path d="M272.39 269.57c0 77.499 48.619 140.21 108.702 140.21" fill="#2f2e41" />
      <path
        d="M381.092 409.78c0-78.37 54.255-141.784 121.303-141.784M311.775 276.596c0 73.615 31.003 133.183 69.317 133.183"
        fill={primaryColor}
      />
      <path d="M381.092 409.78c0-100.139 62.71-181.169 140.208-181.169" fill="#2f2e41" />
      <path
      ...
      <path
        ...
        fill="#2f2e41"
      />
      <path fill="#ffb9b9" d="M742.713 514.276v58.351h-15.771l-7.885-60.717 23.656 2.366z" />
      <path
      ...
      <path
        ...
        fill="#ff6584"
      />
      <path fill="#2f2e41" d="M688.698 95.956h-41.792l-9.463-24.444h58.352l-7.097 24.444z" />
      <ellipse
        cx={742.443}
        cy={153.356}
        rx={2.366}
      ...
      <rect x={467.761} y={414.83} width={107.078} height={30.057} rx={2.774} fill="#2f2e41" />
      <circle cx={549.478} cy={420.465} r={2.818} fill={primaryColor} />
      <circle cx={557.932} cy={420.465} r={2.818} fill={primaryColor} />
      <circle cx={566.385} cy={420.465} r={2.818} fill={primaryColor} />
      <rect x={467.761} y={449.583} width={107.078} height={30.057} rx={2.774} fill="#2f2e41" />
      <circle cx={549.478} cy={455.219} r={2.818} fill={primaryColor} />
      <circle cx={557.932} cy={455.219} r={2.818} fill={primaryColor} />
      <circle cx={566.385} cy={455.219} r={2.818} fill={primaryColor} />
      <rect x={467.761} y={484.336} width={107.078} height={30.057} rx={2.774} fill="#2f2e41" />
      <circle cx={549.478} cy={489.972} r={2.818} fill={primaryColor} />
      <circle cx={557.932} cy={489.972} r={2.818} fill={primaryColor} />
      <circle cx={566.385} cy={489.972} r={2.818} fill={primaryColor} />
    </svg>
  );
};
