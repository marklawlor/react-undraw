...
const UndrawHealthyHabit = (_props: any) => {
  ...
  return (
    <svg data-name="Layer 1" width="1em" height="1em" viewBox="0 0 1020 668.18" style={style} {...props}>
      <path
        ...
        opacity={0.1}
      />
      <ellipse cx={137.95} cy={646.08} rx={72.74} ry={22.1} fill={primaryColor} opacity={0.1} />
      <ellipse cx={825.73} cy={363.42} rx={194.27} ry={12.89} fill={primaryColor} opacity={0.1} />
      <g opacity={0.5} fill={primaryColor}>
        <path d="M708.28 68.4a10.16 10.16 0 0 1 10.16 10.16v282.5h-20.32V78.55a10.16 10.16 0 0 1 10.16-10.15zM931.21 68.4a10.16 10.16 0 0 1 10.16 10.16v282.5H921V78.55a10.16 10.16 0 0 1 10.21-10.15z" />
        <rect
          x={899.59}
          y={56.37}
          width={20.32}
      ...
      <g opacity={0.5} fill={primaryColor}>
        <path d="M799.46 186.64H841a17 17 0 0 1 17 17V275h-75.5v-71.36a17 17 0 0 1 16.96-17z" />
      ...
      <ellipse cx={473.09} cy={577.95} rx={414.32} ry={30.38} fill={primaryColor} opacity={0.1} />
      <path
      ...
      <path
        ...
        opacity={0.05}
      />
      <path d="M260.87 245.09s35 37.75 64.45 10.13l-3.68 97.6s-47.88-58-81-53.4z" fill="#ffb9b9" />
      <path
      ...
      <g opacity={0.8}>
        ...
        <path d="M108.74 565.09s9 24.4 8.26 30.78l7.13-.75s-12-21.39-9-30z" fill={primaryColor} />
        ...
        <path
          ...
          opacity={0.1}
        />
        <path d="M117.66 587.09s3.72-17.77 27.84-20" fill="none" stroke={primaryColor} strokeMiterlimit={10} />
      </g>
      <path
      ...
      <path d="M168.58 587.16s9 24.4 8.26 30.78l7.13-.75s-12-21.39-9-30z" fill={primaryColor} />
      <path d="M168.58 587.16s9 24.4 8.26 30.78l7.13-.75s-12-21.39-9-30z" opacity={0.2} />
      <path d="M205.35 589.19s-14.18-7.25-20.52-1.26-7.32 21.3-7.32 21.3 23.12 3.18 27.84-20.04z" fill={primaryColor} />
      <path
        d="M205.35 589.19s-14.18-7.25-20.52-1.26-7.32 21.3-7.32 21.3 23.12 3.18 27.84-20.04z"
        fill="#fff"
        opacity={0.1}
      />
      <path d="M177.51 609.23s3.72-17.77 27.84-20" fill="none" stroke={primaryColor} strokeMiterlimit={10} />
      <path
