...
const UndrawFreelancer = (_props: any) => {
  ...
  delete props.style;
  return (
    <svg data-name="Layer 1" width="1em" height="1em" viewBox="0 0 1139.67 810.43" style={style} {...props}>
      <defs>
        <linearGradient id="prefix__a" x1={685.66} y1={732.28} x2={685.66} y2={530.49} gradientUnits="userSpaceOnUse">
          <stop offset={0} stopColor="gray" stopOpacity={0.25} />
          <stop offset={0.54} stopColor="gray" stopOpacity={0.12} />
          <stop offset={1} stopColor="gray" stopOpacity={0.1} />
        </linearGradient>
      </defs>
      <ellipse cx={509} cy={689.93} rx={509} ry={120.5} fill={primaryColor} opacity={0.1} />
      <path
      ...
      <path
        ...
        opacity={0.1}
      />
      <path d="M606.14 643.98s41.1-3.26 52.93 10.88 54.06 46.56 36.63 53.78-111-21.61-111-21.61z" fill="#ffb9b9" />
      <path
      ...
      <path d="M452.5 686.98s-39 9.32-43 26.4 23 15.53 23 15.53 38-7.77 43-38.83-23-3.1-23-3.1z" fill="#ffb9b9" />
      ...
      <path
        ...
        fill="#cbcdda"
      />
      <path d="M437.5 657.92s40-10 54 2 61 37 45 47-113-3-113-3z" fill="#ffb9b9" />
      <g opacity={0.05}>
      ...
      />
      <path fill={primaryColor} opacity={0.1} d="M613 179.43h20v4h-20zM613 210.43h20v4h-20zM643 170.43h20v57h-20z" />
      <path fill={primaryColor} opacity={0.1} d="M643 179.43h20v4h-20zM643 210.43h20v4h-20zM673 170.43h20v57h-20z" />
      <path fill={primaryColor} opacity={0.1} d="M673 179.43h20v4h-20zM673 210.43h20v4h-20zM703 170.43h20v57h-20z" />
      <path fill={primaryColor} opacity={0.1} d="M703 179.43h20v4h-20zM703 210.43h20v4h-20zM733 170.43h20v57h-20z" />
      <path fill={primaryColor} opacity={0.1} d="M733 179.43h20v4h-20zM733 210.43h20v4h-20zM763 170.43h20v57h-20z" />
      <path fill={primaryColor} opacity={0.1} d="M763 179.43h20v4h-20zM763 210.43h20v4h-20zM793 170.43h20v57h-20z" />
      <path
        fill={primaryColor}
        opacity={0.1}
      ...
      />
      <path fill={primaryColor} opacity={0.1} d="M613 275.43h20v4h-20zM613 306.43h20v4h-20zM643 266.43h20v57h-20z" />
      <path fill={primaryColor} opacity={0.1} d="M643 275.43h20v4h-20zM643 306.43h20v4h-20zM673 266.43h20v57h-20z" />
      <path fill={primaryColor} opacity={0.1} d="M673 275.43h20v4h-20zM673 306.43h20v4h-20zM798 266.43h20v57h-20z" />
      <path fill={primaryColor} opacity={0.1} d="M798 275.43h20v4h-20zM798 306.43h20v4h-20zM828 266.43h20v57h-20z" />
      <path fill={primaryColor} opacity={0.1} d="M828 275.43h20v4h-20zM828 306.43h20v4h-20zM858 266.43h20v57h-20z" />
      <path fill={primaryColor} opacity={0.1} d="M858 275.43h20v4h-20zM858 306.43h20v4h-20zM613 364.43h20v57h-20z" />
      <path fill={primaryColor} opacity={0.1} d="M613 373.43h20v4h-20zM613 404.43h20v4h-20zM643 364.43h20v57h-20z" />
      <path fill={primaryColor} opacity={0.1} d="M643 373.43h20v4h-20zM643 404.43h20v4h-20zM673 364.43h20v57h-20z" />
      <path fill={primaryColor} opacity={0.1} d="M673 373.43h20v4h-20zM673 404.43h20v4h-20zM703 364.43h20v57h-20z" />
      <path fill={primaryColor} opacity={0.1} d="M703 373.43h20v4h-20zM703 404.43h20v4h-20zM733 364.43h20v57h-20z" />
      <path fill={primaryColor} opacity={0.1} d="M733 373.43h20v4h-20zM733 404.43h20v4h-20zM763 364.43h20v57h-20z" />
      <path
        fill={primaryColor}
        opacity={0.1}
      ...
      />
      <path d="M873 182.44v1h-20v-4h7.78q6.14 1.42 12.22 3zM853 210.43h20v4h-20z" fill={primaryColor} opacity={0.1} />
      <circle cx={146.7} cy={161.75} r={37.33} fill={primaryColor} opacity={0.1} />
      <circle cx={146.7} cy={161.75} r={31.68} fill={primaryColor} opacity={0.1} />
      <circle cx={146.7} cy={161.75} r={2.26} fill={primaryColor} opacity={0.1} />
      <path
        fill="none"
        stroke={primaryColor}
        strokeMiterlimit={10}
      ...
      <path d="M213.1 693.42s10.09 27.33 9.25 34.48l8-.84s-13.46-24-10.09-33.64z" fill={primaryColor} />
      <path d="M213.1 693.42s10.09 27.33 9.25 34.48l8-.84s-13.46-24-10.09-33.64z" opacity={0.2} />
      <path d="M254.29 695.71s-15.88-8.12-23-1.41-8.2 23.86-8.2 23.86 25.91 3.56 31.2-22.45z" fill={primaryColor} />
      <path
        d="M254.29 695.71s-15.88-8.12-23-1.41-8.2 23.86-8.2 23.86 25.91 3.56 31.2-22.45z"
        fill="#fff"
        opacity={0.1}
      />
      <path d="M223.1 718.16s4.17-19.91 31.19-22.45" fill="none" stroke={primaryColor} strokeMiterlimit={10} />
      <g opacity={0.1} fill={primaryColor}>
        <path d="M733.39 302.7s-6.06-2.06-9 3.29a9.75 9.75 0 0 0 .13 9.38c1.92 3.46 5.87 8 13.35 7.56 6.35-.34 8.46-5.18 9-9.69a10 10 0 0 0-13.22-10.66z" />
        <path
      ...
      <g opacity={0.1} fill={primaryColor}>
        <path d="M861.39 401.7s-6.06-2.06-9 3.29a9.75 9.75 0 0 0 .13 9.38c1.92 3.46 5.87 8 13.35 7.56 6.35-.34 8.46-5.18 9-9.69a10 10 0 0 0-13.22-10.66z" />
        <path
