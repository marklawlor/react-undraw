...
const UndrawUpgrade = (_props: any) => {
  ...
  return (
    <svg data-name="Layer 1" width="1em" height="1em" viewBox="0 0 1066 773.96" style={style} {...props}>
      <path
        ...
        opacity={0.1}
      />
      <circle cx={623} cy={179} r={87} fill={primaryColor} />
      <path
        fill="#fff"
      ...
      />
      <path fill="#3f3d56" d="M453.46 669.68l.07-5.63-3.38-.04-.07 5.63-5.83 16.84 14.64.17-5.43-16.97z" />
      <path fill="#3f3d56" d="M468.15 670l.07-5.77-3.47-.05-.07 5.78-5.98 17.27 15.02.17-5.57-17.4z" />
      <path
        fill="#3f3d56"
      ...
      <path
        ...
        fill="#2f2e41"
      />
      <path fill={primaryColor} d="M509.13 395.43l27.88-27.88 28.14 27.88h-19.12v21.31h-17.77v-21.18l-19.13-.13z" />
      <g opacity={0.1}>
