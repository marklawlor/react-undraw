...
const UndrawMissionImpossible = (_props: any) => {
  ...
  delete props.style;
  return (
    <svg data-name="Layer 1" width="1em" height="1em" viewBox="0 0 618.02 704" style={style} {...props}>
      <defs>
        <linearGradient id="prefix__a" x1={252.52} y1={136} x2={252.52} gradientUnits="userSpaceOnUse">
        ...
        <linearGradient
          ...
          xlinkHref="#prefix__a"
        />
        <clipPath id="prefix__c" transform="translate(-302.98 -117)">
          <path data-name="<Rectangle>" fill={primaryColor} d="M421 120h270v135H421z" />
        </clipPath>
        <linearGradient id="prefix__d" x1={13.84} y1={244.99} x2={13.84} y2={202.99} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__e" x1={487.49} y1={430.13} x2={487.49} y2={121.99} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__f" x1={530.91} y1={303.07} x2={530.91} y2={255} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__g" x1={573.5} y1={324.54} x2={573.5} y2={254} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__h" x1={466.02} y1={543} x2={466.02} y2={527} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__i" x1={544.27} y1={659.6} x2={544.27} y2={463.87} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__j" x1={481.02} y1={533} x2={481.02} y2={408} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__k" x1={343.02} y1={704} x2={343.02} y2={540} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__l" x1={593.02} y1={704} x2={593.02} y2={540} xlinkHref="#prefix__a" />
      </defs>
      <path opacity={0.5} fill="url(#prefix__a)" d="M114.02 0h277v136h-277z" />
      <path
      ...
      <path
        ...
        fill="#f5f5f5"
      />
      <path data-name="<Rectangle>" fill={primaryColor} d="M118.02 3h270v135h-270z" />
      <g clipPath="url(#prefix__c)">
        <g opacity={0.5}>
          <path fill="url(#prefix__d)" d="M23.21 244.99l4.47-3.25-2.42-27.33-5.25-11.42L0 210.71l23.21 34.28z" />
          <path
        ...
        <path
          ...
          fill="#fda57d"
        />
        <path d="M283.08 34.46a23.8 23.8 0 0 0 6.41 23.48l13.82-10-13.39-18.45z" opacity={0.05} />
        <ellipse
          cx={610.44}
          cy={156.92}
          rx={24.15}
      ...
      <path
        ...
        fill="#fda57d"
      />
      <path fill="url(#prefix__h)" d="M314.02 527h304v16h-304z" opacity={0.5} />
      <path fill={primaryColor} d="M319.02 527h297v13h-297z" />
      <path
      ...
      <path d="M348.34 407.83l-11.84 12.84a25.56 25.56 0 0 0 15.67 15.61l12.39-13.43z" opacity={0.05} />
      <path
      ...
      <path fill={primaryColor} d="M441.02 520l14-5h10l-5 5h-19z" />
      <path fill="url(#prefix__k)" d="M334.02 540h18v164h-18z" opacity={0.5} />
      <path fill="url(#prefix__l)" d="M584.02 540h18v164h-18z" opacity={0.5} />
      <path fill={primaryColor} d="M336.02 540h15v161h-15zM586.02 540h15v161h-15z" />
