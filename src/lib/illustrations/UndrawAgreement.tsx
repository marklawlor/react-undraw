...
const UndrawAgreement = (_props: any) => {
  ...
  delete props.style;
  return (
    <svg data-name="Layer 1" width="1em" height="1em" viewBox="0 0 885 856.96" style={style} {...props}>
      <defs>
        <linearGradient
          id="prefix__a"
          x1={613.19}
        ...
        <linearGradient
          ...
          xlinkHref="#prefix__a"
        />
        <linearGradient id="prefix__g" x1={599.62} y1={607.1} x2={599.62} y2={100.78} xlinkHref="#prefix__a" />
      </defs>
      <path
      ...
      <path transform="rotate(-24.52 346.323 493.463)" fill="url(#prefix__b)" d="M349.12 112.4H596.9v60.02H349.12z" />
      <path
        ...
        fill="url(#prefix__c)"
      />
      <path fill={primaryColor} d="M193.108 144.562L413.793 43.897l23.813 52.205-220.685 100.665z" />
      <path
        ...
        fill={primaryColor}
      />
      <path transform="rotate(-24.52 252.396 705.48)" fill="url(#prefix__d)" d="M325.61 300.95h106.94v106.94H325.61z" />
      <path transform="rotate(-24.52 340.697 898.134)" fill="url(#prefix__e)" d="M413.89 493.6h106.94v106.94H413.89z" />
      <path fill="#69f0ae" d="M156.303 308.982l90.172-41.131 41.132 90.171-90.172 41.132z" />
      <path fill={primaryColor} d="M243.44 500.001l90.172-41.131 41.131 90.172-90.172 41.131z" />
      <path
        fill="#e0e0e0"
