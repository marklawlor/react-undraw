...
const UndrawDevelopment = (_props: any) => {
  ...
  delete props.style;
  return (
    <svg data-name="Layer 1" width="1em" height="1em" viewBox="0 0 923 585.89" style={style} {...props}>
      <defs>
        <linearGradient id="prefix__a" x1={337.02} y1={284.7} x2={337.02} y2={157.05} gradientUnits="userSpaceOnUse">
          <stop offset={0} stopColor="gray" stopOpacity={0.25} />
          <stop offset={0.54} stopColor="gray" stopOpacity={0.12} />
          <stop offset={1} stopColor="gray" stopOpacity={0.1} />
        </linearGradient>
        <linearGradient id="prefix__b" x1={277.82} y1={250.69} x2={277.82} y2={249.92} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__c" x1={445.5} y1={447} x2={445.5} y2={83.79} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__d" x1={1022.23} y1={742.95} x2={1022.23} y2={530.74} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__e" x1={477.63} y1={628.29} x2={583.5} y2={628.29} xlinkHref="#prefix__a" />
      </defs>
      <g opacity={0.5}>
        <path
          ...
          fill="url(#prefix__a)"
        />
        <path d="M280.61 250h-5.57s1.53 1.62 5.57 0z" transform="translate(-137.5 -157.05)" fill="url(#prefix__b)" />
      </g>
      <path
      ...
      <path
        ...
        opacity={0.1}
      />
      <path d="M212.94 56.87s3.55 9.65-4.09 12.81" fill={primaryColor} />
      <path fill="url(#prefix__c)" d="M0 83.79h891V447H0z" />
      ...
      <path d="M890.22 382.77s21.92-23.1 17.37 33a129.42 129.42 0 0 0-15-28.82z" fill="#795548" />
