...
const UndrawSnowman = (_props: any) => {
  ...
  delete props.style;
  return (
    <svg data-name="Layer 1" width="1em" height="1em" viewBox="0 0 566.04 759.48" style={style} {...props}>
      <defs>
        <linearGradient id="prefix__a" x1={601.75} y1={829.74} x2={601.75} y2={120.23} gradientUnits="userSpaceOnUse">
          <stop offset={0} stopColor="gray" stopOpacity={0.25} />
          <stop offset={0.54} stopColor="gray" stopOpacity={0.12} />
          <stop offset={1} stopColor="gray" stopOpacity={0.1} />
        </linearGradient>
        <linearGradient id="prefix__b" x1={602.33} y1={155.81} x2={602.33} y2={70.26} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__c" x1={396.02} y1={304.93} x2={396.02} y2={70.55} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__d" x1={803.94} y1={304.1} x2={803.94} y2={103.3} xlinkHref="#prefix__a" />
      </defs>
      <path
      ...
      <path
        ...
        fill="url(#prefix__b)"
      />
      <path fill={primaryColor} d="M225.74 59.76h119.22v21.99H225.74z" />
      <path
