...
const UndrawCollaboration = props => (
  ...
  >
    ...
    <circle cx={395.42} cy={363.47} r={34} fill="url(#c)" opacity={0.5} />
    <circle cx={395.42} cy={363.47} r={32} fill="#69f0ae" />
    <circle cx={395.42} cy={501.47} r={34} fill="url(#d)" opacity={0.5} />
    <circle cx={395.42} cy={501.47} r={32} fill="#e0e0e0" />
    <circle cx={395.42} cy={639.47} r={34} fill="url(#e)" opacity={0.5} />
