...
const UndrawAcceptTerms = (_props: any) => {
  ...
  delete props.style;
  return (
    <svg data-name="Layer 1" width="1em" height="1em" viewBox="0 0 905.39 787.66" style={style} {...props}>
      <defs>
        <linearGradient id="prefix__a" x1={637.69} y1={801.36} x2={637.69} y2={253.91} gradientUnits="userSpaceOnUse">
          <stop offset={0} stopColor="gray" stopOpacity={0.25} />
          <stop offset={0.54} stopColor="gray" stopOpacity={0.12} />
          <stop offset={1} stopColor="gray" stopOpacity={0.1} />
        </linearGradient>
        <linearGradient id="prefix__b" x1={407.08} y1={313.45} x2={407.08} y2={243.56} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__c" x1={406.79} y1={366.25} x2={406.79} y2={318.23} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__d" x1={410.39} y1={417.44} x2={410.39} y2={371.18} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__e" x1={409.82} y1={497.91} x2={409.82} y2={438.02} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__f" x1={520.63} y1={525.14} x2={520.63} y2={109.57} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__g" x1={518.01} y1={297.89} x2={518.01} y2={251.22} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__h" x1={518.01} y1={358.71} x2={518.01} y2={312.04} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__i" x1={477.01} y1={286.35} x2={477.01} y2={254.5} xlinkHref="#prefix__a" />
      </defs>
      <path
        ...
        opacity={0.1}
      />
      <path d="M274.92 188.25s-58-10.24 0 68.28z" fill="#ffbec7" />
      <path
        ...
        fill="url(#prefix__a)"
      />
      <path d="M420.27 244s-59.35-10.42 0 69.44z" transform="translate(-147.3 -56.17)" fill="url(#prefix__b)" />
      <path
      ...
      <path
        ...
        fill="url(#prefix__e)"
      />
      <path d="M473.35 655.52s53.77-89.61 136.55-116.92l-4.27 48.65-68.6 68.28z" fill="#dfe5ee" />
      <path d="M473.35 655.52s53.77-89.61 136.55-116.92l-4.27 48.65-68.6 68.28z" opacity={0.05} />
      <path
      ...
      <path
        ...
        fill="url(#prefix__f)"
      />
      <rect x={270.63} y={56.58} width={205.39} height={410.79} rx={11} ry={11} fill="#535461" />
      <path fill="#f1f1f4" d="M285.76 94.8H460.9v334.36H285.76z" />
      <circle cx={352.63} cy={75.69} r={1.59} fill="#fff" />
      <rect x={360.59} y={74.1} width={35.03} height={3.18} rx={1} ry={1} fill="#fff" />
      <circle cx={372.53} cy={445.08} r={11.15} fill="#fff" />
      <path
        d="M261.7 261.22s-21.23 0-20.75 26.37a21.22 21.22 0 0 0 14.45 19.93 18 18 0 0 0 13.67-1 24 24 0 0 0-7.37-45.3z"
        fill="#ffbec7"
      />
      <path d="M261.7 274.83s-19.63 13.66-2.56 25.6c-.01.05-1.72-23.85 2.56-25.6z" fill="#eff4f8" opacity={0.5} />
      <path
        ...
        fill="#ffbec7"
      />
      <path d="M265.1 324.37s-19.63 7.68 0 29c0 .02-9.4-20.46 0-29z" fill="#eff4f8" opacity={0.5} />
      <path
      ...
      <path
        ...
        opacity={0.5}
      />
      <path d="M515.6 308.59s-22.19 24.75-29 27.31" opacity={0.05} />
      <path
      ...
      <path
        ...
        fill="#00dd90"
      />
      <path fill="#00dd90" d="M429.23 226.42H346.6v-16.07h82.63l10.32 8.08-10.32 7.99z" />
      <path
      ...
      <path
        ...
        fill="#ff5288"
      />
      <path fill="#ff5288" d="M429.23 287.24H346.6v-16.07h82.63l10.32 8.08-10.32 7.99z" />
      <path
