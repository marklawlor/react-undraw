...
const UndrawMindMap = (_props: any) => {
  ...
  delete props.style;
  return (
    <svg data-name="Layer 1" width="1em" height="1em" viewBox="0 0 1103.79 707.8" style={style} {...props}>
      <defs>
        <linearGradient id="prefix__a" x1={891.82} y1={790.72} x2={891.82} y2={522.9} gradientUnits="userSpaceOnUse">
          <stop offset={0} stopColor="gray" stopOpacity={0.25} />
          <stop offset={0.54} stopColor="gray" stopOpacity={0.12} />
          <stop offset={1} stopColor="gray" stopOpacity={0.1} />
        </linearGradient>
      </defs>
      <ellipse cx={843.39} cy={664.8} rx={192} ry={43} fill={primaryColor} opacity={0.1} />
      <path
      ...
      <rect x={457} y={170.7} width={70.01} height={33.22} rx={8.57} fill={primaryColor} opacity={0.2} />
      <rect x={598.84} y={170.7} width={70.01} height={33.22} rx={8.57} fill={primaryColor} opacity={0.2} />
      <path fill="none" stroke="#3f3d56" strokeMiterlimit={10} d="M491.81 203.17l70.08 91.51 72.19-91.94" />
      <rect x={508.37} y={291.75} width={107.03} height={50.79} rx={8.57} opacity={0.1} />
      <rect x={510.55} y={292.79} width={102.68} height={48.73} rx={8.57} fill={primaryColor} />
      <path
        fill="none"
        stroke="#3f3d56"
        strokeMiterlimit={10}
      ...
      />
      <rect x={456.61} y={106.7} width={70.01} height={33.22} rx={8.57} fill={primaryColor} opacity={0.2} />
      <rect x={640.21} y={106.7} width={70.01} height={33.22} rx={8.57} fill={primaryColor} opacity={0.2} />
      <rect x={555.81} y={106.7} width={70.01} height={33.22} rx={8.57} fill={primaryColor} opacity={0.2} />
      <path
        fill="none"
        stroke="#3f3d56"
        strokeMiterlimit={10}
      ...
      />
      <rect x={526.62} y={430.01} width={70.01} height={33.22} rx={8.57} fill={primaryColor} opacity={0.2} />
      <rect
        x={861.88}
        y={345.12}
        width={70.01}
      ...
      <rect
        ...
        opacity={0.2}
      />
      <rect x={625.82} y={492.66} width={70.01} height={33.22} rx={8.57} fill={primaryColor} opacity={0.2} />
      <rect
        x={475.52}
        y={588.76}
        width={70.01}
      ...
      <ellipse cx={175.43} cy={607.19} rx={17.52} ry={2.96} fill={primaryColor} opacity={0.1} />
      <path
      ...
      <path
        ...
        opacity={0.1}
      />
      <path d="M818.11 474.47a29.35 29.35 0 1 0 .64-6.1 29.35 29.35 0 0 0-.64 6.1z" fill="#ee8e9e" />
      <path
      ...
      <rect
        ...
        fill="#3f3d56"
      />
      <path fill={primaryColor} d="M744.398 535.158l61.262 31.268-23.563 46.165-61.261-31.268z" />
      ...
      <path
        ...
        fill="#65617d"
      />
      <path d="M808.98 599.68l4 .64 1.67-16.54s-1.83-.27-4.12-.8c.6 2.3-.77 11.22-1.55 16.7z" opacity={0.1} />
      <path
