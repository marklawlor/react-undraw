...
const UndrawPresentation = (_props: any) => {
  ...
  delete props.style;
  return (
    <svg data-name="Layer 1" width="1em" height="1em" viewBox="0 0 906 685.39" style={style} {...props}>
      <defs>
        <linearGradient id="prefix__a" x1={345.27} y1={402.37} x2={345.27} gradientUnits="userSpaceOnUse">
          <stop offset={0} stopColor="gray" stopOpacity={0.25} />
          <stop offset={0.54} stopColor="gray" stopOpacity={0.12} />
          <stop offset={1} stopColor="gray" stopOpacity={0.1} />
        </linearGradient>
        <linearGradient id="prefix__b" x1={24.7} y1={22.44} x2={24.7} y2={10.76} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__c" x1={37.98} y1={22.44} x2={37.98} y2={10.76} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__d" x1={51.26} y1={22.44} x2={51.26} y2={10.76} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__e" x1={352.54} y1={251.95} x2={352.54} y2={55.93} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__f" x1={234.93} y1={165.29} x2={234.93} y2={144.65} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__g" x1={286.51} y1={132.27} x2={286.51} y2={111.64} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__h" x1={349.25} y1={103.14} x2={349.25} y2={82.51} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__i" x1={406.19} y1={165.29} x2={406.19} y2={144.65} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__j" x1={466.02} y1={136.4} x2={466.02} y2={115.77} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__k" x1={352.54} y1={287.5} x2={352.54} y2={274.78} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__l" x1={352.54} y1={305.68} x2={352.54} y2={292.96} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__m" x1={352.54} y1={323.85} x2={352.54} y2={311.13} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__n" x1={352.54} y1={342.02} x2={352.54} y2={329.3} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__o" x1={853.28} y1={792.7} x2={853.28} y2={246.48} xlinkHref="#prefix__a" />
      </defs>
      <path fill="url(#prefix__a)" d="M0 0h690.54v402.37H0z" />
      <path fill="#f5f5f5" d="M9.3 6.64h673.28v20.58H9.3z" />
      <path fill="#fff" d="M9.3 27.22h673.28v364.53H9.3z" />
      <circle cx={24.7} cy={16.6} r={5.84} fill="url(#prefix__b)" />
      <circle cx={37.98} cy={16.6} r={5.84} fill="url(#prefix__c)" />
      <circle cx={51.26} cy={16.6} r={5.84} fill="url(#prefix__d)" />
      ...
      <path fill="url(#prefix__e)" d="M154.46 55.93h396.15v196.01H154.46z" />
      <path fill={primaryColor} d="M158.59 60.06h387.9v185.7h-387.9z" />
      <path
        fill="none"
        stroke="#fff"
        strokeLinecap="round"
      ...
      />
      <path fill="none" stroke="#fff" strokeLinecap="round" strokeLinejoin="round" d="M178.19 228.22H520.7" />
      <path
        fill="none"
        stroke="#fff"
        strokeLinecap="round"
      ...
      <path
        ...
        opacity={0.2}
      />
      <circle cx={286.51} cy={121.96} r={8.25} fill={primaryColor} />
      <circle cx={286.51} cy={121.96} r={8.25} fill="#fff" opacity={0.5} />
      <circle cx={234.93} cy={154.97} r={10.32} fill="url(#prefix__f)" />
      <circle cx={286.51} cy={121.96} r={10.32} fill="url(#prefix__g)" />
      <circle cx={349.25} cy={92.83} r={10.32} fill="url(#prefix__h)" />
      <circle cx={406.19} cy={154.97} r={10.32} fill="url(#prefix__i)" />
      <circle cx={466.02} cy={126.08} r={10.32} fill="url(#prefix__j)" />
      <circle cx={234.93} cy={154.97} r={8.25} fill={primaryColor} />
      <circle cx={234.93} cy={154.97} r={8.25} opacity={0.2} />
      <circle cx={349.25} cy={92.83} r={8.25} fill={primaryColor} />
      <circle cx={349.25} cy={92.83} r={8.25} opacity={0.2} />
      <circle cx={406.19} cy={154.97} r={8.25} fill={primaryColor} />
      <circle cx={406.19} cy={154.97} r={8.25} fill="#fff" opacity={0.5} />
      <circle cx={466.02} cy={126.08} r={8.25} fill={primaryColor} />
      <circle cx={466.02} cy={126.08} r={8.25} opacity={0.2} />
      <path fill="url(#prefix__k)" d="M156.28 274.78H548.8v12.72H156.28z" />
      <path fill="url(#prefix__l)" d="M156.28 292.96H548.8v12.72H156.28z" />
      <path fill="url(#prefix__m)" d="M156.28 311.13H548.8v12.72H156.28z" />
      <path fill="url(#prefix__n)" d="M156.28 329.3H548.8v12.72H156.28z" />
      <path
        fill="#e0e0e0"
      ...
      <path
        ...
        opacity={0.2}
      />
      <rect x={731.33} y={247} width={53.63} height={44.7} rx={12} ry={12} fill={primaryColor} />
      ...
      <path
        ...
        fill="#ffbec5"
      />
      <path fill={primaryColor} d="M579.36 264.88l70.96 1.67 1.11 25.7-72.07-10.61v-16.76z" />
      <path
        d="M516.79 264.88h62.57v16.76l-29.05-3.35s-5.59 19-21.23 0l3.35-5.59-15.64-3.35s-3.35-2.23 0-4.47z"
        fill="#ffbec5"
      />
      <path fill={primaryColor} d="M824.07 363.21l31.29 74.86 21.23-8.94-21.23-79.33-31.29 13.41z" />
      <path
      ...
      <path
        ...
        fill="#00695c"
      />
      <path fill="none" stroke="#fff" strokeMiterlimit={10} strokeWidth={2} d="M758.14 277.45l-1.59 100.84" />
      <g opacity={0.2} fill="#fff">
