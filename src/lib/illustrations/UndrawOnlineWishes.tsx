...
const UndrawOnlineWishes = (_props: any) => {
  ...
  delete props.style;
  return (
    <svg data-name="Layer 1" width="1em" height="1em" viewBox="0 0 1068 831.714" style={style} {...props}>
      <path
      ...
      <path d="M977.042 467.375a17.6 17.6 0 0 0 16.028-.065" fill="none" stroke="#2f2e41" strokeWidth={2} />
      ...
      <path d="M90.958 454.375a17.6 17.6 0 0 1-16.028-.065" fill="none" stroke="#2f2e41" strokeWidth={2} />
      ...
      <path opacity={0.1} d="M678.808 700.044v7.727H263.113v-6.181l.572-1.546h415.123z" />
      <path
        ...
        strokeWidth={2}
      />
      <path d="M951 182.714c0 45.84-37.16 119-83 119s-83-73.16-83-119a83 83 0 0 1 166 0z" fill={primaryColor} />
      <path d="M876 309.714q-8-5.134-16 0v-16h16z" fill={primaryColor} />
      <path d="M860.042 301.375a17.6 17.6 0 0 0 16.028-.065" fill="none" stroke="#2f2e41" strokeWidth={2} />
      ...
      />
      <path opacity={0.1} d="M582.281 304.909v29.815l-144.934-7.454v-29.815l.365-.393 144.569 7.847z" />
      <path opacity={0.15} d="M606.713 265.57v30.229l-24.432 38.925v-29.815l24.432-39.339z" />
      <path
        fill="#2f2e41"
