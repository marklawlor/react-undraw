...
const UndrawProcessing = (_props: any) => {
  ...
  delete props.style;
  return (
    <svg data-name="Layer 1" width="1em" height="1em" viewBox="0 0 880.92 737.5" style={style} {...props}>
      <defs>
        <linearGradient id="prefix__a" x1={194} y1={524} x2={194} gradientUnits="userSpaceOnUse">
          <stop offset={0} stopColor="gray" stopOpacity={0.25} />
          <stop offset={0.54} stopColor="gray" stopOpacity={0.12} />
          <stop offset={1} stopColor="gray" stopOpacity={0.1} />
        </linearGradient>
        <linearGradient id="prefix__b" x1={256.5} y1={341} x2={256.5} y2={261} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__c" x1={698.41} y1={686.91} x2={698.41} y2={411} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__d" x1={521} y1={592.5} x2={564} y2={592.5} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__e" x1={864} y1={667} x2={864} y2={506} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__f" x1={587} y1={666} x2={587} y2={505} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__g" x1={818.5} y1={672} x2={818.5} y2={507} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__h" x1={692.5} y1={520} x2={692.5} y2={503} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__i" x1={696.5} y1={492} x2={696.5} y2={407} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__j" x1={696.5} y1={503} x2={696.5} y2={482} xlinkHref="#prefix__a" />
        <linearGradient id="prefix__k" x1={695} y1={448} x2={695} y2={438} xlinkHref="#prefix__a" />
      </defs>
      <path fill="url(#prefix__a)" d="M0 0h388v524H0z" />
      <path fill="#fff" d="M23 8h358v506H23z" />
      <path fill="#f5f5f5" d="M6 8h17v506H6z" />
      <path fill="#e0e0e0" d="M82 383h240v6H82z" />
      <path fill="#69f0ae" opacity={0.4} d="M82 406h240v6H82z" />
      <path fill="#ff0" opacity={0.4} d="M82 429h240v6H82z" />
      <path fill="#e0e0e0" d="M82 452h240v6H82zM82 475h240v6H82z" />
      <path
      ...
      <path
        ...
        fill={primaryColor}
      />
      <path fill="none" stroke={primaryColor} strokeMiterlimit={10} d="M161.25 22h-6" />
      <path
        fill="none"
        stroke={primaryColor}
        strokeMiterlimit={10}
        ...
        d="M142.54 22H72.61"
      />
      <path fill="none" stroke={primaryColor} strokeMiterlimit={10} d="M66.25 22h-6v6" />
      <path fill="none" stroke={primaryColor} strokeMiterlimit={10} strokeDasharray="11.33 11.33" d="M60.25 39.33v85" />
      <path fill="none" stroke={primaryColor} strokeMiterlimit={10} d="M60.25 130v6" />
      <path fill="none" stroke={primaryColor} strokeMiterlimit={10} strokeDasharray="12" d="M207.75 222.5h136v-119" />
      <path fill="url(#prefix__b)" d="M103 261h307v80H103z" />
      <path fill={primaryColor} d="M106 266h300v71H106z" />
      <path fill={primaryColor} d="M186 283h88v4h-88z" />
      <path opacity={0.2} d="M186 292h88v4h-88z" />
      <path fill="#fff" d="M186 307h172v4H186z" />
      <circle cx={140} cy={301} r={19} fill={primaryColor} />
      ...
      <path
        ...
        fill="url(#prefix__c)"
      />
      <path fill="url(#prefix__d)" d="M537.03 512L521 672l19.03 1L564 512h-26.97z" />
      <path fill={primaryColor} d="M538 512l-12 158h12l17-158h-17z" />
      <path fill="url(#prefix__e)" d="M865.16 506l15.76 161h-18.76l-15.08-161h18.08z" />
      <path fill={primaryColor} d="M865 507l12 158h-12l-17-158h17z" />
      <path fill="url(#prefix__f)" d="M583.9 505L569 666h19.9L605 505h-21.1z" />
      <path fill={primaryColor} d="M585 505l-12 158h12l17-158h-17z" />
      <path fill="url(#prefix__g)" d="M821.69 507L837 672h-18.31L800 507h21.69z" />
      <path fill={primaryColor} d="M821 512l12 158h-12l-17-158h17z" />
      <path fill="url(#prefix__h)" d="M513 503h359v17H513z" />
      <path fill={primaryColor} d="M516 503h288v15H516zM804 503h66v15h-66z" />
      <path opacity={0.2} d="M804.46 503h66v15h-66z" />
      <path fill="url(#prefix__i)" d="M629 407h135v85H629z" />
      <path fill="#fff" d="M632 410h126v79H632z" />
      <path fill="url(#prefix__j)" d="M676 482h41v21h-41z" />
      <path fill="#fff" d="M677.5 482h35v21h-35z" />
      <path fill="#f5f5f5" d="M758 410h4v79h-4zM712 482h3v21h-3z" />
      <path fill="url(#prefix__k)" d="M690 438h10v10h-10z" />
      <path fill="#f5f5f5" d="M691 439h8v8h-8z" />
      <path fill={primaryColor} d="M499.84 430.1l65.39 27.79-22.01 41.81-64.64-23.82 21.26-45.78z" />
      <path fill="#f8c198" d="M502.52 563.62h17.96v14.96h-17.96zM526.47 563.62h17.96v14.96h-17.96z" />
      <circle cx={542.87} cy={376.5} r={23.94} fill="#f8c198" />
      <path fill="#f8c198" d="M565.31 410.92h-20.95l-2.99-23.94h17.96l5.98 23.94z" />
      <path
      ...
      <path d="M526.46 575.59s-47.89 0-47.89 6 6 9 6 9h41.89z" fill="#263238" />
      <path
      ...
      <path
        ...
        fill="#ff5252"
      />
      <path fill="#fff" d="M501.47 441.54l-9.81 21.26 6.54 3.27 9.81-21.26-6.54-3.27z" />
      <path
      ...
      <path
        ...
        opacity={0.2}
      />
      <path fill="#ff5252" d="M570.14 443.18h-26.16V425.2h26.16z" />
      <g opacity={0.2} fill="#fff">
        <path d="M535.12 482.85c23.37-.45 66.18-6.56 66.18-6.56a9 9 0 0 1 .9.55c-12.2 1.66-49.19 6.43-67.08 6.01zM522.21 482.06c-10.26 1.56-13.42 13.09-5.8 18.17 9 6 12 68.84 12 68.84h-4.95s-3-62.85-12-68.84c-8.68-5.81-3.28-20.09 10.75-18.17zM540.35 506.22s10.52 1 23.39 1.17c-9.34.1-18-.38-23.22-.75z" />
      </g>
      <path
