...
const UndrawSetup = props => (
  ...
  >
    ...
    />
    <path fill="url(#a)" d="M0 74.96h438.05v248.81H0z" />
    <path fill="#fff" d="M4.67 111.18h427.54v206.76H4.67z" />
    <path fill="url(#b)" d="M33.88 128.7h148.35v156.53H33.88z" />
    ...
    />
    <path fill="url(#c)" d="M633.47 112.64h231.14v109.19H633.47z" />
    ...
    />
    <path fill="url(#d)" d="M373.29 527.93h510.15v144.01H373.29z" />
    <path fill="#fff" d="M376.95 532.81h502.83v134.25H376.95z" />
    <circle cx={499.83} cy={599.94} r={50.3} fill="url(#e)" />
