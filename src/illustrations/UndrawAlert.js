...
const UndrawAlert = props => (
  ...
  >
    ...
    <path
      ...
      fill="#e0e0e0"
    />
    <path fill="url(#a)" d="M168.91 693.5h503.87v29.78H168.91z" />
    ...
    <path
      ...
      fill="#fff"
    />
    <path fill={props.primaryColor} d="M50.76 68.72h745.6v348.29H50.76z" />
    ...
    <path fill="url(#b)" d="M414 107.83L279 352.05h270L414 107.83z" />
    <path fill="#fff" d="M414 126.64l-118.71 216h237.42L414 126.64z" />
    <circle cx={414} cy={320.14} r={14.5} fill="url(#d)" />
    <circle cx={414} cy={320.14} r={12} fill={props.primaryColor} />
    <path fill="url(#e)" d="M410 210.64h8v86h-8z" />
    <path fill={props.primaryColor} d="M411.5 211.14h5v84h-5z" />
    <rect
      x={841.39}
      y={373.76}
      width={250.13}
    ...
    <circle cx={858.27} cy={503.83} r={7.03} fill="url(#h)" />
    <circle cx={858.27} cy={503.83} r={5.82} fill={props.primaryColor} />
    <path fill="url(#i)" d="M856.33 450.72h3.88v41.71h-3.88z" />
    <path fill={props.primaryColor} d="M857.06 450.96h2.43v40.74h-2.43z" />
  </svg>
);
