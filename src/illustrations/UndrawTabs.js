...
const UndrawTabs = props => (
  ...
  >
    ...
    <path fill="url(#m)" d="M107.96 299.78H882.5v386.73H107.96z" />
    ...
    <path fill={props.primaryColor} d="M113.28 337.9h201.4v339.6h-201.4z" />
    <path
    ...
    <rect
      ...
      fill="url(#o)"
    />
    <ellipse cx={214.05} cy={436.96} rx={20.59} ry={19.56} fill="url(#p)" />
    <path
