...
const UndrawResponsive = props => (
  ...
  >
    ...
    />
    <circle cx={485.72} cy={79} r={4} fill={props.primaryColor} />
    <circle
      cx={485.72}
      cy={46}
      r={4}
    ...
    />
    <circle cx={485.72} cy={251} r={4} fill={props.primaryColor} />
    <path
      stroke={props.primaryColor}
      strokeMiterlimit={10}
      strokeWidth={2}
    ...
    />
    <circle cx={333.22} cy={168.5} r={4} fill={props.primaryColor} />
    ...
    />
    <circle cx={637.22} cy={168.5} r={4} fill={props.primaryColor} />
    <circle
      cx={686.22}
      cy={168.5}
      r={4}
