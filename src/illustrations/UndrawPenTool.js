  ...
  >
    <defs>
      ...
      <linearGradient
        ...
        xlinkHref="#a"
      />
      <linearGradient id="d" x1={41} y1={82.01} x2={41} y2={0} xlinkHref="#a" />
      <linearGradient
        id="e"
        x1={866.87}
        y1={82.01}
    ...
    <path fill="url(#c)" d="M413.91 1.14h69.93v69.93h-69.93z" />
    <path fill={props.primaryColor} d="M417.17 4.3h64.22v64.22h-64.22z" />
    <circle cx={41} cy={41} r={41} fill="url(#d)" />
    <circle cx={866.87} cy={41} r={41} fill="url(#e)" />
