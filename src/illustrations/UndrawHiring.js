...
const UndrawHiring = props => (
  ...
  >
    ...
    />
    <path fill={props.primaryColor} d="M486.92 308.72h118.22v16.89H486.92z" />
    <path
      fill="#e0e0e0"
    ...
    />
    <path fill={props.primaryColor} d="M339.15 654.93h92.88v16.89h-92.88z" />
    <circle cx={652.07} cy={663.56} r={84.39} fill="url(#g)" opacity={0.5} />
