...
const UndrawAddUser = props => (
  ...
  >
    ...
    <path fill="url(#a)" d="M0 0v509.56h734.81V0H0z" opacity={0.5} />
    ...
    />
    <path fill="url(#b)" d="M300.25 343.1h133.79v26.13H300.25z" />
    <path fill={props.primaryColor} d="M301.29 345.48h131.7v21.38h-131.7z" />
    <circle cx={725.74} cy={275.02} r={125} fill="url(#c)" opacity={0.5} />
