...
const UndrawCreationProcess = props => (
  ...
  >
    ...
    <path fill="url(#a)" d="M0 0h888v377.21H0z" />
    <path fill="#eee" d="M9.93 2.66h869.39V372.7H9.93z" />
    <path fill="url(#b)" d="M542.51 139.97h46.13v44.66h-46.13z" />
    <path fill="#f5f5f5" d="M543.31 140.74h44.54v43.12h-44.54z" />
    <path fill="url(#c)" d="M273.2 286.45h46.13v44.66H273.2z" />
    <path fill="#f5f5f5" d="M274 287.22h44.54v43.12H274z" />
    <path fill="url(#d)" d="M675.52 129.47h46.13v44.66h-46.13z" />
    <path fill="#f5f5f5" d="M676.31 130.24h44.54v43.12h-44.54z" />
    <path fill="url(#e)" d="M542.68 257.75h46.13v44.66h-46.13z" />
    <path fill="#f5f5f5" d="M543.47 258.52h44.54v43.12h-44.54z" />
    <path fill="url(#f)" d="M249.71 33.02h46.13v44.66h-46.13z" />
    <path fill="#f5f5f5" d="M250.51 33.79h44.54v43.12h-44.54z" />
    <path fill="url(#g)" d="M698.26 23.02h46.13v44.66h-46.13z" />
    <path fill="#f5f5f5" d="M699.06 23.78h44.54V66.9h-44.54z" />
    <path fill="url(#h)" d="M807.44 184.06h46.13v44.66h-46.13z" />
    <path fill="#f5f5f5" d="M808.24 184.83h44.54v43.12h-44.54z" />
    <path fill="url(#i)" d="M84.12 16.65h46.13v44.66H84.12z" />
    <path fill="#f5f5f5" d="M84.92 17.42h44.54v43.12H84.92z" />
    <path fill="url(#j)" d="M604.54 56.16h46.13v44.66h-46.13z" />
    <path fill="#7cfcff" d="M605.34 56.93h44.54v43.12h-44.54z" />
    <path fill="url(#k)" d="M325.22 150.78h46.13v44.66h-46.13z" />
    <path fill="#7cfcff" d="M326.02 151.55h44.54v43.12h-44.54z" />
    <path fill="url(#l)" d="M480.8 199.91h46.13v44.66H480.8z" />
    <path fill="#7cfcff" d="M481.6 200.68h44.54v43.12H481.6z" />
    <path fill="url(#m)" d="M534.73 33.22h46.13v44.66h-46.13z" />
    <path fill="#ffffa5" d="M535.53 33.99h44.54v43.12h-44.54z" />
    <path fill="url(#n)" d="M615.71 228.83h46.13v44.66h-46.13z" />
    <path fill="#ffffa5" d="M616.5 229.6h44.54v43.12H616.5z" />
    <path fill="url(#o)" d="M337.3 33.22h46.13v44.66H337.3z" />
    <path fill="#ffffa5" d="M338.09 33.99h44.54v43.12h-44.54z" />
    <path fill="url(#p)" d="M398.26 277.06h46.13v44.66h-46.13z" />
