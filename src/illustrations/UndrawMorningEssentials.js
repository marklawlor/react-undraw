...
const UndrawMorningEssentials = props => (
  ...
  >
    ...
    />
    <circle cx={474.94} cy={198.21} r={171.55} fill="url(#c)" />
    <circle cx={474.94} cy={198.21} r={166.92} fill={props.primaryColor} />
    <circle cx={474.94} cy={198.21} r={135.62} fill="#fff" />
    <circle cx={474.94} cy={198.21} r={8.11} fill="url(#d)" />
    <path fill={props.primaryColor} d="M520.15 93.89L476.1 198.21" />
    <path fill="url(#e)" d="M478 199.22l-5-1.68 45-105.33 5 2.36-45 104.65z" />
    <path
      fill="#2196f3"
      d="M474.483 197.514l44.046-104.322 3.206 1.353-44.046 104.323z"
    />
    <path fill={props.primaryColor} d="M476.1 199.37l28.98 53.32" />
    <path fill="url(#f)" d="M503 254.22l-29-54 4-2 30 53-5 3z" />
    <path
      fill="#2196f3"
    ...
    <circle
      ...
      fill="url(#h)"
    />
    <circle cx={348.59} cy={201.69} r={4.52} fill="url(#i)" />
    <circle
      cx={574.23}
      cy={329.16}
      r={4.52}
    ...
    <rect
      ...
      fill="#fff"
    />
    <path fill={props.primaryColor} d="M710.75 102.88h140.4v271.04h-140.4z" />
