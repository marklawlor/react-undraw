...
const UndrawEvents = props => (
  ...
  >
    ...
    <path
      ...
      strokeWidth={2}
    />
    <path fill="url(#a)" d="M193.07 33.2h570.61v662.53H193.07z" />
    ...
    <circle cx={440.87} cy={288.03} r={5.7} fill={props.primaryColor} />
    <circle cx={455.12} cy={288.03} r={5.7} fill={props.primaryColor} />
    <circle cx={745.64} cy={451.33} r={5.7} fill={props.primaryColor} />
    <circle cx={748.49} cy={444.69} r={5.7} fill={props.primaryColor} />
    <circle cx={751.34} cy={438.99} r={5.7} fill={props.primaryColor} />
    <circle cx={645} cy={203.53} r={5.7} fill={props.primaryColor} />
    <circle cx={659.24} cy={203.53} r={5.7} fill={props.primaryColor} />
    <circle cx={673.49} cy={203.53} r={5.7} fill={props.primaryColor} />
    <circle cx={687.73} cy={203.53} r={5.7} fill={props.primaryColor} />
    <circle cx={645} cy={380.12} r={5.7} fill={props.primaryColor} />
    <circle cx={659.24} cy={380.12} r={5.7} fill={props.primaryColor} />
    <circle cx={673.49} cy={380.12} r={5.7} fill={props.primaryColor} />
    <circle cx={687.73} cy={380.12} r={5.7} fill={props.primaryColor} />
