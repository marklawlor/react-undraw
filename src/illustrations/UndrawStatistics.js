  ...
  >
    <defs>
      ...
      <linearGradient
        ...
        xlinkHref="#a"
      />
      <linearGradient id="c" x1={434} x2={434} y2={118.5} xlinkHref="#a" />
      <linearGradient
        id="d"
        x1={431.5}
        y1={426.5}
    ...
    />
    <path fill="url(#c)" d="M423 118.5h22v651h-22z" />
    <path
      fill="#bdbdbd"
    ...
    />
    <path fill="url(#d)" d="M0 23.5h863v403H0z" />
    ...
    <path fill={props.primaryColor} d="M542 344.5h27v27h-27z" />
    ...
    />
    <circle cx={207.19} cy={287.02} r={15.8} fill="url(#f)" />
    <circle cx={229.06} cy={248.13} r={15.8} fill="url(#g)" />
    <circle cx={250.94} cy={267.58} r={15.8} fill="url(#h)" />
    <circle cx={272.81} cy={213.3} r={15.8} fill="url(#i)" />
