...
const UndrawCalendar = props => (
  ...
  >
    ...
    <path fill="url(#a)" d="M35.61 0h800v529h-800z" />
    <path fill="#fff" d="M42.61 62.5h784V513h-784z" />
    <path fill={props.primaryColor} d="M42.61 11h784v51.5h-784z" />
    <path fill="url(#b)" d="M53.61 95h764v393h-764z" />
    <path
    ...
    />
    <circle cx={171.55} cy={488.5} r={171.55} fill="url(#c)" />
    <circle cx={171.55} cy={488.5} r={166.92} fill={props.primaryColor} />
    <circle cx={171.55} cy={488.5} r={135.62} fill="#fff" />
    <circle cx={171.55} cy={488.5} r={8.11} fill="url(#d)" />
    <path fill={props.primaryColor} d="M216.76 384.18L172.71 488.5" />
    <path
      fill="url(#e)"
    ...
    />
    <path fill={props.primaryColor} d="M172.71 489.66l28.98 53.32" />
    <path fill="url(#f)" d="M199.61 544.5l-29-54 4-2 30 53-5 3z" />
    <path
      fill="#2196f3"
    ...
    <circle
      ...
      fill="url(#h)"
    />
    <circle cx={45.21} cy={491.98} r={4.52} fill="url(#i)" />
    <circle
      cx={291.04}
      cy={499.63}
      r={4.52}
